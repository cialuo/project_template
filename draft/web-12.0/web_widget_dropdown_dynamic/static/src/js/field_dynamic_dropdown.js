 ...
 */
odoo.define(
    "web_widget_dropdown_dynamic.field_dynamic_dropdown",
    function (require) {
        "use strict";
        ...
        var FieldDynamicDropdown = AbstractField.extend({
            ...
            updateModifiersValue: function () {
                this._super.apply(this, arguments);
                if (
                    !this.attrs.modifiersValue.invisible &&
                    this.mode !== "readonly"
                ) {
                    this._setValues();
                    this._renderEdit();
             ...
             */
            _setValues: function () {
                this.values = _.reject(
                    this.record.specialData[this.name],
                    function (v) {

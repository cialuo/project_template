!(function (d3) {
    ...
    mpld3.generate_id = function (N, chars) {
        console.warn(
            "mpld3.generate_id is deprecated. " +
    ...
    mpld3.process_props = function (obj, properties, defaults, required) {
        console.warn(
            "mpld3.process_props is deprecated. " +
    ...
    mpld3_Grid.prototype.draw = function () {
        this.grid = d3.svg
            ...
            .tickFormat("");
        this.elem = this.ax.axes
            .append("g")
            .attr("class", this.cssclass)
            .attr("transform", this.transform)
            .call(this.grid);
        mpld3.insert_css(
            "div#" + this.ax.fig.figid + " ." + this.cssclass + " .tick",
            {
        ...
        mpld3.insert_css(
            "div#" + this.ax.fig.figid + " ." + this.cssclass + " path",
            {
                "stroke-width": 0,
            }
        );
    ...
    mpld3_Axis.prototype.draw = function () {
        var scale =
            this.props.xy === "x"
                ? this.parent.props.xscale
                : this.parent.props.yscale;
        if (scale === "date" && this.props.tickvalues) {
            ...
            var ordinal_to_js_date = d3.scale
                .linear()
                .domain(domain)
                .range(range);
        ...
        var tickformat = mpld3_tickFormat(
        ...
        mpld3.insert_css(
            "div#" + this.ax.fig.figid + " ." + this.cssclass + " text",
            {
    ...
    mpld3_Axis.prototype.filter_ticks = function (tickValues, domain) {
        if (this.props.tickvalues != null) {
            tickValues(
                this.props.tickvalues.filter(function (v) {
    ...
    function mpld3_Path(ax, props) {
        ...
        this.pathcoords = new mpld3_Coordinates(
            this.props.coordinates,
            this.ax
        );
        this.offsetcoords = new mpld3_Coordinates(
            this.props.offsetcoordinates,
            this.ax
        );
    ...
    mpld3_Path.prototype.finiteFilter = function (d, i) {
        return (
            isFinite(this.pathcoords.x(d[this.props.xindex])) &&
    ...
    mpld3_PathCollection.prototype.transformFunc = function (d, i) {
        ...
        var offset =
            d === null || typeof d === "undefined"
                ? "translate(0, 0)"
                : "translate(" +
                  this.offsetcoords.xy(
                      d,
                      this.props.xindex,
                      this.props.yindex
                  ) +
                  ")";
        return this.props.offsetorder === "after"
            ? transform + offset
            : offset + transform;
    };
    ...
    function mpld3_Markers(ax, props) {
        ...
        if (this.props.markerpath !== null) {
            this.marker =
                this.props.markerpath[0].length == 0
                    ? null
                    : mpld3
                          .path()
                          .call(
            ...
            this.marker =
                this.props.markername === null
                    ? null
                    : d3.svg
                          .symbol(this.props.markername)
    ...
    mpld3_Image.prototype.zoomed = function () {
        ...
        this.image
            ...
            .attr(
                "height",
                this.coords.y(extent[2]) - this.coords.y(extent[3])
            );
    };
    ...
    mpld3_Text.prototype.applyTransform = function () {
        ...
        if (this.props.rotation)
            this.obj.attr(
                "transform",
                "rotate(" + this.props.rotation + "," + pos + ")"
            );
    };
    ...
    function mpld3_Axes(fig, props) {
        ...
        function setDomain(scale, domain) {
            return scale !== "date"
                ? domain
                : [buildDate(domain[0]), buildDate(domain[1])];
        }
        ...
        this.x = this.xdom = build_scale(
            this.props.xscale,
            this.props.xdomain,
            [0, this.width]
        );
        this.y = this.ydom = build_scale(
            this.props.yscale,
            this.props.ydomain,
            [this.height, 0]
        );
        if (this.props.xscale === "date") {
            this.x = mpld3.multiscale(
                d3.scale
                    .linear()
    ...
    mpld3_Axes.prototype.draw = function () {
        ...
        this.clip = this.baseaxes
            ...
            .attr("width", this.width)
            .attr("height", this.height);
        this.axes = this.baseaxes
            .append("g")
            .attr("class", "mpld3-axes")
            .attr("clip-path", "url(#" + this.clipid + ")");
        this.axesbg = this.axes
            .append("svg:rect")
            .attr("width", this.width)
            .attr("height", this.height)
    ...
    mpld3_Axes.prototype.zoomed = function (propagate) {
        ...
        if (propagate) {
            ...
            this.sharex.forEach(
                function (ax) {
                    ax.zoom_x
                        .translate(this.zoom_x.translate())
            ...
            this.sharey.forEach(
                function (ax) {
                    ax.zoom_y
                        .translate(this.zoom_y.translate())
    ...
    mpld3_Toolbar.prototype.draw = function () {
        ...
        mpld3.insert_css(
            "div#" + this.fig.figid + " .mpld3-toolbar image.active",
            {
                opacity: 0.4,
            }
        );
        mpld3.insert_css(
            "div#" + this.fig.figid + " .mpld3-toolbar image.pressed",
            {
                opacity: 0.6,
            }
        );
    ...
    mpld3_ZoomPlugin.prototype.draw = function () {
        if (this.props.enabled) this.fig.enable_zoom();
        else this.fig.disable_zoom();
    };
    ...
    mpld3_TooltipPlugin.prototype.draw = function () {
        ...
        if (loc == "bottom left" || loc == "bottom right") {
            this.y =
                obj.ax.position[1] + obj.ax.height - 5 + this.props.voffset;
        ...
        function brushmove(d) {
            ...
            if (data.length > 0) {
                ...
                if (brush.empty()) {
                    ...
                    dataToBrush
                        .selectAll("path")
                        .classed("mpld3-hidden", function (p) {
                            return (
                                e[0][0] > p[ix] ||
                                e[1][0] < p[ix] ||
                                e[0][1] > p[iy] ||
    ...
    mpld3_Figure.prototype.showBrush = function (extentClass) {
        ...
        this.canvas
            .selectAll("rect.extent, rect.resize")
            .style("display", null)
    ...
    function mpld3_PlotElement(parent, props) {
        ...
        this.fig =
            parent instanceof mpld3_Figure
                ? parent
                : parent && "fig" in parent
                ? parent.fig
                : null;
        this.ax =
            parent instanceof mpld3_Axes
                ? parent
                : parent && "ax" in parent
                ? parent.ax
                : null;

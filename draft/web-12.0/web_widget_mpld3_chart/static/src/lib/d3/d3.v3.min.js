!(function () {
    ...
    function J(n, e) {
        ...
        return [
            e.clientX - o.left - n.clientLeft,
            e.clientY - o.top - n.clientTop,
        ];
    }
    function G() {
    ...
    function Tn() {
        var n = Rn(),
            t = Dn() - n;
        t > 24
            ? (isFinite(t) && (clearTimeout(oo), (oo = setTimeout(Tn, t))),
              (ao = 0))
            : ((ao = 1), lo(Tn));
    }
    function Rn() {
    ...
    function Yn(n) {
        function t(n) {
            function t(t) {
                for (var e, u, i, a = [], o = -1, l = 0; ++o < r; )
                    37 === n.charCodeAt(o) &&
                        (a.push(n.slice(l, o)),
                        null != (u = vo[(e = n.charAt(++o))]) &&
                            (e = n.charAt(++o)),
                        (i = A[e]) &&
                            (e = i(t, null == u ? ("e" === e ? " " : "0") : u)),
                        a.push(e),
                        (l = o + 1));
        ...
        function r(n, t, e) {
            ...
            return r
                ? ((n.w = w.get(r[0].toLowerCase())), e + r[0].length)
                : -1;
        }
        function u(n, t, e) {
            x.lastIndex = 0;
            ...
            return r
                ? ((n.w = b.get(r[0].toLowerCase())), e + r[0].length)
                : -1;
        }
        function i(n, t, e) {
            N.lastIndex = 0;
            ...
            return r
                ? ((n.m = E.get(r[0].toLowerCase())), e + r[0].length)
                : -1;
        }
        function a(n, t, e) {
            S.lastIndex = 0;
        ...
        return function (o) {
            function l(n) {
                for (var t = 0, e = d.length, r = n[1], u = 0; e > u; ++u)
                    for (
                        var i, a = 1, o = d[u], l = o.length, c = o[0];
                        l > a;
                        ++a
                    )
                        (i = o[a]),
    ...
    function ve(n, t) {
        ...
        return function (u, i, a, o) {
            ...
            for (var c, s = u; a > 0 ? s > i : i > s; s -= l)
                o.point(
                    (c = _t([e, -r * Math.cos(s), -r * Math.sin(s)]))[0],
                    c[1]
                );
        };
    }
    ...
    function _e() {
        function n(n, u) {
            ...
            (Wo += Math.atan2(
                Math.sqrt(
                    (o = a * Math.sin(o)) * o + (o = r * i - e * a * l) * o
                ),
                e * i + r * a * l
            )),
                (t = n),
    ...
    function or(n, t) {
        var e,
            ...
            i = n.sort(lr).pop();
        for (
            rl = [], ul = new Array(n.length), il = new er(), ol = new er();
            ;

        )
            if (
                ((u = al), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x)))
            )
                (i.x !== e || i.y !== r) &&
    ...
    function Lr(n, t) {
        ...
        return (
            ...
            function (r) {
                return (
                    1 + n * Math.pow(2, -10 * r) * Math.sin(((r - e) * Ua) / t)
                );
            }
        );
    }
    ...
    function ai(n, t) {
        function e(e) {
            return i[
                ((u.get(e) || ("range" === t.t ? u.set(e, n.push(e)) : NaN)) -
                    1) %
                    i.length
            ];
        }
        ...
        return (
            ...
            (e.rangeRoundBands = function (u, o, l) {
                ...
                return (
                    (i = r(
                        s + Math.round((f - s - (n.length - o) * h) / 2),
                        h
                    )),
                    c && i.reverse(),
                    (a = Math.round(h * (1 - o))),
    ...
    function _i(n) {
        for (
            var t = 0, e = n.length, r = n[0], u = [r[0], ",", r[1]];
            ++t < e;
    ...
    function Ni(n, t) {
        return n.length < 3
            ...
            : n[0] +
                  Ai(
                      (n.push(n[0]), n),
                      Ci([n[n.length - 2]].concat(n, [n[1]]), t)
                  );
    }
    function Ei(n, t) {
    ...
    function qi(n) {
        for (
            var t, e, r = -1, u = n.length, i = u + 4, a = [], o = [];
            ++r < 4;
    ...
    function Ui(n) {
        for (
            var t, e, r, u, i = [], a = ji(n), o = -1, l = n.length - 1;
            ++o < l;
    ...
    function aa(n) {
        ...
        return (
            t.selectNode(sa.body), t.createContextualFragment(n.responseText)
        );
    }
    ...
    (oa.bisectLeft = ya.left),
        ...
        (oa.zip = function () {
            ...
            for (
                var n = -1, t = oa.min(arguments, a), e = new Array(t);
                ++n < t;
        ...
        (Aa.selectAll = function (n) {
            ...
            for (var u = -1, i = this.length; ++u < i; )
                for (var a = this[u], o = -1, l = a.length; ++o < l; )
                    (e = a[o]) &&
                        (r.push((t = ca(n.call(e, e.__data__, o, u)))),
                        (t.parentNode = e));
            return E(r);
        });
    var Ca = {
    ...
    (oa.selection.enter = Z),
        ...
        (za.select = function (n) {
            for (
                var t, e, r, u, i, a = [], o = -1, l = this.length;
                ++o < l;
        ...
        (oa.behavior.zoom = function () {
            ...
            function h() {
                ...
                function t() {
                    ...
                    for (
                        var e = oa.event.changedTouches, u = 0, i = e.length;
                        i > u;
                        ++u
                    )
        ...
        [
            ...
            var e = (ho[n] = On(
                ...
                function (n) {
                    ...
                    return (
                        Math.floor((ho.dayOfYear(n) + ((e + t) % 7)) / 7) -
                        (e !== t)
                    );
                }
            ));
    ...
    (oa.geo.path = function () {
        ...
        (oa.geo.rotation = function (n) {
            function t(t) {
                return (
                    (t = n(t[0] * Oa, t[1] * Oa)), (t[0] *= Ia), (t[1] *= Ia), t
                );
            }
            return (
                (n = fe(
        ...
        (oa.layout.force = function () {
            ...
            return (
                (l.tick = function () {
                    ...
                    if (p)
                        for (
                            ru((t = oa.geom.quadtree(M)), u, o), r = -1;
                            ++r < _;
    ...
    (oa.layout.hierarchy = function () {
        function n(u) {
            ...
            for (u.depth = 0; null != (i = a.pop()); )
                if (
                    (o.push(i), (c = e.call(n, i, i.depth)) && (l = c.length))
                ) {
                    for (var l, c, s; --l >= 0; )
                        a.push((s = c[l])),
                            (s.parent = i),
    ...
    oa.layout.stack = function () {
        function n(o, l) {
            ...
            for (p = 0; m > p; ++p)
                for (
                    u.call(n, c[0][p], (v = d[p]), s[0][p][1]), g = 1;
                    h > g;
                    ++g
                )
        ...
        (oa.layout.pack = function () {
            function n(n, i) {
                ...
                if (
                    ...
                    var f =
                        (r * (t ? 1 : Math.max((2 * o.r) / l, (2 * o.r) / c))) /
                        2;
                    au(o, function (n) {
                        n.r += f;
                    }),
                    ...
                    var a,
                        ...
                        v =
                            "slice" === g
                                ...
                                : Math.min(c.dx, c.dy);
                    for (
                        n(h, (c.dx * c.dy) / e.value), s.area = 0;
                        (l = h.length) > 0;
                        ...
                        s.push((a = h[l - 1])),
                            ...
                            "squarify" !== g || (o = r(s, v)) <= p
                                ...
                                : ((s.area -= s.pop().area),
                                  ...
                                  (s.length = s.area = 0),
                                  (p = 1 / 0));
                    s.length && (u(s, v, c, !0), (s.length = s.area = 0)),
                        i.forEach(t);
                }
            }
            function e(t) {
                ...
                if (r && r.length) {
                    var i,
                        ...
                        l = [];
                    for (
                        n(o, (a.dx * a.dy) / t.value), l.area = 0;
                        (i = o.pop());
    ...
    (Il.call = Aa.call),
        ...
        (Il.attrTween = function (n, t) {
            ...
            function r(n, e) {
                var r = t.call(
                    ...
                    n,
                    e,
                    this.getAttributeNS(u.space, u.local)
                );
                return (
                    r &&
                    function (n) {
        ...
        (Il.styleTween = function (n, e, r) {
            ...
            return (
                arguments.length < 3 && (r = ""), this.tween("style." + n, u)
            );
        }),
        (Il.text = function (n) {
        ...
        (Il.each = function (n, t) {
            ...
            if (arguments.length < 2) {
                ...
                Y(this, function (u) {
                    ...
                    (
                        i.event ||
                        (i.event = oa.dispatch("start", "end", "interrupt"))
                    ).on(n, t);
                });
            return this;
        }),
    ...
    oa.svg.brush = function () {
        ...
        function i() {
            ...
            function d() {
                ...
                x && ((n[0] += x[0]), (n[1] += x[1])),
                    ...
                    t &&
                        (e(k),
                        w({ type: "brush", mode: C ? "move" : "resize" }));
            }
            function m(n, t, e) {
                var r,
                    u,
        ...
        return (
            ...
            (n.clear = function () {
                return (
                    n.empty() || ((f = [0, 0]), (h = [0, 0]), (a = o = null)), n
                );
            }),
            (n.empty = function () {

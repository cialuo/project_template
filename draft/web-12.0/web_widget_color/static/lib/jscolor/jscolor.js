...
if (!window.jscolor) {
    window.jscolor = (function () {
        var jsc = {
            ...
            setStyle: (function () {
                ...
                return function (elm, prop, value) {
                    switch (prop.toLowerCase()) {
                        case "opacity":
                            var alphaOpacity = Math.round(
                                parseFloat(value) * 100
                            );
                            elm.style.opacity = value;
                            elm.style.filter =
                                "alpha(opacity=" + alphaOpacity + ")";
                            break;
                        default:
            ...
            onControlPointerStart: function (
                e,
                target,
                controlName,
                pointerType
            ...
            createPalette: function () {
                ...
                if (jsc.isCanvasSupported) {
                    ...
                    var drawFunc = function (width, height, type) {
                        ...
                        var vGrad = ctx.createLinearGradient(
                            0,
                            0,
                            0,
                            canvas.height
                    ...
                    var drawFunc = function (width, height, type) {
                        ...
                        hRect.style.width = vRect.style.width =
                            width + 1 + "px";
                        hRect.style.height = vRect.style.height =
                            height + 1 + "px";
            ...
            jscolor: function (targetElement, options) {
                ...
                this.fromString = function (str, flags) {
                    var m;
                    if (
                        (m = str.match(/^\W*([0-9A-F]{3}([0-9A-F]{3})?)\W*$/i))
                    ) {
                        // HEX notation
                        //
                ...
                this.toString = function () {
                    return (
                        (0x100 | Math.round(this.rgb[0]))
                            .toString(16)
                            .substr(1) +
                        (0x100 | Math.round(this.rgb[1]))
                            .toString(16)
                            .substr(1) +
                ...
                this._processParentElementsInDOM = function () {
                    ...
                    do {
                        ...
                        if (
                            currStyle &&
                            currStyle.position.toLowerCase() === "fixed"
                        ) {
                            this.fixed = true;
                        }
                ...
                function drawPicker() {
                    ...
                    p.cross.style.width = p.cross.style.height =
                        crossOuterSize + "px";

                    // pad cross border Y and X
                    p.crossBY.style.position = p.crossBX.style.position =
                        "absolute";
                    ...
                    p.crossLY.style.position = p.crossLX.style.position =
                        "absolute";
                ...
                if (typeof targetElement === "string") {
                    ...
                    if (elm) {
                        ...
                        jsc.warn(
                            "Could not find target element with ID '" + id + "'"
                        );
                    }
		...
		*/
                ...
                if (this.styleElement) {
                    this.styleElement._jscOrigStyle = {
                        backgroundImage: this.styleElement.style
                            .backgroundImage,
                        backgroundColor: this.styleElement.style
                            .backgroundColor,

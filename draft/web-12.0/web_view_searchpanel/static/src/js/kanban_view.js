    ...
    KanbanView.include({
        ...
        _createSearchPanel: function (parent) {
            ...
            return searchPanel
                ...
                .then(function () {
                    ...
                    self.loadParams.domain = controlPanelDomain.concat(
                        searchPanelDomain
                    );
                });
        },
        ...
        _processSearchPanelNode: function (node, fv) {
            ...
            node.children.forEach(function (childNode, index) {
                ...
                var type =
                    childNode.attrs.select === "multi" ? "filter" : "category";

                var sectionId = _.uniqueId("section_");
                var section = {
                    color: childNode.attrs.color,
                    description:
                        childNode.attrs.string || fv.fields[fieldName].string,
                    fieldName: fieldName,

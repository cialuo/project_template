...
odoo.define(
    "web_widget_model_viewer.FieldBinaryModelViewer",
    function (require) {
        "use strict";
        ...
        var FieldBinaryModelViewer = BasicFields.FieldBinaryFile.extend({
            ...
            init: function () {
                ...
                if (max_upload_size) {
                    this.max_upload_size =
                        parseInt(max_upload_size) * 1024 * 1024;
                } else {
            ...
            _render: function () {
                ...
                var $glb = $(
                    qweb.render("FieldBinaryModelViewer-glb", {
                        widget: this,
                        url: url,
                    })
                );
            ...
            fullscreen: function (ev) {
                ...
                if (isFullscreenAvailable) {
                    ...
                    console.error(
                        "ERROR : full screen not supported by web browser"
                    );
                }
            },
        });

...
odoo.define("web_timeline.TimelineView", function (require) {
    ...
    var TimelineView = AbstractView.extend({
        ...
        init: function (viewInfo, params) {
            ...
            this.stack = true;
            if (
                !isNullOrUndef(attrs.stack) &&
                !_.str.toBoolElse(attrs.stack, "true")
            ) {
                this.stack = false;
            }
            this.options = {
            ...
            if (
                ...
                !_.str.toBoolElse(attrs.event_open_popup, true)
            ) {
        ...
        parse_colors: function () {
            if (this.arch.attrs.colors) {
                this.colors = _(this.arch.attrs.colors.split(";"))
                    .chain()
                    .compact()

odoo.define("web_timeline.TimelineController", function (require) {
    ...
    var TimelineController = AbstractController.extend({
        ...
        update: function (params, options) {
            ...
            return $.when(
                ...
                self
                    ...
                    .then(function (data) {
                        return self.renderer.on_data_loaded(
                            data,
                            n_group_bys,
        ...
        _onAdd: function (event) {
            ...
            if (this.date_start) {
                default_context["default_".concat(this.date_start)] = moment(
                    item.start
                )
                    .add(1, "hours")
            ...
            if (this.date_stop && item.end) {
                default_context["default_".concat(this.date_stop)] = moment(
                    item.end
                )
                    .add(1, "hours")
                    .format("YYYY-MM-DD HH:mm:ss");
            ...
            if (item.group > 0) {
                default_context[
                    "default_".concat(this.renderer.last_group_bys[0])
                ] = item.group;
            }
            // Show popup
            new dialogs.FormViewDialog(this, {

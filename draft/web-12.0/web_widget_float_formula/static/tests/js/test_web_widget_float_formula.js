 ...
 */
odoo.define(
    "web_widget_float_formula.test_web_widget_float_formula",
    function (require) {
        "use strict";
        ...
        QUnit.module("web_widget_float_formula", {}, function () {
            QUnit.test("float field", async function (assert) {
                ...
                testUtils.fields.editInput(
                    test_field,
                    "=(1.5+8.0/2.0-(15+5)*0.1)"
                );
            ...
            QUnit.test("monetary field", async function (assert) {
                ...
                const form = await testUtils.createAsyncView({
                    ...
                    data: {
                        demo_entry: {
                            ...
                            records: [
                                { id: 1, test_field: 0.0, currency_id: 1 },
                            ],
                        },
                        currency: {
                            fields: {
                ...
                var test_field = form.$('.o_field_widget[name="test_field"]');
                var test_field_input = form.$(
                    '.o_field_widget[name="test_field"] input'
                );

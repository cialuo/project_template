...
odoo.define(
    "web_widget_one2many_product_picker.FieldOne2ManyProductPicker",
    function (require) {
        "use strict";
        ...
        var FieldOne2ManyProductPicker = FieldOne2Many.extend({
            ...
            init: function (parent, name, record) {
                ...
                if (!(this.options.search[0] instanceof Array)) {
                    this._searchCategoryNames = _.map(
                        this.options.search,
                        "name"
                    );
                }
            ...
            updateBadgeLines: function () {
                var records = this.parent_controller.model.get(this.state.id)
                    .data[this.name].data;
            ...
            _renderButtons: function () {
                ...
                this.$groups = $(
                    qweb.render(
                        "One2ManyProductPicker.ControlPanelGroupButtons",
                        {
            ...
            doRenderSearchRecords: function () {
                ...
                return $.Deferred(function (d) {
                    self._getSearchRecords().then(function () {
                        ...
                        self.renderer
                            ._renderView()
                            .then(function (virtualStateDefs) {
            ...
            _addMaximizeButton: function () {
                ...
                this.$btnMaximize = $(
                    qweb.render("One2ManyProductPicker.ButtonMaximize")
                );
                this.$btnMaximize
                    .appendTo(this.$el)
                ...
                var context = _.extend(
                    {
                        ...
                        active_search_involved_fields: this._searchContext
                            .involvedFields,
            ...
            _onCreateQuickRecord: function (evt) {
                ...
                if (!self.options.auto_save) {
                    self.parent_controller.model.updateRecordContext(
                        evt.data.id,
                        {
        ...
        field_registry.add(
            "one2many_product_picker",
            FieldOne2ManyProductPicker
        );

    ...
    function (require) {
        ...
        var ProductPickerQuickModifPriceForm = Widget.extend({
            ...
            start: function () {
                ...
                this.formView = new ProductPickerQuickModifPriceFormView(
                    fieldsView,
                    {
                        ...
                        mode:
                            this.res_id && this.readonly ? "readonly" : "edit",
                        recordID: this.id,
                        index: 0,
                ...
                if (this.id) {
                    this.basicFieldParams.model.save(this.id, {
                        savePoint: true,
                    });
                }
                var def2 = this.formView
                    .getController(this)
            ...
            _getWantedFieldState: function () {
                ...
                wantedFieldState[this.fieldMap.discount] = !this
                    .canEditDiscount;

    ...
    function (require) {
        ...
        var One2ManyProductPickerRecord = Widget.extend({
            ...
            generateVirtualState: function () {
                return this._generateVirtualState().then(
            ...
            _getInternalVirtualRecordContext: function () {
                var context = {};
                context[
                    "default_" + this.options.basicFieldParams.relation_field
            ...
            _generateVirtualState: function (data, context) {
                ...
                scontext[
                    `default_${this.options.fieldMap.product_uom_qty}`
                ] = 1.0;
                var sdata = _.extend(
                    {},
            ...
            _render: function () {
                ...
                this.$el.data(
                    "renderer_widget_index",
                    this.options.renderer_widget_index
                );
            ...
            _processWidgetFields: function ($container, widget_list) {
                ...
                $container.find("field").each(function () {
                    ...
                    if (
                        field_widget ||
                        self.fields[field_name].type === "many2many"
                    ) {
            ...
            _processDynamicFields: function (fields) {
                ...
                this.$el.find(to_find.join()).each(function () {
                    ...
                    $elm.html(
                        py.eval(
                            format_out,
                            _.extend({}, state_data, self.recordSearch)
                        )
                    );
                });
            ...
            _addProduct: function () {
                ...
                var changes = {};
                if (
                    this.state.data[this.options.fieldMap.product_uom_qty] === 0
                ) {
                ...
                return model
                    .notifyChanges(this.state.id, changes)
                    .then(function () {
                        self._saveRecord();
                    });
            },
            ...
            _incProductQty: function (amount) {
                ...
                return model
                    .notifyChanges(record.id, changes)
                    .then(function () {
            ...
            _openPriceModifier: function () {
                ...
                var modif_price_form = new ProductPickerQuickModifPriceForm(
                    this,
                    {
            ...
            _onClickFlipCard: function (evt) {
                ...
                if (
                    ["INPUT", "BUTTON", "A"].indexOf(evt.target.tagName) !==
                        -1 ||

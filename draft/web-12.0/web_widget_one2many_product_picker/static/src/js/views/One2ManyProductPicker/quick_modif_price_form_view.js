    ...
    function (require) {
        ...
        var ProductPickerQuickModifPriceFormRenderer = QuickCreateFormView.prototype.config.Renderer.extend(
            {
                ...
                _appendButtons: function () {
                    this.$el
                        .find(".oe_one2many_product_picker_form_buttons")
                        .remove();
                    this.$el.append(
                        qweb.render(
                ...
                _appendPrice: function () {
                    ...
                    this.$el.append(
                        qweb.render(
                            "One2ManyProductPicker.QuickModifPrice.Price"
                        )
                    );
                },
            }
                ...
                _updatePrice: function () {
                    ...
                    this.renderer.$el
                        ...
                        .html(
                            tools.monetary(
                                price_reduce,
                                this.getParent().state.fields[
                                    this.fieldMap.price_unit
                                ],
                                this.currencyField,
                                record
                            )
        ...
        var ProductPickerQuickModifPriceFormView = QuickCreateFormView.extend({
            ...
            init: function (viewInfo, params) {
                ...
                this.controllerParams.parentRecordData =
                    params.parentRecordData;

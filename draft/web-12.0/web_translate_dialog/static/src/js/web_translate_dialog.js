...
odoo.define("web_translate_dialog.translate_dialog", function (require) {
    ...
    var TranslateDialog = Dialog.extend({
        ...
        open: function () {
            ...
            return $.when(this.languages_loaded).then(
                $.proxy(this._super, this)
            );
        },
        start: function () {
            var self = this;
        ...
        initialize_html_fields: function (lang) {
            ...
            this.$(
                '.oe_form_field_html .oe_translation_field[name^="' +
                    lang +
                    '-"]'
            ).each(function () {
                var $parent = $(this)

...
class PartnerService(Component):
    ...
    _usage = "partner"
    _collection = "hpu.api.partner.services"
    _description = """
        Partner Services
    ...
    def search(self, name):
        ...
        _logger.info('partners %s', str(partners))
    ...
    def _validator_create(self):
        res = {
            ...
            "phone_sanitized": {"type": "string", "required": True, "empty": False},
            "state": {
                "type": "dict",
                "schema": {
    ...
    def _to_json(self, partner):
        _logger.info('partner %s', model_data(partner))
        res = {
            "id": partner.id,
            "name": partner.name,

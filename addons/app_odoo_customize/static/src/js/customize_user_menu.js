  ...
  UserMenu.include({
        ...
        .then(function (res) {
          _.each(res, function (lang) {
            ...
            lang_list +=
              ...
              lang["code"] +
              '"><img class="flag" src="app_odoo_customize/static/src/img/flags/' +
              lang["code"] +
              '.png"/>' +
              lang["name"] +
              a +
      ...
      self
        ...
        .then(function (res) {
          $.each(res, function (key, val) {
            ...
            if (val.key == "app_support_url") support_url = val.value;
            if (val.key == "app_account_title") account_title = val.value;
            if (val.key == "app_account_url") account_url = val.value;
            //  控制显示
            ...
            if (
              ...
              (val.key == "app_show_debug" && val.value == "False")
            ) {
            ...
            if (
              val.key == "app_show_documentation_dev" &&
              val.value == "False"
            ) {
    ...
    start: function () {
      ...
      return this._super.apply(this, arguments).then(function () {
        ...
        //控制debug显示
        var mMode = "normal";
        if (window.location.href.indexOf("debug=1") != -1) mMode = "debug";

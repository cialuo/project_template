...
class HrWorkEntryRegenerationWizard(models.TransientModel):
    ...
    def regenerate_work_entries(self):
        ...
        if self.earliest_available_date and self.date_from < self.earliest_available_date or self.latest_available_date and self.date_to > self.latest_available_date:

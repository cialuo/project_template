  ...
  (function () {
    ...
    (function (root, factory) {
      ...
      var OverlayManager = {
        overlays: {},
        active: null,
        register: function overlayManagerRegister(
          name,
          element,
          callerCloseMethod,
          canForceClose
    ...
    (function (root, factory) {
      ...
      var PDFRenderingQueue = (function PDFRenderingQueueClosure() {
        ...
        PDFRenderingQueue.prototype = {
          ...
          isHighestPriority: function PDFRenderingQueue_isHighestPriority(
            view
          ) {
            return this.highestPriorityPage === view.renderingId;
          },
          renderHighestPriority: function PDFRenderingQueue_renderHighestPriority(
          ...
          getHighestPriority: function PDFRenderingQueue_getHighestPriority(
            visible,
            views,
            scrolledDown
          ) {
    ...
    (function (root, factory) {
      ...
      var Preferences = {
        ...
        initialize: function preferencesInitialize() {
          return (this.initializedPromise = getDefaultPreferences()
            .then(
              function (defaults) {
            ...
            function () {
              ...
              if (valueType !== defaultType) {
                ...
                if (valueType === "number" && (value | 0) !== value) {
                  throw new Error(
                    "Preferences_set: '" + value + '\' must be an "integer".'
                  );
                }
              }
          ...
          this.initializedPromise = this._readFromStorage().then(
            function (databaseStr) {
              ...
              if (typeof index !== "number") {
                index =
                  database.files.push({ fingerprint: this.fingerprint }) - 1;
              }
    ...
    (function (root, factory) {
      ...
      var PDFAttachmentViewer = (function PDFAttachmentViewerClosure() {
        ...
        PDFAttachmentViewer.prototype = {
          ...
          _dispatchEvent: function PDFAttachmentViewer_dispatchEvent(
            attachmentsCount
          ) {
          ...
          _bindLink: function PDFAttachmentViewer_bindLink(
            button,
            content,
            filename
          ) {
    ...
    (function (root, factory) {
      ...
      var PDFOutlineViewer = (function PDFOutlineViewerClosure() {
        ...
        PDFOutlineViewer.prototype = {
          ...
          _toggleOutlineItem: function PDFOutlineViewer_toggleOutlineItem(
            root,
            show
          ) {
      ...
      var PDFSidebar = (function PDFSidebarClosure() {
        ...
        PDFSidebar.prototype = {
          ...
          _updateThumbnailViewer: function PDFSidebar_updateThumbnailViewer() {
            ...
            thumbnailViewer.scrollThumbnailIntoView(
              pdfViewer.currentPageNumber
            );
          },
          _addEventListeners: function PDFSidebar_addEventListeners() {
            var self = this;
            self.mainContainer.addEventListener(
              "transitionend",
              function (evt) {
                if (evt.target === this) {
            ...
            self.eventBus.on("attachmentsloaded", function (e) {
              ...
              if (
                !attachmentsCount &&
                self.active === SidebarView.ATTACHMENTS
              ) {
                self.switchView(SidebarView.THUMBS);
              }
            });
    ...
    (function (root, factory) {
      ...
      var PDFJS = pdfjsLib.PDFJS;
      PDFJS.disableFullscreen =
        PDFJS.disableFullscreen === undefined ? false : PDFJS.disableFullscreen;
      PDFJS.useOnlyCssZoom =
        PDFJS.useOnlyCssZoom === undefined ? false : PDFJS.useOnlyCssZoom;
      PDFJS.maxCanvasPixels =
        PDFJS.maxCanvasPixels === undefined ? 16777216 : PDFJS.maxCanvasPixels;
      PDFJS.disableHistory =
        PDFJS.disableHistory === undefined ? false : PDFJS.disableHistory;
      PDFJS.disableTextLayer =
        PDFJS.disableTextLayer === undefined ? false : PDFJS.disableTextLayer;
      PDFJS.ignoreCurrentPositionOnZoom =
        PDFJS.ignoreCurrentPositionOnZoom === undefined
          ? false
          : PDFJS.ignoreCurrentPositionOnZoom;
      PDFJS.locale =
        PDFJS.locale === undefined ? navigator.language : PDFJS.locale;
      ...
      function parseQueryString(query) {
        ...
        for (var i = 0, ii = parts.length; i < ii; ++i) {
          ...
          var value =
            param.length > 1 ? param.slice(1, param.length).join("=") : null;
      ...
      function getVisibleElements(scrollEl, views, sortByVisibility) {
        ...
        for (var i = firstVisibleElementInd, ii = views.length; i < ii; i++) {
          ...
          percentHeight =
            (((viewHeight - hiddenHeight) * 100) / viewHeight) | 0;
          visible.push({
            id: view.id,
            x: currentWidth,
            y: currentHeight,
    ...
    (function (root, factory) {
      ...
      var HandTool = (function HandToolClosure() {
        function HandTool(options) {
          ...
          Promise.all([localized, Preferences.get("enableHandToolOnLoad")])
            .then(
    ...
    (function (root, factory) {
      ...
      var PasswordPrompt = (function PasswordPromptClosure() {
        ...
        PasswordPrompt.prototype = {
          open: function PasswordPrompt_open() {
            OverlayManager.open(this.overlayName).then(
              function () {
                ...
                this.input.focus();
                var promptString = mozL10n.get(
                  "password_label",
                  null,
                  "Enter the password to open this PDF file."
                );
                if (
                  this.reason === pdfjsLib.PasswordResponses.INCORRECT_PASSWORD
                ) {
                  promptString = mozL10n.get(
                    "password_invalid",
                    null,
          ...
          setUpdateCallback: function PasswordPrompt_setUpdateCallback(
            updateCallback,
            reason
          ) {
    ...
    (function (root, factory) {
      ...
      var PDFDocumentProperties = (function PDFDocumentPropertiesClosure() {
        ...
        PDFDocumentProperties.prototype = {
          ...
          setDocumentAndUrl: function PDFDocumentProperties_setDocumentAndUrl(
            pdfDocument,
            url
          ) {
    ...
    (function (root, factory) {
      ...
      var PDFFindController = (function PDFFindControllerClosure() {
        ...
        PDFFindController.prototype = {
          ...
          executeCommand: function PDFFindController_executeCommand(
            cmd,
            state
          ) {
          ...
          updateMatch: function PDFFindController_updateMatch(found) {
            ...
            if (found) {
              ...
              if (
                previousPage !== -1 &&
                previousPage !== this.selected.pageIdx
              ) {
        ...
        PDFPresentationMode.prototype = {
          ...
          _setSwitchInProgress: function PDFPresentationMode_setSwitchInProgress() {
            ...
            this.switchInProgress = setTimeout(
              function switchInProgressTimeout() {
          ...
          _enter: function PDFPresentationMode_enter() {
            ...
            setTimeout(
              function enterPresentationModeTimeout() {
          ...
          _exit: function PDFPresentationMode_exit() {
            ...
            setTimeout(
              function exitPresentationModeTimeout() {
                this.active = false;
                this._removeFullscreenChangeListeners();
                this._notifyStateChange();
    ...
    (function (root, factory) {
      ...
      var SecondaryToolbar = (function SecondaryToolbarClosure() {
        ...
        SecondaryToolbar.prototype = {
          ...
          _bindHandToolListener: function SecondaryToolbar_bindHandToolListener(
            toggleHandToolButton
          ) {
            ...
            this.eventBus.on("handtoolchanged", function (e) {
              ...
              if (isHandToolActive) {
                toggleHandToolButton.title = mozL10n.get(
                  "hand_tool_disable.title",
                  null,
                  "Disable hand tool"
                );
                toggleHandToolButton.firstElementChild.textContent = mozL10n.get(
    ...
    (function (root, factory) {
      ...
      var Toolbar = (function ToolbarClosure() {
        ...
        Toolbar.prototype = {
          ...
          _updateUIState: function Toolbar_updateUIState(resetNumPages) {
            function selectScaleOption(value, scale) {
              ...
              if (!predefinedValueFound) {
                ...
                items.customScaleOption.textContent = mozL10n.get(
                  "page_scale_percent",
                  { scale: customScale },
                  "{{scale}}%"
                );
            ...
            if (resetNumPages) {
              if (this.hasPageLabels) {
                ...
                items.numPages.textContent = mozL10n.get(
                  "of_pages",
          ...
          updateLoadingIndicatorState: function Toolbar_updateLoadingIndicatorState(
            loading
          ) {
      ...
      var PDFFindBar = (function PDFFindBarClosure() {
        function PDFFindBar(options) {
          ...
          if (this.findController === null) {
            throw new Error(
              "PDFFindBar cannot be used without a " +
      ...
      PDFHistory.prototype = {
        initialize: function pdfHistoryInitialize(fingerprint) {
          ...
          function pdfHistoryBeforeUnload() {
            ...
            if (previousParams) {
              var replacePrevious =
                !self.current.dest && self.current.hash !== self.previousHash;
        ...
        updateCurrentBookmark: function pdfHistoryUpdateCurrentBookmark(
          bookmark,
          pageNum
        ) {
          if (this.initialized) {
          ...
          if (params.dest && !params.hash) {
            params.hash =
              ...
              this.current.dest === params.dest
                ? this.current.hash
                : this.linkService
                    .getDestinationHash(params.dest)
                    .split("#")[1];
          }
          if (params.page) {
            params.page |= 0;
        ...
        _pushToHistory: function pdfHistory_pushToHistory(
          params,
          addPrevious,
          overwrite
        ) {
    ...
    (function (root, factory) {
      ...
      var PDFLinkService = (function PDFLinkServiceClosure() {
        ...
        PDFLinkService.prototype = {
          setDocument: function PDFLinkService_setDocument(
            pdfDocument,
            baseUrl
          ) {
          ...
          setHash: function PDFLinkService_setHash(hash) {
            ...
            if (hash.indexOf("=") >= 0) {
              ...
              if (isPageNumber(hash) && hash <= this.pagesCount) {
                console.warn(
                  "PDFLinkService_setHash: specifying a page number " +
          ...
          executeNamedAction: function PDFLinkService_executeNamedAction(
            action
          ) {
            switch (action) {
              case "GoBack":
    ...
    (function (root, factory) {
      ...
      this,
      function (exports, uiUtils, pdfRenderingQueue, domEvents, pdfjsLib) {
            ...
            paintOnCanvas: function (canvasWrapper) {
              ...
              if (pdfjsLib.PDFJS.maxCanvasPixels > 0) {
                ...
                var maxScale = Math.sqrt(
                  pdfjsLib.PDFJS.maxCanvasPixels / pixelsInViewport
                );
    ...
    (function (root, factory) {
      ...
      var PDFThumbnailViewer = (function PDFThumbnailViewerClosure() {
        ...
        PDFThumbnailViewer.prototype = {
          ...
          scrollThumbnailIntoView: function PDFThumbnailViewer_scrollThumbnailIntoView(
            page
          ) {
          ...
          setDocument: function PDFThumbnailViewer_setDocument(pdfDocument) {
            ...
            return pdfDocument.getPage(1).then(
              function (firstPage) {
          ...
          _ensurePdfPageLoaded: function PDFThumbnailViewer_ensurePdfPageLoaded(
            thumbView
          ) {
    ...
    (function (root, factory) {
      ...
      var TextLayerBuilder = (function TextLayerBuilderClosure() {
        ...
        TextLayerBuilder.prototype = {
          ...
          setTextContent: function TextLayerBuilder_setTextContent(
            textContent
          ) {
            this.cancel();
          ...
          convertMatches: function TextLayerBuilder_convertMatches(
            ...
            for (var m = 0, len = matches.length; m < len; m++) {
              ...
              while (
                i !== end &&
                matchIdx >= iIndex + bidiTexts[i].str.length
              ) {
          ...
          updateMatches: function TextLayerBuilder_updateMatches() {
            ...
            if (this.findController !== null) {
              pageMatches =
                this.findController.pageMatches[this.pageIdx] || null;
          ...
          _bindMouse: function TextLayerBuilder_bindMouse() {
            ...
            div.addEventListener("mousedown", function (e) {
              ...
              if (adjustTop) {
                ...
                var r = Math.max(
                  0,
                  (e.pageY - divBounds.top) / divBounds.height
                );
      ...
      DefaultTextLayerFactory.prototype = {
        createTextLayerBuilder: function (
          textLayerDiv,
          pageIndex,
          viewport,
    ...
    (function (root, factory) {
      ...
      DefaultAnnotationLayerFactory.prototype = {
        createAnnotationLayerBuilder: function (
          pageDiv,
          pdfPage,
      ...
      function (
        ...
        var PDFViewer = (function pdfViewer() {
          ...
          PDFViewer.prototype = {
            ...
            _setCurrentPageNumber: function PDFViewer_setCurrentPageNumber(
              val,
            ...
            set currentScale(val) {
              ...
              if (!this.pdfDocument) {
                ...
                this._currentScaleValue =
                  val !== UNKNOWN_SCALE ? val.toString() : null;
                return;
              }
            ...
            _setScaleUpdatePages: function pdfViewer_setScaleUpdatePages(
              ...
              if (!noScroll) {
                ...
                if (
                  this._location &&
                  !pdfjsLib.PDFJS.ignoreCurrentPositionOnZoom &&
                  !(
            ...
            update: function PDFViewer_update() {
              ...
              var suggestedCacheSize = Math.max(
                DEFAULT_CACHE_SIZE,
              ...
              for (
                var i = 0, ii = visiblePages.length, stillFullyVisible = false;
                i < ii;
                ++i
              ) {
    ...
    (function (root, factory) {
      ...
      function (
        ...
        pdfSidebarLib,
        viewHistoryLib,
        pdfThumbnailViewerLib,
        toolbarLib,
        secondaryToolbarLib,
        passwordPromptLib,
        pdfPresentationModeLib,
        pdfDocumentPropertiesLib,
        handToolLib,
        pdfViewerLib,
        pdfRenderingQueueLib,
        pdfLinkServiceLib,
        pdfOutlineViewerLib,
        overlayManagerLib,
        pdfAttachmentViewerLib,
        pdfFindControllerLib,
        pdfFindBarLib,
        domEventsLib,
        pdfjsLib
      ) {
        ...
        var PDFDocumentProperties =
          pdfDocumentPropertiesLib.PDFDocumentProperties;
        ...
        var PDFViewerApplication = {
          ...
          _readPreferences: function () {
            ...
            return Promise.all([
              ...
              Preferences.get("sidebarViewOnLoad").then(function resolved(
                value
              ) {
              ...
              Preferences.get("showPreviousViewOnLoad").then(function resolved(
                value
              ) {
                self.viewerPrefs["showPreviousViewOnLoad"] = value;
              }),
              Preferences.get("defaultZoomValue").then(function resolved(
                value
              ) {
                self.viewerPrefs["defaultZoomValue"] = value;
              }),
              Preferences.get("enhanceTextSelection").then(function resolved(
                value
              ) {
                self.viewerPrefs["enhanceTextSelection"] = value;
              }),
              Preferences.get("disableTextLayer").then(function resolved(
                value
              ) {
              ...
              Preferences.get("disableAutoFetch").then(function resolved(
                value
              ) {
              ...
              Preferences.get("externalLinkTarget").then(function resolved(
                value
              ) {
              ...
              Preferences.get("renderInteractiveForms").then(function resolved(
                value
              ) {
                self.viewerPrefs["renderInteractiveForms"] = value;
              }),
              Preferences.get("disablePageLabels").then(function resolved(
                value
              ) {
          ...
          _initializeViewerComponents: function () {
            ...
            return new Promise(function (resolve, reject) {
              ...
              self.pdfViewer = new PDFViewer({
                ...
                renderInteractiveForms:
                  self.viewerPrefs["renderInteractiveForms"],
              });
              ...
              self.findController.onUpdateState = function (
                state,
                previous,
                matchCount
              ) {
              ...
              self.pdfDocumentProperties = new PDFDocumentProperties(
              ...
              self.secondaryToolbar = new SecondaryToolbar(
              ...
              self.passwordPrompt = new PasswordPrompt(
          ...
          setTitleUsingUrl: function pdfViewSetTitleUsingUrl(url) {
            ...
            try {
              this.setTitle(
                decodeURIComponent(pdfjsLib.getFilenameFromUrl(url)) || url
              );
            } catch (e) {
              this.setTitle(url);
            }
          ...
          open: function pdfViewOpen(file, args) {
            ...
            loadingTask.onPassword = function passwordNeeded(
              updateCallback,
              reason
            ) {
            ...
            loadingTask.onProgress = function getDocumentProgress(
              progressData
            ) {
            ...
            return loadingTask.promise.then(
              ...
              function getDocumentError(exception) {
                ...
                if (exception instanceof pdfjsLib.InvalidPDFException) {
                  loadingErrorMessage = mozL10n.get(
                    "invalid_file_error",
                    null,
          ...
          load: function pdfViewLoad(pdfDocument, scale) {
            ...
            var downloadedPromise = pdfDocument
              .getDownloadInfo()
              .then(function () {
              ...
              store.initializedPromise.then(
                function resolved() {
                  var storedHash = null,
                    sidebarView = null;
                  if (
                    self.viewerPrefs["showPreviousViewOnLoad"] &&
                    ...
                    storedHash =
                      "page=1&zoom=" + self.viewerPrefs["defaultZoomValue"];
                  }
          ...
          setInitialView: function pdfViewSetInitialView(storedHash, options) {
            ...
            this.pdfSidebar.setInitialView(
              this.viewerPrefs["sidebarViewOnLoad"] || sidebarView | 0
            );
          ...
          beforePrint: function pdfViewSetupBeforePrint() {
            ...
            if (!this.pdfViewer.pageViewsReady) {
              var notReadyMessage = mozL10n.get(
                "printing_not_ready",
                null,
          ...
          get hasEqualPageSizes() {
            ...
            for (var i = 1, ii = this.pagesCount; i < ii; ++i) {
              ...
              if (
                pageView.width !== firstPage.width ||
        ...
        function webViewerUpdateViewarea(e) {
          ...
          PDFViewerApplication.pdfHistory.updateCurrentBookmark(
            location.pdfOpenParams,
            location.pageNumber
          );
        ...
        function webViewerPageNumberChanged(e) {
          ...
          if (
            e.value !== pdfViewer.currentPageNumber.toString() &&
    ...
    (function (root, factory) {
      ...
      function renderProgress(index, total) {
        ...
        progressPerc.textContent = mozL10n.get(

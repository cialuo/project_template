...
odoo.define("report_pdf_preview.PreviewGenerator", function (require) {
  "use strict";
  ...
  var PreviewGenerator = core.Class.extend({
    ...
    createPreview: function (url, mimetype, extension, title) {
      ...
      if (matchedHandler) {
        ...
        $content.resolve(
          $(
            QWeb.render("UnsupportedContent", {
              url: url,
              mimetype: mimetype || _t("Unknown"),
  ...
  PreviewGenerator.createPreview = function (
    widget,
    url,
    mimetype,
    extension,
    ...
    return new PreviewGenerator(widget, {}).createPreview(
      url,
      mimetype,
      extension,
      title

...
odoo.define("report_pdf_preview.PreviewDialog", function (require) {
  "use strict";
  ...
  var PreviewDialog = Widget.extend({
    ...
    willStart: function () {
      ...
      return $.when(ajax.loadLibs(this), this._super()).then(function () {
        self.$modal = $(
          QWeb.render("PreviewDialog", { title: self.title, url: self.url })
        );
      });
    },
    start: function () {
      ...
      return this._super().then(function () {
        ...
        self.$modal
          ...
          .on("click", _.bind(self.maximize, self));
        self.$modal
          .find(".preview-minimize")
          .on("click", _.bind(self.minimize, self));
        self.$modal
          .find(".preview-print")
          .on("click", _.bind(self.print, self));
      });
    },
    renderElement: function () {
      ...
      var self = this;
      this.generator
        .createPreview(this.url, this.mimetype, this.extension, this.title)
  ...
  PreviewDialog.createPreviewDialog = function (
    parent,
    url,
    mimetype,
    extension,

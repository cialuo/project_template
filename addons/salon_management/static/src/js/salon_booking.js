odoo.define(
  "salon_management.website_salon_booking_system",
  function (require) {
    "use strict";
    ...
    $(document).on("click", "#submit_button", function () {
      ...
      if (
        ...
        if (
          isNaN(time_left_char) ||
          isNaN(time_right_char) ||
          time_separator != ":"
        ) {
            ...
            $.ajax({
              ...
              success: function (data) {
                window.location.href =
                  "/page/salon_management.salon_booking_thank_you";
              },
    ...
    $(document).on("click", "#check_button", function () {
      ...
      if (check_date != "") {
        ajax
          .jsonRpc("/page/salon_check_date", "call", { check_date: check_date })
          .then(function (order_details) {
            ...
            for (x in order_details) {
              ...
              order +=
                '<div class="col-lg-4 s_title pt16 pb16"><div style="height: 200px!important; text-align: center;' +

(function () {
  ...
  function d(a, b, d, e) {
    ...
    for (var p = 0; 3 > p; p++) (n[p] < 0 || n[p] > 1) && (n[p] = -1);
    return n;
  }
  ...
  var e = {
    ...
    k = function (a, b, c, d) {
      ...
      for (var q = 0; e > q; q++) c[q] = j[q];
      for (var q = 0; g > q; q++) c[q + e] = p[q];
      return e + g;
    },
    l = function (a, b) {
      var c,
    ...
    u = function (a, b, c) {
      if (t(a)) return { point: a[0], location: b };
      for (
  ...
  function () {
    ...
    var c = function (a) {
      ...
      d = function (a, b, d) {
        return (
          (a = c(a) ? a : [a.x, a.y]), (b = c(b) ? b : [b.x, b.y]), d(a, b)
        );
      },
      ...
      h = function (a, b, c, d) {
        if (d) {
          if ("undefined" != typeof a.path && a.path.indexOf)
            return { path: a.path, end: a.path.indexOf(c) };
          var e = { path: [], end: -1 },
            f = function (a) {
              e.path.push(a),
                a === c
    ...
    var a = this,
      ...
      E = function (a, b, c, d) {
        ...
        var l = [0, 0],
          ...
          r = !1,
          s = [0, 0],
          t = this.params.consumeStartEvent !== !1,
          v = this.el,
          x = this.params.clone,
          z = (this.params.scroll, b.multipleDrop !== !1),
          E = !1,
          F =
            b.ghostProxy === !0
              ? C
        ...
        (this.posses = []),
          ...
          (this.toGrid = function (a) {
            ...
            var b = this.params.grid ? this.params.grid[0] / 2 : L ? L : j / 2,
              c = this.params.grid ? this.params.grid[1] / 2 : L ? L : k / 2;
            return M(a, this.params.grid[0], this.params.grid[1], b, c);
          }),
          (this.snap = function (a, b) {
            if (null != v) {
              (a = a || (this.params.grid ? this.params.grid[0] : j)),
                (b = b || (this.params.grid ? this.params.grid[1] : k));
              var c = this.params.getPosition(v),
                d = this.params.grid ? this.params.grid[0] / 2 : L,
                e = this.params.grid ? this.params.grid[1] / 2 : L;
              this.params.setPosition(v, M(c, a, b, d, e));
            }
          }),
        ...
        var R = function (a) {
            return "function" == typeof a
              ? ((a._katavorioId = G()), a._katavorioId)
              : a;
          },
          S = {},
          T = function (a) {
        ...
        (this.downListener = function (a) {
          ...
          if (b && this.isEnabled() && this.canDrag()) {
            var d = T(a) && A(a, this.el, this.k);
            if (d) {
              if (J) {
                if (((K = h(this.el, a.target || a.srcElement, J)), null == K))
                  return;
              } else K = this.el;
              if (x)
                if (
                  ((v = K.cloneNode(!0)),
                  this.params.addClass(v, q.clonedDrag),
                  v.setAttribute("id", null),
                  ...
                  (v.style.left = e[0] + "px"),
                    (v.style.top = e[1] + "px"),
                    this.params.parent.appendChild(v);
                } else {
                  var g = f(K);
              ...
              t && y(a),
                ...
                v &&
                  v.parentNode &&
                  (s = [v.parentNode.scrollLeft, v.parentNode.scrollTop]),
                this.params.bind(document, "mousemove", this.moveListener),
                this.params.bind(document, "mouseup", this.upListener),
                i.markSelection(this),
                i.markPosses(this),
                this.params.addClass(document.body, c.noSelect),
                Z("beforeStart", { el: this.el, pos: m, e: a, drag: this });
          ...
          (this.moveListener = function (a) {
            if (l) {
              if (!r) {
                var b = Z("start", { el: this.el, pos: m, e: a, drag: this });
                if (b !== !1) {
                  if (!l) return;
                  this.mark(!0), (r = !0);
                } else this.abort();
              ...
              if (l) {
                ...
                v &&
                  v.parentNode &&
                  ((d += v.parentNode.scrollLeft - s[0]),
                  (e += v.parentNode.scrollTop - s[1])),
                  (d /= f),
                  (e /= f),
                  this.moveBy(d, e, a),
                  i.updateSelection(d, e, this),
                  i.updatePosses(d, e, this);
              }
            }
          }.bind(this)),
          (this.upListener = function (a) {
            l &&
              ...
              this.unmark(a),
              i.unmarkSelection(this, a),
              i.unmarkPosses(this, a),
              this.stop(a),
              i.notifyPosseDragStop(this, a),
              (r = !1),
              x &&
                (v && v.parentNode && v.parentNode.removeChild(v), (v = null)),
              (X.length = 0),
              Q &&
                Q(this.el, this.params.getPosition(this.el)) === !0 &&
                (this.params.setPosition(this.el, m), Z("revert", this.el)));
          }.bind(this)),
        ...
        b.events.start && Y.start.push(b.events.start),
          b.events.beforeStart && Y.beforeStart.push(b.events.beforeStart),
          b.events.stop && Y.stop.push(b.events.stop),
          b.events.drag && Y.drag.push(b.events.drag),
          b.events.revert && Y.revert.push(b.events.revert),
          (this.on = function (a, b) {
            Y[a] && Y[a].push(b);
          }),
          (this.off = function (a, b) {
            if (Y[a]) {
              for (var c = [], d = 0; d < Y[a].length; d++)
                Y[a][d] !== b && c.push(Y[a][d]);
              Y[a] = c;
            }
          });
        var Z = function (a, b) {
        ...
        (this.notifyStart = function (a) {
          ...
          (this.mark = function (a) {
            (m = this.params.getPosition(v)),
              (o = this.params.getPosition(v, !0)),
              (p = [o[0] - m[0], o[1] - m[1]]),
              (this.size = this.params.getSize(v)),
              (W = i.getMatchingDroppables(this)),
              w(W, !0, !1, this),
              this.params.addClass(v, this.params.dragClass || c.drag);
            var b;
            (b = this.params.getConstrainingRectangle
              ? this.params.getConstrainingRectangle(v)
              : this.params.getSize(v.parentNode)),
              (V = { w: b[0], h: b[1] }),
        ...
        (this.unmark = function (a, d) {
          if (
            (w(W, !1, !0, this),
            E && F(K)
              ? (($ = [v.offsetLeft, v.offsetTop]),
                K.parentNode.removeChild(v),
                (v = K))
              : ($ = null),
            this.params.removeClass(v, this.params.dragClass || c.drag),
            (W.length = 0),
            (E = !1),
            !d)
          ) {
            X.length > 0 && $ && b.setPosition(K, $), X.sort(H);
            for (var e = 0; e < X.length; e++) {
              var f = X[e].drop(this, a);
              if (f === !0) break;
            }
          }
        }),
          (this.moveBy = function (a, c, d) {
            ...
            if (F(this.el))
              if (e[0] !== f[0] || e[1] !== f[1]) {
                if (!E) {
                  var g = I(K);
                  b.addClass(g, q.ghostProxy),
                    K.parentNode.appendChild(g),
                    (v = g),
                    (E = !0);
                }
                f = e;
              } else E && (K.parentNode.removeChild(v), (v = K), (E = !1));
            var h = { x: f[0], y: f[1], w: this.size[0], h: this.size[1] },
              i = { x: h.x + p[0], y: h.y + p[1], w: h.w, h: h.h },
              j = null;
            this.params.setPosition(v, f);
            for (var k = 0; k < W.length; k++) {
              var l = {
                x: W[k].pagePosition[0],
                y: W[k].pagePosition[1],
                w: W[k].size[0],
                h: W[k].size[1],
              };
              this.params.intersects(i, l) &&
              (z || null == j || j === W[k].el) &&
              W[k].canDrop(this)
                ? (j || (j = W[k].el), X.push(W[k]), W[k].setHover(this, !0, d))
                : W[k].isHover() && W[k].setHover(this, !1, d);
            }
            Z("drag", { el: this.el, pos: f, e: d, drag: this });
          }),
          ...
          this.params.handle
            ? U(this.params.handle, !1)
            : U(this.params.filter, this.params.filterExclude);
      },
      F = function (a, b, c, d) {
        ...
        return null == a
          ...
          : ((a =
              "string" == typeof a || a.constructor === String
                ? document.getElementById(a)
                : a),
            null == a ? null : ((a._katavorio = a._katavorio || G()), a));
      };
              ...
              function (b) {
                if (((b = I(b)), null != b))
                  if (null == b._katavorioDrag) {
                    var e = k(c);
                    (b._katavorioDrag = new E(b, e, m, o)),
      ...
      x(
        ...
        function (a) {
          (this[a + "Scope"] = function (b, c) {
            y(b._katavorioDrag, c, this._dragsByScope, a + "Scope"),
              y(b._katavorioDrop, c, this._dropsByScope, a + "Scope");
          }.bind(this)),
            (this[a + "DragScope"] = function (b, c) {
              y(
                b.constructor === E ? b : b._katavorioDrag,
                c,
                this._dragsByScope,
                a + "Scope"
              );
            ...
            (this[a + "DropScope"] = function (b, c) {
              y(
                b.constructor === F ? b : b._katavorioDrop,
                c,
                this._dropsByScope,
                a + "Scope"
              );
    ...
    var a = this,
      ...
      d = function (a) {
        if (a._jsPlumb.paintStyle && a._jsPlumb.hoverPaintStyle) {
          var b = {};
          p.extend(b, a._jsPlumb.paintStyle),
            p.extend(b, a._jsPlumb.hoverPaintStyle),
        ...
        if (a.getDefaultType) {
          ...
          for (var j = 0, k = a._jsPlumb.types.length; k > j; j++) {
            ...
            if ("__default" !== l) {
              ...
              null != m &&
                ((i = b.merge(i, m, ["cssClass"], ["connector"])), h(f, m, l));
            }
          }
      ...
      removeType: function (a, b, c) {
        var d = g(a),
          ...
          f = function (a) {
            ...
            return -1 !== b
              ? (l(this, b), this._jsPlumb.types.splice(b, 1), !0)
              : !1;
          }.bind(this);
        if (null != d) {
      ...
      toggleType: function (a, b, c) {
        ...
        if (null != d) {
          for (var e = 0, f = d.length; f > e; e++) {
            ...
            -1 !== h
              ? (l(this, h), this._jsPlumb.types.splice(h, 1))
          ...
          null != this.canvas &&
            ...
            null != this._jsPlumb.hoverPaintStyle &&
              ...
              this._jsPlumb.instance.isSuspendDrawing() ||
                ((d = d || c()), this.repaint({ timestamp: d, recalc: !1 }))),
      ...
      o = (a.jsPlumbInstance = function (d) {
        ...
        var s = null,
          ...
          J = function (a, b, d, e) {
            if (!D) {
              ...
              var j = ta({ elId: h, offset: b, recalc: !1, timestamp: d });
              if (g && j && j.o)
                for (var k in g)
                  ta({
                    elId: g[k].id,
          ...
          L = function (a, c, d, e, g) {
            if (!p.headless) {
              ...
              if (h && p.isDragSupported(a, f)) {
                ...
                if (((i = p.extend({}, i)), p.isAlreadyDraggable(a, f)))
                  d.force && f.initDraggable(a, i);
                else {
                  ...
                  sa(e, a),
                    (i[l] = b.wrap(
                      ...
                      function () {
                        return (
                          f.setHoverSuspended(!0),
                          f
                            .select({ source: a })
                            .addClass(
                              f.elementDraggingClass +
                                " " +
                                f.sourceElementDraggingClass,
                              !0
                            ),
                          f
                            .select({ target: a })
                            .addClass(
                              f.elementDraggingClass +
                                " " +
                                f.targetElementDraggingClass,
                              !0
                            ),
                          f.setConnectionBeingDragged(!0),
                          i.canDrag ? d.canDrag() : void 0
                        );
                      },
                      !1
                    )),
                    (i[j] = b.wrap(i[j], function () {
                      var b = f.getUIPosition(arguments, f.getZoom());
                      null != b &&
                        (J(a, b, null, !0),
                        m && f.addClass(a, "jtk-dragged"),
                        (m = !0));
                    })),
                    (i[k] = b.wrap(i[k], function () {
                      for (
                        var a,
                          b = arguments[0].selection,
                          c = function (b) {
                            null != b[1] &&
                              ((a = f.getUIPosition([
                                { el: b[2].el, pos: [b[1].left, b[1].top] },
                              ])),
                              J(b[2].el, a)),
                              f.removeClass(b[0], "jtk-dragged"),
                              f
                                .select({ source: b[2].el })
                                .removeClass(
                                  f.elementDraggingClass +
                                    " " +
                                    f.sourceElementDraggingClass,
                              ...
                              f.getDragManager().dragEnded(b[2].el);
                          },
                          d = 0;
                        d < b.length;
                        d++
                        ...
                        c(b[d]);
                      (m = !1),
                        f.setHoverSuspended(!1),
                        f.setConnectionBeingDragged(!1);
                    }));
                  var n = Y(a);
                  A[n] = !0;
                  var o = A[n];
                  (i.disabled = null == o ? !1 : !o),
                    f.initDraggable(a, i),
                    f.getDragManager().register(a),
                    g && f.fire("elementDraggable", { el: a, options: i });
                }
              }
            }
          },
          ...
          O = function (a, c) {
            ...
            if (
              ...
              a.uuids &&
                ((d.sourceEndpoint = K(a.uuids[0])),
                (d.targetEndpoint = K(a.uuids[1]))),
              ...
              i = function (a, b, c, e) {
                if (
                  ...
                  if ((g = g ? g[e] : null)) {
                    ...
                    (d[a + "Endpoint"] = i),
                      !d.scope && g.def.scope && (d.scope = g.def.scope),
                      g.uniqueEndpoint
                        ? g.endpoint
                          ? (i.finalEndpoint = g.endpoint)
                          : ((g.endpoint = i), i.setDeleteOnEmpty(!1))
                        : i.setDeleteOnEmpty(!0),
                      0 === b &&
            ...
            return i(
              ...
              ? (d.sourceEndpoint &&
                  d.targetEndpoint &&
                  (M(d.sourceEndpoint, d.targetEndpoint) || (d = null)),
                d)
              : void 0;
          }.bind(f),
          P = function (a) {
            ...
            (a._jsPlumb = f),
              ...
              (a.newEndpoint = R),
              (a.endpointsByUUID = w),
              (a.endpointsByElement = v),
              (a.finaliseConnection = Q),
              (a.id = "con_" + H());
            var c = new b(a);
            return (
              c.isDetachable() &&
          ...
          Q = (f.finaliseConnection = function (a, b, c, d) {
            if (
              ((b = b || {}),
              a.suspendedEndpoint || u.push(a),
              (a.pending = null),
              (a.endpoints[0].isTemporarySource = !1),
              d !== !1 && f.anchorManager.newConnection(a),
              J(a.source),
          ...
          R = function (a, b) {
            ...
            (d._jsPlumb = f),
              ...
              (d.newEndpoint = R),
              (d.endpointsByUUID = w),
              (d.endpointsByElement = v),
              (d.fireDetachEvent = _),
              (d.elementId = b || Y(d.source));
            var e = new c(d);
            return (
              (e.id = "ep_" + H()),
              sa(d.elementId, d.source),
              p.headless || f.getDragManager().endpointAdded(d.source, b),
              e
            );
          },
          S = function (a, b, c) {
          ...
          T = function (a, b) {
            return p.each(a, function (a) {
              f.isDragSupported(a) &&
                ((A[f.getAttribute(a, "id")] = b), f.setElementDraggable(a, b));
            });
          },
          U = function (a, b, c) {
            b = "block" === b;
        ...
        var Z = [
          ...
          $ = function (a, b, c, d) {
            ...
            if (b.constructor === p.Endpoint)
              (e = b), e.addConnection(a), (b = e.element);
            else if (((f = Y(b)), (g = this[h.epDefs][f]), f === a[h.elId]))
              e = null;
            else if (g)
              for (var l in g) {
        ...
        this.unregisterEndpoint = function (a) {
          a._jsPlumb.uuid && (w[a._jsPlumb.uuid] = null),
        ...
        (this.deleteConnection = function (a, c) {
          return null != a &&
            ...
            ? (a.setHover(!1),
              _(a, !a.pending && c.fireEvent !== !1, c.originalEvent),
              a.endpoints[0].detachFromConnection(a),
              a.endpoints[1].detachFromConnection(a),
              b.removeWithFunction(u, function (b) {
                return a.id === b.id;
              }),
              a.cleanup(),
              a.destroy(),
        ...
        (this.select = function (a) {
          return (
            (a = a || {}),
            (a.scope = a.scope || "*"),
            na(a.connections || f.getConnections(a, !0))
          );
        }),
        ...
        var qa = function (a) {
          ...
          sa = (f.manage = function (a, b, c) {
            return (
              x[a] ||
                ((x[a] = { el: b, endpoints: [], connections: [] }),
                (x[a].info = ta({ elId: a, timestamp: E })),
                c ||
                  f.fire("manageElement", { id: a, info: x[a].info, el: b })),
              x[a]
            );
          }),
          ta = function (a) {
            ...
            return (
              ...
              !d && c && c === z[g]
                ...
                : (d || (!e && null == y[g])
                    ...
                    : ((y[g] = e || y[g]),
                      null == C[g] &&
                        ((b = x[g].el), null != b && (C[g] = f.getSize(b))),
                      (z[g] = c)),
                  y[g] &&
                    !y[g].right &&
                    ((y[g].right = y[g].left + C[g][0]),
                    (y[g].bottom = y[g].top + C[g][1]),
                    (y[g].width = C[g][0]),
                    (y[g].height = C[g][1]),
                    (y[g].centerx = y[g].left + y[g].width / 2),
                    (y[g].centery = y[g].top + y[g].height / 2)),
                  { o: y[g], s: C[g] })
            );
          };
        (this.updateOffset = ta),
          (this.init = function () {
            t ||
              (ra(),
          ...
          (this.makeAnchor = function () {
            ...
            if ("string" == typeof e)
              h = d(arguments[0], { elementId: g, jsPlumbInstance: f });
            else if (b.isArray(e))
              if (b.isArray(e[0]) || b.isString(e[0]))
                2 === e.length && b.isObject(e[1])
                  ? b.isString(e[0])
                    ? ((c = a.jsPlumb.extend(
                        { elementId: g, jsPlumbInstance: f },
                        e[1]
                      )),
                      (h = d(e[0], c)))
                    : ((c = a.jsPlumb.extend(
                        { elementId: g, jsPlumbInstance: f, anchors: e[0] },
                        e[1]
                      )),
                      (h = new a.jsPlumb.DynamicAnchor(c)))
                  : (h = new p.DynamicAnchor({
                      anchors: e,
                      selector: null,
                      elementId: g,
                      jsPlumbInstance: f,
            ...
            for (
              var j = g.maxConnections || -1,
                ...
                n = function (d) {
                  ...
                  g.createEndpoint &&
                    ((m.uniqueEndpoint = !0),
                    (m.endpoint = f.addEndpoint(c, m.def)),
                    m.endpoint.setDeleteOnEmpty(!1)),
                    (this.sourceEndpointDefinitions[e][h] = m),
                    (d.def = m);
                    ...
                    if (3 !== c.which && 2 !== c.button) {
                      ...
                      if (m.enabled) {
                        if (
                          ...
                          var n = b.isString(g.filter)
                            ? ua(c, d.el, g.filter, this, g.filterExclude)
                            : g.filter(c, d.el);
                          if (n === !1) return;
                        }
                        var o = this.select({ source: e }).length;
                        if (m.maxConnections >= 0 && o >= m.maxConnections)
                          return (
                            k && k({ element: d.el, maxConnections: j }, c), !1
                          );
                        var q = a.jsPlumb.getPositionOnElement(c, i, l),
                          r = {};
                        a.jsPlumb.extend(r, g),
                          (r.isTemporarySource = !0),
                          (r.anchor = [q[0], q[1], 0, 0]),
                          (r.dragOptions = p),
                          m.def.scope && (r.scope = m.def.scope),
                          (s = this.addEndpoint(e, r)),
                          (t = !0),
                          s.setDeleteOnEmpty(!0),
                          m.uniqueEndpoint &&
                            (m.endpoint
                              ? (s.finalEndpoint = m.endpoint)
                              : ((m.endpoint = s), s.setDeleteOnEmpty(!1)));
                        var u = function () {
                          f.off(s.canvas, "mouseup", u),
                            f.off(d.el, "mouseup", u),
        ...
        var ya = function (a, c, d, e, g) {
            ...
            if (((g = g || "default"), c.length && !b.isString(c))) {
              h = [];
              for (var l = 0, n = c.length; n > l; l++)
                (i = m(c[l])),
                  k[i.id] &&
                    k[i.id][g] &&
                    ((h[l] = k[i.id][g].enabled),
                    (j = e ? !h[l] : d),
                    (k[i.id][g].enabled = j),
        ...
        (this.clear = function () {
          ...
          (this.setId = function (a, c, d) {
            ...
            (c = "" + c),
              ...
              (v[c] = v[e] || []);
            for (var h = 0, i = v[c].length; i > h; h++)
          ...
          (this.getCachedData = X),
          (this.timestamp = c),
          (this.show = function (a, b) {
            return U(a, "block", b), f;
          }),
          (this.toggleVisible = W),
          (this.toggleDraggable = V),
  ...
  function () {
    var a = this,
              ...
              for (var c = 0; c < b.childNodes.length; c++)
                if (
                  ...
                  if (l && e[l] && e[l] > 0) {
                    ...
                    (d[i][l] = {
                      id: l,
                      offset: { left: m.left - h.left, top: m.top - h.top },
                    }),
                      (f[l] = i);
                  }
                  j(b.childNodes[c]);
      ...
      k = function (a, b, c) {
        (b = j(b)),
          "undefined" != typeof a.className.baseVal
      ...
      l = function (a) {
        return "undefined" == typeof a.className.baseVal
          ? a.className
          : a.className.baseVal;
      },
      m = function (a, c, d) {
    ...
    a.jsPlumb.extend(a.jsPlumbInstance.prototype, {
      ...
      getDragManager: function () {
        return (
          null == this.dragManager && (this.dragManager = new i(this)),
          this.dragManager
        );
      },
      ...
      hasClass: function (a, b) {
        return (
          ...
          a.classList ? a.classList.contains(b) : -1 !== l(a).indexOf(b)
        );
      },
      ...
      getStyle: function (a, b) {
        return "undefined" != typeof window.getComputedStyle
      ...
      getOffset: function (a, b, c) {
        ...
        for (
          var d = { left: a.offsetLeft, top: a.offsetTop },
            e =
  ...
  function () {
    ...
    var a = this,
      ...
      f = function (a, d) {
        ...
        if (c.isArray(d)) {
          var f = d[0],
            g = b.extend({ component: a, _jsPlumb: a._jsPlumb.instance }, d[1]);
  ...
  function () {
          ...
          drag: function () {
            ...
            if (b.element) {
              ...
              null != e && c.setPosition(b.element, e),
                ...
                a.paint({
                  anchorPoint: a.anchor.getCurrentLocation({ element: a }),
                });
            }
          },
          stopDrag: function () {
    ...
    (b.Endpoint = function (a) {
      ...
      this.bind("mouseover", function () {
        ...
        (a.connectionsDetachable === !1 || a.detachable === !1) &&
          ...
          var g,
            ...
            y = function (c) {
              ...
              this.addClass("endpointDrag"),
                ...
                i.updateOffset({ elId: this.elementId });
              ...
              if ((i.setConnectionBeingDragged(!1), m && null != m.endpoints)) {
                ...
                if (
                  ...
                  i.setDragScope(o[2], o[3]),
                    ...
                    m._forceReattach ||
                    m._forceDetach ||
                    !i.deleteConnection(m, { originalEvent: a })
                      ? (m.setHover(!1),
                        (m._forceDetach = null),
                        ...
                        i.repaint(o[1]))
                      : i.deleteObject({ endpoint: c });
                }
                this.deleteAfterDragStop
                  ? i.deleteObject({ endpoint: this })
                  : this._jsPlumb && this.paint({ recalc: !1 }),
              ...
              function () {
                ...
                if (null != d) {
                  ...
                  if (f) {
                    ...
                    this[(g ? "add" : "remove") + "Class"](
                      i.endpointDropAllowedClass
                    ),
                      this[(g ? "remove" : "add") + "Class"](
      ...
      c.extend(b.Endpoint, b.OverlayCapableJsPlumbUIComponent, {
        ...
        isFull: function () {
          return 0 === this._jsPlumb.maxConnections
            ? !0
            : !(
                this.isFloating() ||
  ...
  function () {
    ...
    (b.Connection = function (a) {
      ...
      if (!e.isSuspendDrawing()) {
        ...
        this.endpoints[0].paint({ anchorLoc: r, timestamp: q }),
      ...
      (this.getTypeDescriptor = function () {
        ...
        (this.isDetachable = function (a) {
          return null != a
            ? a.connectionsDetachable === !0
            : this._jsPlumb.detachable === !0;
        }),
        ...
        (this.isReattach = function () {
          return (
            this._jsPlumb.reattach === !0 ||
            this.endpoints[0].reattachConnections === !0 ||
            this.endpoints[1].reattachConnections === !0
          );
        }),
      ...
      c.extend(b.Connection, b.OverlayCapableJsPlumbUIComponent, {
        applyType: function (a, c, d) {
          ...
          var f = null;
          a.anchor
            ? ((f = this.getCachedTypeItem("anchors", d.anchor)),
              null == f &&
                ((f = [
            ...
            : a.anchors &&
              ((f = this.getCachedTypeItem("anchors", d.anchors)),
              null == f &&
                ((f = [
        ...
        prepareEndpoint: function (a, c, d, f, g, h, i, j) {
          ...
          if (f) (d.endpoints[g] = f), f.addConnection(d);
            ...
            null == m.fill &&
              null != h.paintStyle &&
              (m.fill = h.paintStyle.stroke),
              null == m.outlineStroke &&
                null != h.paintStyle &&
                (m.outlineStroke = h.paintStyle.outlineStroke),
              null == m.outlineWidth &&
                null != h.paintStyle &&
      ...
      var d = {},
        ...
        m = function (a) {
          return function (b, c) {
            var d = !0;
            return (
              (d = a ? b[0][0] < c[0][0] : b[0][0] > c[0][0]), d === !1 ? -1 : 1
            );
          };
        },
        n = function (a, b) {
      ...
      (this.updateOtherEndpoint = function (a, d, e, f) {
        ...
        (this.redraw = function (a, e, f, h, l, m) {
          if (!j.isSuspendDrawing()) {
            ...
            (f = f || j.timestamp()),
              (h = h || { left: 0, top: 0 }),
              e && (e = { left: e.left + h.left, top: e.top + h.top });
            for (
              ...
              if (A || B) {
                ...
                A &&
                  !i[y] &&
                  (i[y] = { top: [], right: [], bottom: [], left: [] }),
                  B &&
                    !i[z] &&
                    (i[z] = { top: [], right: [], bottom: [], left: [] }),
                  a !== z && j.updateOffset({ elId: z, timestamp: f }),
                  a !== y && j.updateOffset({ elId: y, timestamp: f });
            ...
            for (w = 0; w < r.length; w++) {
              ...
              r[w].paint({ timestamp: null, offset: H, dimensions: H.s });
            }
            for (w = 0; w < o.length; w++) {
              var I = o[w][1];
              if (I.anchor.constructor === c.DynamicAnchor) {
                I.paint({ elementWithPrecedence: a, timestamp: f }),
            ...
            var K = k[a];
            for (
              K && K.paint({ timestamp: f, recalc: !1, elId: a }), w = 0;
              w < p.length;
              w++
            )
              p[w].paint({
  ...
  function () {
    ...
    (b.Segments = {
      ...
      Straight: function (a) {
        ...
        (this.type = "Straight"),
          ...
          (this.pointAlongPathFrom = function (a, b, c) {
            var e = this.pointOnPath(a, c),
              f = 0 >= b ? { x: g, y: i } : { x: h, y: j };
            return (
              0 >= b && Math.abs(b) > 1 && (b *= -1), d.pointOnLine(e, f, b)
            );
          });
        ...
        (this.lineIntersection = function (a, b, c, f) {
          var k = Math.abs(d.gradient({ x: a, y: b }, { x: c, y: f })),
            l = Math.abs(e),
            m = l === 1 / 0 ? g : i - l * g,
            n = [],
            p = k === 1 / 0 ? a : b - k * a;
      ...
      Bezier: function (c) {
        ...
        (this.pointOnPath = function (b, c) {
          ...
          (this.findClosestPointOnPath = function (b, c) {
            var d = a.jsBezier.nearestPointOnCurve({ x: b, y: c }, this.curve);
            return {
              d: Math.sqrt(
    ...
    (b.Connectors.AbstractConnector = function (a) {
      ...
      (this.getPathData = function () {
        ...
        (this.findSegmentForPoint = function (a, b) {
          for (
            var c = { d: 1 / 0, s: null, x: null, y: null, l: null }, d = 0;
            d < f.length;
            d++
          ) {
      ...
      return (
        ...
        (this.gradientAtPoint = function (a, b) {
          var c = s(a, b);
          return (
            (c.segment && c.segment.gradientAtPoint(c.proportion, !1)) || 0
          );
        }),
        (this.pointAlongPathFrom = function (a, b, c) {
          var d = s(a, c);
    ...
    (g.prototype = {
      ...
      (b.Overlays.Diamond = function (a) {
        a = a || {};
        var c = a.length || 40,
          d = b.extend(a, { length: c / 2, foldback: 2 });
    ...
    c.extend(i, [b.jsPlumbUIComponent, g], {
      ...
      (b.Overlays.Label = function (a) {
        ...
        if (
          ...
          this.labelStyle.padding &&
            (d.style.padding = this.labelStyle.padding);
        }
      }),
      c.extend(b.Overlays.Label, b.Overlays.Custom, {
        ...
        getDimensions: function () {
          return (
            this.update(), i.prototype.getDimensions.apply(this, arguments)
          );
        },
        update: function () {
    ...
    var a = this,
      ...
      z = function (a) {
                  ...
                  a.each(function (a) {
                    a.setVisible(!1),
                      a.endpoints[d].element._jsPlumbGroup === b
                        ? (a.endpoints[d].setVisible(!1),
                          l.expandConnection(a, d, b))
                        : (a.endpoints[c].setVisible(!1),
                          l.collapseConnection(a, c, b));
                  });
                };
                b.collapsed &&
                  (i(a.select({ source: c }), 0),
                  i(a.select({ target: c }), 1));
                var j = a.getId(c);
        ...
        var n = (this.collapseConnection = function (b, c, d) {
          ...
          (i[k] && !i[k].shouldProxy() && i[k].collapsed) ||
            ((b.proxies = b.proxies || []),
            (e = b.proxies[c]
              ? b.proxies[c].ep
              : a.addEndpoint(f, {
            ...
            e.setDeleteOnEmpty(!0),
            (b.proxies[c] = { ep: e, originalEp: b.endpoints[c] }),
            0 === c
              ? a.anchorManager.sourceChanged(h, g, b, f)
              : (a.anchorManager.updateOtherEndpoint(
                  b.endpoints[0].elementId,
                  h,
                  g,
                  b
                ),
        ...
        var s = (this.expandConnection = function (b, c, d) {
          if (null != b.proxies && null != b.proxies[c]) {
            ...
            (b.endpoints[c] = b.proxies[c].originalEp),
              0 === c
                ? a.anchorManager.sourceChanged(e, g, b, f)
                : (a.anchorManager.updateOtherEndpoint(
                    b.endpoints[0].elementId,
                    e,
                    g,
        ...
        (a = this.getGroupManager().getGroup(a)),
          null != a &&
            this.getGroupManager()[
              a.collapsed ? "expandGroup" : "collapseGroup"
            ](a);
      }),
      ...
      f = function (a) {
        ...
        var c,
          ...
          r = function (a, b, c) {
            for (var f, h, i, j = null, k = 0; k < b.length - 1; k++) {
              if (
                ...
                var r =
                  ...
                  v = (u && r) || (!u && !r) ? f[0] : j[2],
                  w = (u && r) || (!u && !r) ? j[3] : f[1];
                g.addSegment(a, d, { x1: j[0], y1: j[1], x2: j[2], y2: j[3] }),
                  g.addSegment(a, e, {
                    r: o,
                    x1: j[2],
                    y1: j[3],
                ...
                var x =
                    j[2] === j[0] ? 0 : j[2] > j[0] ? c.lw / 2 : -(c.lw / 2),
            ...
            null != f &&
              g.addSegment(a, d, { x1: f[0], y1: f[1], x2: f[2], y2: f[3] });
          };
  ...
  function () {
    ...
    var a = this,
      ...
      w = function (a, b, c, d, e) {
        ...
        m = c.gradient.offset
          ? t(h, { id: f })
          : t(g, { id: f, gradientUnits: "userSpaceOnUse" });
        var n = t(i);
    ...
    var z = function (a) {
      ...
      (this.svg = t("svg", g)),
        a.useDivWrapper
          ? ((this.canvas = b.createElement("div", { position: "absolute" })),
            c.sizeElement(this.canvas, 0, 0, 1, 1),
            (this.canvas.className = f))
          : (s(this.svg, { class: f }), (this.canvas = this.svg)),
        ...
        (this.paint = function (b, d, f) {
          if (null != b) {
            ...
            null != f &&
              ...
              s(this.svg, { style: g, width: i[0] || 0, height: i[1] || 0 });
          }
        }),
        { renderer: e }
      );
      ...
      (this.path = null),
        (this.paint = function (a, b) {
          if (a.component.svg && b) {
            null == this.path &&
              ((this.path = t("path", { "pointer-events": "all" })),

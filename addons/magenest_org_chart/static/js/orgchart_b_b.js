var OrgChart = function (t, e) {
  ...
  if (
    ...
    for (var i in this.config)
      "object" != typeof e[i] || Array.isArray(e[i])
        ? void 0 !== e[i] && (this.config[i] = e[i])
        : (this.config[i] = OrgChart._mergeObject(this.config[i], e[i]));
  ...
  for (
    ...
    var n = a[o];
    this.config[n] &&
      this.on(n.replace("on", "").toLowerCase(), this.config[n]);
  }
  null != this.config.nodeMouseClickBehaviour &&
    (this.config.nodeMouseClick = this.config.nodeMouseClickBehaviour),
    null != this.config.mouseScroolBehaviour &&
    ...
    OrgChart._validateConfig(this.config) &&
      ...
      null === this.server && (this.server = new OrgChart.server(this.config)),
...
(OrgChart.prototype.load = function (t) {
  ...
  (OrgChart.prototype.get = function (t) {
    for (var e = 0; e < this.config.nodes.length; e++)
      if (this.config.nodes[e].id == t)
        return JSON.parse(JSON.stringify(this.config.nodes[e]));
    return null;
  }),
  (OrgChart.prototype.getByParentId = function (t) {
    for (var e = [], r = 0; r < this.config.nodes.length; r++)
      this.config.nodes[r].pid == t &&
        e.push(JSON.parse(JSON.stringify(this.config.nodes[r])));
    return e;
  }),
  (OrgChart.prototype._draw = function (t, O, v, y) {
    var x = this;
    this._hideBeforeAnimationCompleted = !1;
    var e = O == OrgChart.action.init ? null : this.getViewBox();
    this.server.read(
      t,
      this.width(),
      this.height(),
      ...
      v,
      function (t) {
        O != OrgChart.action.exporting && (x.nodes = t.nodes),
          (x.editUI.fields = t.allFields);
        var e = { defs: "" };
        OrgChart.events.publish("renderdefs", [x, e]);
        var r = x.ui.defs(e.defs),
          i = x.getScale(t.viewBox);
        r += x.ui.pointer(x.config, O, i);
        var a = x.getViewBox(),
          o = t.viewBox;
        e = { content: r, res: t };
        for (var n in (OrgChart.events.publish("prerender", [x, e]),
        (r = e.content),
        t.visibleNodes)) {
          var l = t.visibleNodes[n],
            s = x._get(n);
          (r += x.ui.node(
            l,
            s,
            ...
            (r += x.ui.link(l, x, x.config, i)),
            (r += x.ui.expandCollapse(l, x.config, O, i));
        }
        e = { content: r, res: t };
        if (
          (OrgChart.events.publish("render", [x, e]),
          (r = e.content),
          (r += x.ui.lonely(x.config)),
          O !== OrgChart.action.exporting)
        ) {
          (O !== OrgChart.action.centerNode &&
            O !== OrgChart.action.insert &&
            O !== OrgChart.action.expandCollapse &&
            O !== OrgChart.action.update) ||
            (o = a),
            O === OrgChart.action.init && null != a && (o = a),
            (x.response = t);
          m = x.ui.svg(x.width(), x.height(), o, x.config, r);
          if (x._initialized) {
            var h = x.getSvg(),
              d = h.parentNode;
            d.removeChild(h),
              d.insertAdjacentHTML("afterbegin", m),
            ...
            (x.element.innerHTML =
              x.ui.css() + x.ui.exportMenuButton(x.config) + m),
          ...
          if (0 < g[0].length) {
            ...
            for (var p = 0; p < g[0].length; p++)
              g[0][p] = x.getNodeElement(g[0][p]);
            OrgChart.anim(
              g[0],
              g[1],
              g[2],
              ...
              function () {
                c ||
                  (y && y(),
                  OrgChart.events.publish("redraw", [x]),
                  x._showAfterAnimation(),
                  (c = !0));
              }
            );
          }
          O === OrgChart.action.centerNode
            ...
            : !a ||
              !x.response ||
              (a[0] == x.response.viewBox[0] &&
                a[1] == x.response.viewBox[1] &&
                a[2] == x.response.viewBox[2] &&
                a[3] == x.response.viewBox[3]) ||
              (O !== OrgChart.action.insert &&
                O !== OrgChart.action.expandCollapse &&
                O !== OrgChart.action.update &&
                O !== OrgChart.action.init)
            ? 0 == g[0].length &&
              (c ||
                (y && y(), OrgChart.events.publish("redraw", [x]), (c = !0)))
            : OrgChart.anim(
                x.getSvg(),
                { viewbox: a },
                { viewbox: x.response.viewBox },
            ...
            x._initialized ||
              ((x._initialized = !0), OrgChart.events.publish("init", [x]));
        } else {
          var f = t.boundary,
            u = f.maxX - f.minX,
            C = f.maxY - f.minY,
            m = x.ui.svg(u, C, [f.minX, f.minY, u, C], x.config, r, i);
          y(m);
        }
      },
      function (t) {
    ...
    if (null != i) {
      ...
      if (null != a) {
        ...
        var h = i.w,
          ...
          O = OrgChart._randomId();
        u.setAttribute("id", O);
        var v = OrgChart.t(i.templateName, this.getScale());
        C.setAttribute("x", v.ripple.rect ? v.ripple.rect.x : 0),
          C.setAttribute("y", v.ripple.rect ? v.ripple.rect.y : 0),
          C.setAttribute("width", v.ripple.rect ? v.ripple.rect.width : i.w),
          C.setAttribute("height", v.ripple.rect ? v.ripple.rect.height : i.h),
          C.setAttribute("rx", v.ripple.radius),
          C.setAttribute("ry", v.ripple.radius),
          m.setAttribute("clip-path", "url(#" + O + ")"),
          m.setAttribute("cx", n),
          m.setAttribute("cy", l),
          m.setAttribute("r", 0),
          m.setAttribute("fill", v.ripple.color),
          u.appendChild(C),
          f.appendChild(u),
          f.appendChild(m),
          a.appendChild(f),
  ...
  (OrgChart.prototype.center = function (t, e, r) {
    ...
    e && null != e.parentState && (i = e.parentState),
      ...
      e && null != e.rippleId && (o = e.rippleId),
      e && null != e.vertical && (n = e.vertical),
  ...
  (OrgChart.prototype.fit = function (t) {
    (this.config.scaleInitial = OrgChart.match.boundary),
      this._draw(!0, OrgChart.action.init, void 0, t);
  }),
  (OrgChart.prototype.getBGNode = function (t) {
    var e = this.nodes[t];
    if (null == e)
      for (var r in this.nodes)
        for (var i = this.nodes[r].bgnodes, a = 0; a < i.length; a++)
          if (i[a].id == t) return i[a];
    return e;
  }),
  (OrgChart.prototype.setLayout = function (t) {
    (this.config.layout = t), this._draw(!1, OrgChart.action.update);
  }),
  ...
  (OrgChart.prototype._hideBeforeAnimation = function (t) {
    if (
      ...
      var o = this.element.querySelectorAll("[control-expcoll-id]");
      if (o.length > OrgChart.EXPCOLL_THRESHOLD)
  ...
  (OrgChart.prototype.isChild = function (t, e) {
    var r = this.getBGNode(t).childrenIds;
    if (-1 != r.indexOf(e)) return !0;
    for (var i = 0; i < r.length; i++) this.isChild(r[i], e);
    return !1;
  }),
  ...
  (OrgChart.prototype.link = function (t, e) {
    if (this._canUpdateLink(t, e)) {
      var r = this.get(t);
      (r.pid = e), this.update(r, !0);
    }
  }),
  (OrgChart.prototype.linkNode = function (t, e) {
    if (this._canUpdateLink(t, e)) {
      var r = this.getBGNode(t),
        i = this.getBGNode(e);
      if (r.isGroup && i.isGroup)
        for (var a = i.bgnodes[0].id, o = 0; o < r.bgnodes.length; o++) {
          ((n = this.get(r.bgnodes[o].id)).pid = a), this.update(n, !0);
        }
      else if (!r.isGroup && i.isGroup) {
        a = i.bgnodes[0].id;
        ((n = this.get(t)).pid = a), this.update(n, !0);
      } else if (r.isGroup && !i.isGroup)
        for (o = 0; o < r.bgnodes.length; o++) {
          ((n = this.get(r.bgnodes[o].id)).pid = e), this.update(n, !0);
        }
      else if (!r.isGroup && !i.isGroup) {
        var n;
        ((n = this.get(t)).pid = e), this.update(n, !0);
      }
      r.isChildOfGroup &&
        (this.removeNodeTag(r.id, r._groupParentNodeId),
        this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id));
      var l = this;
      this._draw(!1, OrgChart.action.update, { visId: t }, function () {
        l.ripple(r.id);
      });
    }
  }),
  (OrgChart.prototype.updateNode = function (t, e) {
    var r = this;
    if (!1 === this.update(t, e)) return !1;
    var i = t.pid;
    return (
      (null != i && null != i && "" != i) || (i = t.id),
      this._draw(!1, OrgChart.action.update, { id: i }, function () {
        r.ripple(t.id);
      }),
      !0
    );
  }),
  (OrgChart.prototype.update = function (t, e) {
    var r = this.get(t.id);
    if (!0 === e && !1 === OrgChart.events.publish("update", [this, r, t]))
      return !1;
    for (var i = 0; i < this.config.nodes.length; i++)
      this.config.nodes[i].id == t.id && (this.config.nodes[i] = t);
    return !0;
  }),
  (OrgChart.prototype.removeNode = function (t, e) {
    var r = this;
    return (
      !1 !== this.remove(t, e) &&
  ...
  (OrgChart.prototype.remove = function (t, e) {
    ...
    if (
      (r.isChildOfGroup &&
        this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id),
      !0 === e) &&
      !1 === OrgChart.events.publish("remove", [this, t])
    )
      return !1;
    for (var i = null, a = this.config.nodes.length - 1; 0 <= a; a--)
      if (this.config.nodes[a].id == t) {
        (i = this.config.nodes[a].pid), this.config.nodes.splice(a, 1);
        break;
      }
    var o = this.getByParentId(t);
    for (a = o.length - 1; 0 <= a; a--) (o[a].pid = i), this.update(o[a], e);
    return !0;
  }),
  (OrgChart.prototype.addNode = function (t, e) {
    if (!1 === this.add(t, e)) return !1;
    var r = OrgChart.action.insert;
    (null != t.pid && null != t.pid) || (r = OrgChart.action.update);
    var i = this.getBGNode(t.pid),
      a = t.pid;
    return (
      i && i.isChildOfGroup && (a = i._groupParentNodeId),
      this._draw(!1, r, { id: a, insertedNodeId: t.id }),
      !0
    );
  }),
  (OrgChart.prototype.add = function (t, e) {
    if (
      (null == t.id && console.error("Call addNode without id"), !0 === e) &&
      !1 === OrgChart.events.publish("add", [this, t])
    )
      return !1;
    return this.config.nodes.push(t), !0;
  }),
  (OrgChart.prototype.addTag = function (t, e, r) {
    var i = OrgChart.copy(this.config.tags);
    if (
      ((i[t] = e), !0 === r) &&
      !1 === OrgChart.events.publish("updatetags", [this, i])
    )
      return !1;
    return (this.config.tags = i), !0;
  }),
  (OrgChart.prototype.hasTag = function (t) {
    return null != this.config.tags[t];
  }),
  (OrgChart.prototype.removeTag = function (t, e) {
    var r = JSON.parse(JSON.stringify(this.config.tags));
    if (
      (delete r[t], !0 === e) &&
      !1 === OrgChart.events.publish("updatetags", [this, r])
    )
      return !1;
    return (this.config.tags = r), !0;
  }),
  (OrgChart.prototype._updateTag = function (t, e, r) {
    var i = JSON.parse(JSON.stringify(this.config.tags));
    if (
      ((i[t][e] = r), !1 === OrgChart.events.publish("updatetags", [this, i]))
    )
      return !1;
    this.config.tags = i;
    var a = this;
    this._draw(!1, OrgChart.action.update, { id: t }, function () {
      a.ripple(t);
    });
  }),
  (OrgChart.prototype.addNodeTag = function (t, e, r) {
    var i = this.get(t);
    Array.isArray(i.tags) || (i.tags = []),
      -1 == i.tags.indexOf(e) && (i.tags.push(e), this.update(i, r));
  }),
  (OrgChart.prototype.removeNodeTag = function (t, e, r) {
    var i = this.get(t);
    if (Array.isArray(i.tags)) {
      var a = i.tags.indexOf(e);
      -1 != a && (i.tags.splice(a, 1), this.update(i, r));
    }
  }),
  (OrgChart.prototype._removeGroupIfHasOneNode = function (t, e) {
    if (OrgChart.REMOVE_GROUP_IF_HAS_ONE_NODE) {
      var r = this.getBGNode(t);
      if (2 == r.bgnodes.length) {
        this.removeTag(r.id, !0);
        for (var i = 0; i < r.bgnodes.length; i++) {
          var a = r.bgnodes[i];
          a.id != e && this.removeNodeTag(a.id, t);
        }
      }
    }
  }),
  (OrgChart.prototype.groupNode = function (t, e, r, i) {
    var a = this,
      o = this.group(t, e, r, i);
    this._draw(!1, OrgChart.action.update, { id: o.id }, function () {
      a.ripple(o.rippleId);
    });
  }),
  (OrgChart.prototype.group = function (t, e, r, i) {
    if (!0 === i && !1 === OrgChart.events.publish("group", [this, t, e]))
      return !1;
    var a = this.getBGNode(t),
      o = this.getBGNode(e),
      n = o.id;
    if (a.isGroup || o.isGroup || a.isChildOfGroup || o.isChildOfGroup)
      if (a.isGroup || o.isGroup || !a.isChildOfGroup || o.isChildOfGroup)
        if (a.isGroup || o.isGroup || a.isChildOfGroup || !o.isChildOfGroup)
          if (!a.isGroup && !o.isGroup && a.isChildOfGroup && o.isChildOfGroup)
            a._groupParentNodeId != o._groupParentNodeId &&
              (this._removeGroupIfHasOneNode(a._groupParentNodeId, a.id),
              this.removeNodeTag(a.id, a._groupParentNodeId, !0),
              this.addNodeTag(a.id, o._groupParentNodeId, !0),
              this.link(a.id, o.pid));
          else if (
            !a.isGroup &&
            o.isGroup &&
            a.isChildOfGroup &&
            ...
            if (
              ...
              for (var l = 0; l < a.bgnodes.length; l++)
                this.removeNodeTag(a.bgnodes[l].id, a.id, !0),
                  this.addNodeTag(a.bgnodes[l].id, o.id, !0);
          } else this.addNodeTag(a.id, o.id, !0);
        else
          this.addNodeTag(a.id, o._groupParentNodeId, !0),
            this.link(a.id, o.pid);
      else {
        s = null != r ? r : OrgChart._randomId();
        this.addTag(
          s,
          {
            group: !0,
          ...
          this._removeGroupIfHasOneNode(a._groupParentNodeId, a.id),
          this.removeNodeTag(a.id, a._groupParentNodeId, !0),
          this.addNodeTag(a.id, s, !0),
          this.addNodeTag(o.id, s, !0);
      }
    else {
      var s = null != r ? r : OrgChart._randomId();
      this.addTag(
        s,
        {
          group: !0,
        ...
        this.addNodeTag(a.id, s, !0),
        this.addNodeTag(o.id, s, !0);
      var h = this._get(o.id).pid;
      this.link(a.id, h);
    }
    return { rippleId: a.id, id: n };
  }),
  ...
  (OrgChart._ajax = function (t, e, r, i, a) {
    ...
    (o.onload = function (t) {
      ...
      null == r ? o.send() : o.send(r);
  }),
  void 0 === OrgChart && (OrgChart = {}),
  (OrgChart.anim = function (c, g, p, f, u, C, m) {
    var O,
      v = 1,
      y = f / 10 + 1;
        ...
        for (var t = 0; t < c.length; t++)
          for (var e in p[t]) {
            ...
            switch (e.toLowerCase()) {
              case "d":
                var a =
                    u((10 * v - 10) / f) * (p[t][e][0] - g[t][e][0]) +
                    g[t][e][0],
                  o =
                    u((10 * v - 10) / f) * (p[t][e][1] - g[t][e][1]) +
                    g[t][e][1];
                c[t].setAttribute(
                  "d",
                  c[t].getAttribute("d") + " L" + a + " " + o
                );
                break;
              case "r":
                var n = u((10 * v - 10) / f) * (p[t][e] - g[t][e]) + g[t][e];
              ...
              case "transform":
                if (p[t][e]) {
                  var l = g[t][e],
                    ...
                    h = [0, 0, 0, 0, 0, 0];
                  for (i in l)
                    h[i] = u((10 * v - 10) / f) * (s[i] - l[i]) + l[i];
                  c[t].hasAttribute("transform")
                    ? c[t].setAttribute(
                        "transform",
                        "matrix(" + h.toString() + ")"
                      )
                    : (c[t].style.transform = "matrix(" + h.toString() + ")");
                }
                break;
              case "viewbox":
                if (p[t][e]) {
                  ...
                  l))
                    h[i] = u((10 * v - 10) / f) * (s[i] - l[i]) + l[i];
                  c[t].setAttribute("viewBox", h.toString());
                }
                break;
              case "margin":
                if (p[t][e]) {
                  ...
                  l))
                    h[i] = u((10 * v - 10) / f) * (s[i] - l[i]) + l[i];
                  var d = "";
                  for (i = 0; i < h.length; i++) d += parseInt(h[i]) + "px ";
                  c[t] && c[t].style && (c[t].style[e] = d);
                }
                break;
              default:
                (n = u((10 * v - 10) / f) * (p[t][e] - g[t][e]) + g[t][e]),
                  c[t] && c[t].style && (c[t].style[e] = n + r);
            }
          }
        m && m(), 1 + y < (v += 1) && (clearInterval(O), C && C(c));
      }, 10));
  }),
  ...
  (OrgChart.prototype._attachEventHandlers = function (t) {
    ...
    /Android/i.test(navigator.userAgent)
      ...
      : (this._addEvent(t, "mousedown", this._globalMouseDownHandler),
        ...
        this.config.mouseScrool == OrgChart.action.zoom &&
          (this._addEvent(t, "DOMMouseScroll", this._mouseScrollHandler),
          this._addEvent(t, "mousewheel", this._mouseScrollHandler)));
  ...
  (OrgChart.prototype._addEvent = function (e, t, r, i) {
    ...
    e.getListenerList[t + i]) ||
      ((a = this),
      (o = r),
      (r = function () {
        if (o) return o.apply(a, [this, arguments[0]]);
      }),
      e.addEventListener
  ...
  (OrgChart.nodeOpenTag =
    '<g node-id="{id}" style="opacity: {opacity}" transform="matrix(1,0,0,1,{x},{y})" class="{class}" level="{level}">'),
  (OrgChart.linkOpenTag =
    '<g link-id="[{id}][{child-id}]" class="{class}" level="{level}">'),
  (OrgChart.expcollOpenTag =
    '<g control-expcoll-id="{id}" transform="matrix(1,0,0,1,{x},{y})"  style="cursor:pointer;">'),
  ...
  (OrgChart.IT_IS_LONELY_HERE =
    '<g transform="translate(-100, 0)" style="cursor:pointer;"  control-add="control-add"><text fill="#039be5">{link}</text></g>'),
  (OrgChart.RES = {}),
  (OrgChart.RES.IT_IS_LONELY_HERE_LINK =
    "It's lonely here, add your first node"),
  (OrgChart.MAXIMIZE =
    '<g style="cursor:pointer;" transform="matrix(1,0,0,1,{x},20)" control-maxmin-id="{id}"><rect x="0" y="0" width="26" height="26" fill="#EEEEEE" stroke="#aeaeae" stroke-width="1" rx="2"></rect><polyline  stroke="#aeaeae" stroke-width="2" points="9,6 17,13 9,20" fill="none"></polyline></g>'),
  (OrgChart.MINIMIZE =
    '<g style="cursor:pointer;" transform="matrix(1,0,0,1,{x},20)" control-maxmin-id="{id}"><rect x="0" y="0" width="26" height="26" fill="#EEEEEE" stroke="#aeaeae" stroke-width="1" rx="2"></rect><polyline stroke="#aeaeae" stroke-width="2" points="17,6 9,13 17,20" fill="none"></polyline></g>'),
  (OrgChart.MAX_NODES_MESS =
    "The trial has expired or 200 nodes limit was reached! <br /><a style='color: #039BE5;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>"),
  (OrgChart.OFFLINE_MESS =
    "The evaluation version requires intermet connection! <br /><a style='color: #039BE5;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>"),
  ...
  (OrgChart.REMOVE_GROUP_IF_HAS_ONE_NODE = !0),
  "undefined" != typeof module && (module.exports = OrgChart),
  (OrgChart.input = function (t, e, r, i, a, o) {
    null == i && (i = !1);
    ...
    if (
      ...
      (d.style.right = 0),
      (n.style.margin = "14px 14px 7px 14px"),
      (n.style.textAlign = "left"),
      (n.style.position = "relative"),
      n.setAttribute("data-field-name", t),
      ...
      i ||
        s.addEventListener("focus", function () {
          ...
          (t.style.border = "1px solid #039BE5"),
            OrgChart.anim(
              t,
              { width: 10 },
              { width: n.clientWidth },
      ...
      d.addEventListener("click", function () {
        ...
        t.setAttribute("type", "file"),
          ...
          (t.onchange = function () {
            var t = this.files[0];
            OrgChart.events.publish("imageuploaded", [
              o,
              t,
              e.parentNode.querySelector("input"),
            ]);
          }),
      ...
      s.addEventListener("blur", function () {
        this.parentNode.getElementsByTagName("hr")[0].style.border =
          "1px solid #d7d7d7";
      }),
      n.appendChild(l),
      n.appendChild(s),
      ...
      var c = { wrapper: n, label: l, input: s, hr: h };
  ...
  (OrgChart._intersects = function (t, e, r) {
    var i = t.x - r.siblingSeparation / 4,
      a = t.y,
      o = t.x + t.w + r.siblingSeparation / 4,
      n = t.y;
    switch (r.orientation) {
      ...
      case OrgChart.orientation.left_top:
        (i = t.x),
          ...
          (o = t.x),
          (n = t.y + t.h + r.siblingSeparation / 4);
    }
    var l,
      s,
      h,
  ...
  (OrgChart._addPointTop = function (t, e, r, i, a) {
    ...
    return (
      ...
      e.push([o, e[e.length - 1][1]]),
      e.push([o, t.y - r.levelSeparation / 3]),
      (n = e[e.length - 1][1]),
      (l = o),
      (i.p = o),
      (i.q = n),
      ...
      "left" == a
        ...
        : "right" == a &&
          (o = t.rightNeighbor
            ...
            : t.x + t.w + r.siblingSeparation / 2),
      e.push([o, e[e.length - 1][1]]),
      e.push([o, t.y + t.h + r.levelSeparation / 3]),
      (n = e[e.length - 1][1]),
      (l = o),
      (i.p = o),
      (i.q = n),
  ...
  (OrgChart._addPointLeft = function (t, e, r, i, a) {
    ...
    return (
      ...
      e.push([t.x - r.levelSeparation / 3, o]),
      (n = e[e.length - 1][0]),
      (s = o),
      (i.p = n),
      (i.q = o),
      ...
      "bottom" == a
        ...
        : "top" == a &&
          (o = t.leftNeighbor
            ...
            : t.y - r.siblingSeparation / 2),
      e.push([e[e.length - 1][0], o]),
      e.push([t.x + t.w + r.levelSeparation / 3, o]),
      (n = e[e.length - 1][0]),
      (s = o),
      (i.p = n),
      (i.q = o),
  ...
  (OrgChart.editUI.prototype.show = function (t, e) {
    if ((this.hide(), !1 === OrgChart.events.publish("show", [this, t])))
      return !1;
    (this.node = this.obj.getBGNode(t)),
    ...
    window.matchMedia("(max-width: 1150px)").matches && (a = "100%"),
      ...
      e
        ? this._createDetailsView(this.node, i)
        : this._createEditView(this.node, r);
  }),
  (OrgChart.editUI.prototype._createDetailsView = function (t, e) {
    ...
    (n.className = "edit-tags"),
      ...
      Object.assign(n.style, { margin: "12px" }),
    ...
    var l = this.fields,
      s = this.obj._get(t.id);
    t.isGroup &&
      ((l = ["Name"]), (s = { Name: this.obj.config.tags[t.id].groupName }));
    for (var h = 0; h < l.length; h++) {
      var d = s[l[h]];
      if (
        (t.isGroup && (d = this.obj.config.tags[t.id]["group" + l[h]]),
        OrgChart._fieldIsImg(this.obj.config, l[h]))
      ) {
        ...
        (c.src = d),
          ...
          this._addField(i, c, l[h], "details");
      } else if ("tags" == l[h]) {
        if (d)
          for (var g = 0; g < d.length; g++) {
            ...
            Object.assign(p.style, {
              ...
              (p.innerHTML = d[g]),
              this._addField(n, p, d[g], "details-tag");
          }
      } else
        this._addField(
          o,
          OrgChart.input(l[h], d, null, !0, void 0, r),
          l[h],
          "details"
        );
    }
    this.obj.element.appendChild(this.wrapperElement),
      ...
      OrgChart.anim(
        ...
        OrgChart.anim.inOutSin,
        function () {
          r.obj._showAfterAnimation(),
            (o.style.height =
              r.obj.element.offsetHeight - i.offsetHeight + "px");
        }
      );
  }),
  (OrgChart.editUI.prototype._addField = function (t, e, r, i) {
    var a = { name: r, field: e, type: i };
    !1 !== OrgChart.events.publish("field", [this, a]) &&
      t.appendChild(a.field);
  }),
  (OrgChart.editUI.prototype._createEditView = function (t, e) {
    ...
    (l.className = "edit-assistant-button-content"),
      ...
      (o.innerHTML = "Add new field");
    var s = OrgChart._arrayContains(this.node.tags, "assistant")
      ? "checked"
      : "";
    l.setAttribute("data-field-name", "isAssistant"),
      (l.innerHTML =
        '<div style="margin-top: 10px;display:inline-block;">Assistant</div><label class="bg-switch"><input val type="checkbox" ' +
        s +
        '><span class="bg-slider round"></span></label>'),
      this.wrapperElement.appendChild(e),
      e.appendChild(r),
      e.appendChild(n),
      r.appendChild(a),
    ...
    var h = this.fields,
      d = this.obj._get(t.id);
    t.isGroup &&
      ((h = ["Name"]), (d = { Name: this.obj.config.tags[t.id].groupName }));
    for (var c = 0; c < h.length; c++) {
      var g = d[h[c]];
      if (
        (t.isGroup && (g = this.obj.config.tags[t.id]["group" + h[c]]),
        "tags" != h[c])
      )
        if (OrgChart._fieldIsImg(this.obj.config, h[c])) {
          if (g) {
          ...
          this._addField(
            n,
            OrgChart.input(h[c], g, null, !1, !0, i),
            h[c],
            "edit"
          );
        } else
          this._addField(
            n,
            OrgChart.input(h[c], g, null, !1, void 0, i),
            h[c],
            "edit"
          );
    }
    t.isGroup ||
      ...
      this._addField(n, l, "isAssistant", "edit"),
      t.isGroup || this._addField(n, o, "Add new field", "edit"),
      this.obj.element.appendChild(this.wrapperElement),
      ...
      o.addEventListener("click", function () {
        if ("Save" == o.innerHTML)
          OrgChart.anim(
            ...
            OrgChart.anim.inSin,
            function () {
              (o.innerHTML = "Add new field"), (o.style.textAlign = "left");
              var t = document.getElementById("bgNewField"),
                e = t.getElementsByTagName("input")[0].value;
              if (
                (n.removeChild(t), e && !OrgChart._arrayContains(i.fields, e))
              ) {
      ...
      OrgChart.anim(
        ...
        OrgChart.anim.inOutSin,
        function () {
          i.obj._showAfterAnimation(),
            (n.style.height =
              i.obj.element.offsetHeight - r.offsetHeight + "px"),
            1 < i.wrapperElement.getElementsByTagName("input").length &&
              i.wrapperElement.getElementsByTagName("input")[0].focus();
        }
      );
  }),
  (OrgChart.editUI.prototype.hide = function (t) {
    if (this.wrapperElement) {
      ...
      if (
        (this.node.isGroup &&
          (e = { Name: this.obj.config.tags[this.node.id].groupName }),
        t)
      ) {
        for (
          var r = this.wrapperElement.querySelectorAll("[data-field-name]"),
            i = 0;
          i < r.length;
          i++
        ) {
          ...
          if (a) {
            var o = r[i].querySelector("[val]").value;
            if (a === OrgChart.TAGS) e.tags = o.split(",");
            else if ("isAssistant" === a) {
              var n = r[i].querySelector("[val]").checked;
              n && e.tags
                ? OrgChart._arrayContains(this.node.tags, "assistant") ||
                  e.tags.push("assistant")
                : n && !e.tags
                ? (e.tags = ["assistant"])
                : !n &&
                  e.tags &&
                  -1 != this.node.tags.indexOf("assistant") &&
                  e.tags.splice(e.tags.indexOf("assistant"), 1);
            } else null != e[a] ? (e[a] = o) : "" != o && (e[a] = o);
          }
        }
        var l = this;
        this.obj._hideBeforeAnimation(),
          OrgChart.anim(
            ...
            OrgChart.anim.inOutSin,
            function () {
              l.obj._showAfterAnimation(),
                l.node.isGroup
                  ? l.obj._updateTag(l.node.id, "groupName", e.Name)
                  : l.obj.updateNode(e, !0),
                l.obj.element.removeChild(l.wrapperElement),
  ...
  (OrgChart.menuUI.prototype._show = function (t, e, o, n, l) {
    var s = this;
    this.hide();
    var r = "";
    l || (l = this.menu);
    var i = { firstNodeId: o, secondNodeId: n, menu: l };
        ...
        (a = f[u]).addEventListener("mouseover", function () {
          ...
          a.addEventListener("click", function (t) {
            ...
            if (void 0 === l[r].onClick)
              if ("add" === r) {
                var i = { id: OrgChart._randomId(), pid: o };
                s.obj.addNode(i, !0);
              } else if ("edit" === r) {
                var a = s.obj.getBGNode(o);
                ...
                "remove" === r
                  ...
                  ? s.obj.exportXML()
                  : "addInGroup" === r
                  ? s.obj.groupNode(o, n, void 0, !0)
                  : "addAsChild" === r && s.obj.linkNode(o, n);
            else e = l[r].onClick.call(s.obj, o, n);
            0 != e && s.hide();
          });
      }
    }
  ...
  (OrgChart.toolbarUI.prototype.init = function (t, e) {
    if (e) {
      (this.obj = t),
        ...
        e.fit &&
          (this.div.innerHTML +=
            '<div data-tlbr="fit">' + OrgChart.toolbarUI.fitIcon + "</div>"),
        e.zoom &&
          ((this.div.innerHTML +=
            '<div data-tlbr="plus">' +
            OrgChart.toolbarUI.zoomInIcon +
  ...
  (OrgChart.icon.addInGroup = function (t, e, r) {
    return (
      '<svg width="' +
      t +
      '" height="' +
  ...
  (OrgChart.icon.addAsChild = function (t, e, r) {
    return (
      '<svg width="' +
      t +
      '" height="' +
  ...
  (OrgChart.prototype._defaultExportOptions = function (t, e) {
    if (
      ...
      var r = this.getBGNode(t.nodeId);
      r.isChildOfGroup && (t.nodeId = r._groupParentNodeId);
    }
    return t;
  }),
  (OrgChart.prototype._export = function (a, o) {
    var n = this,
    ...
    this._draw(!1, OrgChart.action.exporting, t, function (t) {
      ...
      if (((r.innerHTML = t), "svg" == a.ext))
        if (o) o(a, r.innerHTML);
        else {
          var e = { content: r.innerHTML, options: a },
            i = OrgChart.events.publish("exportstart", [n, e]);
          if (!1 === i) return !1;
          if (
            (OrgChart._downloadFile(
              ...
              e.content,
              e.options.filename,
              e.options.openInNewTab
            ),
            !1 === (i = OrgChart.events.publish("exportend", [n, e])))
          )
            return !1;
        }
      else
        n._pages(a, r.querySelector("svg"), function (t) {
          var e = { content: r.innerHTML, options: a, pages: t };
          if (!1 === OrgChart.events.publish("exportstart", [n, e])) return !1;
          o || OrgChart.loading.show(n),
            o
              ? o(n, e, r.querySelector("svg"))
              : ((e = JSON.stringify(e)),
                OrgChart._ajax(
                  n.config.exportUrl + "/v3",
                  "POST",
                  e,
                  "arraybuffer",
                  function (t) {
                    if (!1 === OrgChart.events.publish("exportend", [n, t]))
                      return !1;
                    OrgChart.loading.hide(n),
                      OrgChart._downloadFile(
                        a.mime,
                        t,
                        a.filename,
  ...
  (OrgChart.prototype._pages = function (t, e, r) {
    "fit2Levels" == t.format
      ? this._pagesFit2Levels(t, r)
      : "A42Levels" == t.format ||
        "A32Levels" == t.format ||
        "A22Levels" == t.format ||
        "A12Levels" == t.format
      ? this._pagesA2Levels(t, r)
  ...
  (OrgChart.prototype._pagesA2Levels = function (n, l) {
    var s = this,
      h = this.config.collapse,
      d = this.config.roots;
    this.config.collapse = { level: 2 };
    var t = { id: n.nodeId, expandChildren: n.expandChildren },
      c = [],
      g = [];
    for (var e in this.nodes) {
      this.destroy,
        (0 != (i = this.nodes[e]).childrenIds.length ||
          (0 == i.childrenIds.length && null == i.pid)) &&
          (i.isAssistant || "split" == i.templateName || g.push(i.id));
    }
    for (var r = 0; r < g.length; r++) {
      e = g[r];
      var i = this.nodes[e];
      (this.config.roots = [i.id]),
        (function (r) {
          s._draw(!1, OrgChart.action.exporting, t, function (t) {
            var e = document.createElement("div");
            (e.innerHTML = t),
              (function (t, e) {
                for (
                  var r = t.querySelector("svg"), i = s._pagesAfit(n, r), a = 0;
                  a < i.length;
                  a++
                ) {
                  var o = i[a];
                  (o.html = t.innerHTML), c.push(o);
                }
                g.length - 1 == e &&
                  ((s.config.collapse = h), (s.config.roots = d), l(c));
              })(e, r);
          });
        })(r);
    }
  }),
  (OrgChart.prototype._pagesFit2Levels = function (n, l) {
    var s = this,
      h = this.config.collapse,
      d = this.config.roots;
    this.config.collapse = { level: 2 };
    ...
    for (var e in this.nodes) {
      var r = this.nodes[e];
      (0 != r.childrenIds.length ||
        (0 == r.childrenIds.length && null == r.pid)) &&
        (r.isAssistant || "split" == r.templateName || g.push(r.id));
    }
        ...
        (function (r) {
          s._draw(!1, OrgChart.action.exporting, t, function (t) {
            ...
            (e.innerHTML = t),
              (function (t, e) {
                for (
                  var r = t.querySelector("svg"), i = s._pagesFit(n, r), a = 0;
                  a < i.length;
                  a++
                ) {
                  var o = i[a];
  ...
  (OrgChart.prototype._pagesFit = function (t, e) {
    var r = e.getAttribute("width"),
      ...
      o = { w: parseFloat(r), h: parseFloat(i) };
    return [
      {
        vb: a,
        size: {
          w: o.w + (t.margin[1] + t.margin[3]),
          h: o.h + (t.margin[0] + t.margin[2]),
        },
        innerSize: o,
      },
    ];
  ...
  (OrgChart.prototype._pagesAfit = function (t, e) {
    ...
    switch (t.format) {
      case "A4":
      case "A42Levels":
        (a = OrgChart.A4w), (o = OrgChart.A4h);
        break;
      case "A3":
      case "A32Levels":
        (a = OrgChart.A3w), (o = OrgChart.A3h);
      case "A2":
      case "A22Levels":
        (a = OrgChart.A2w), (o = OrgChart.A2h);
      case "A1":
      case "A12Levels":
        (a = OrgChart.A1w), (o = OrgChart.A1h);
    }
    var n = OrgChart.pdfPrevUI._getViewBox(e),
      l = {
        w: t.landscape
      ...
      s = { w: t.landscape ? o : a, h: t.landscape ? a : o },
      h = r / l.w,
      d = i / l.h,
      c = d < h ? h : d,
      g = n[0],
      ...
      f = n[2],
      u = n[3] / c;
    e.setAttribute("width", l.w),
      e.setAttribute("height", l.h),
      e.setAttribute("preserveAspectRatio", "xMidYMin meet");
    for (var C = l.h, m = g, O = p, v = []; O < u; ) {
      var y = [m, O * c, f, u];
      (y = y.join()),
        v.push({ vb: y, innerSize: l, size: s }),
        (O += l.h),
        i < (C += l.h) && (C = i);
    }
    return v;
  ...
  (OrgChart.prototype._pagesA100 = function (t, e, r) {
    ...
    var n = i[0],
      ...
      c = { w: t.landscape ? o : a, h: t.landscape ? a : o };
    e.setAttribute("preserveAspectRatio", "xMinYMin slice"),
      e.setAttribute("width", d.w),
      e.setAttribute("height", d.h);
    for (
      var g = n, p = l, f = d.w * (100 / r), u = d.h * (100 / r), C = [];
      g < s;

    ) {
      for (; p < h; ) {
        var m = [g, p, g + f, u];
        (m = m.join()), C.push({ vb: m, innerSize: d, size: c }), (p += u);
      }
      (g += f), (p = l);
    }
    return C;
    ...
    return {
      on: function (t, e, r) {
        Array.isArray(n[t]) || (n[t] = []),
          n[t].push({ listener: e, event_id: r });
      },
      ...
      removeForEventId: function (t) {
        for (var e in n)
          if (Array.isArray(n[e]))
            for (var r = n[e].length - 1; 0 <= r; r--)
              n[e][r].event_id == t && n[e].splice(r, 1);
      },
      publish: function (t, e) {
        if (n[t]) {
          for (var r = [], i = 0; i < n[t].length; i++) {
            var a = n[t][i];
            (null != a.event_id && a.event_id != e[0]._event_id) ||
              r.push(a.listener);
          }
          if (0 < r.length) {
            var o = !0;
            for (i = 0; i < r.length; i++)
              1 == e.length
                ...
                ? (o = r[i](e[0], e[1], e[2]) && o)
                : 4 == e.length
                ? (o = r[i](e[0], e[1], e[2], e[3]) && o)
                : 5 == e.length &&
                  (o = r[i](e[0], e[1], e[2], e[3], e[4]) && o);
            return o;
          }
        }
      },
  ...
  (OrgChart.prototype.importCSV = function () {
    ...
    t.setAttribute("type", "file"),
      ...
      (t.onchange = function (t) {
        ...
        (s.onload = function () {
          for (
            var t = s.result, e = OrgChart._csvToArray(t, ","), r = [], i = 1;
            i < e.length;
            i++
          ) {
            for (var a = {}, o = 0; o < e[i].length; o++) {
              var n = e[0][o],
                l = e[i][o];
              if ("tags" == n && "" != l) l = l.split(",");
              else if ("tags" == n && "" == l) continue;
              a[n] = l;
            }
            "" != a.id.trim() && r.push(a);
          }
          0 != OrgChart.events.publish("import", [h, r]) &&
            ((h.config.nodes = r), h.draw());
        }),
    ...
    t.setAttribute("type", "file"),
      ...
      (t.onchange = function (t) {
        ...
        (r.onload = function () {
          ...
          0 != OrgChart.events.publish("import", [i, e]) &&
            ((i.config.nodes = e), i.draw());
        }),
  ...
  (OrgChart.prototype.expand = function (t, e, r) {
    var i = { id: t, ids: e, state: OrgChart.EXPAND };
    this._draw(!1, OrgChart.action.expandCollapse, i, r);
  }),
  (OrgChart.prototype.collapse = function (t, e, r) {
    var i = { id: t, ids: e, state: OrgChart.COLLAPSE };
    this._draw(!1, OrgChart.action.expandCollapse, i, r);
  }),
  (OrgChart.prototype.expandCollapseToLevel = function (t, e, r, i) {
    ...
    this._draw(!1, OrgChart.action.expandCollapse, a, i);
  }),
  (OrgChart.prototype.maximize = function (t, e) {
    var r = { id: t, state: OrgChart.EXPAND };
    this._draw(!1, OrgChart.action.groupMaxMin, r, e);
  }),
  (OrgChart.prototype.minimize = function (t, e) {
    var r = { id: t, state: OrgChart.COLLAPSE };
    this._draw(!1, OrgChart.action.groupMaxMin, r, e);
  }),
  (OrgChart.prototype._expCollHandler = function (t) {
    this.nodeMenuUI.hide(),
      ...
      this.menuUI.hide();
    var e = this.getBGNode(t);
    if (e.collapsedChildrenIds.length) {
      if (
        !1 ===
        OrgChart.events.publish("expcollclick", [
          this,
          OrgChart.EXPAND,
          t,
          e.collapsedChildrenIds,
        ])
      )
        return !1;
      this.expand(t, e.collapsedChildrenIds, !1);
    } else {
      if (
        !1 ===
        OrgChart.events.publish("expcollclick", [
  ...
  (OrgChart.prototype._maxMinHandler = function (t) {
    this.nodeMenuUI.hide(),
      this.nodeContextMenuUI.hide(),
      this.dragDropMenuUI.hide(),
      this.menuUI.hide();
    var e = this.getBGNode(t);
    if (e.groupState == OrgChart.EXPAND) {
      if (
        !1 ===
        OrgChart.events.publish("expcollclick", [this, OrgChart.COLLAPSE, t])
      )
        return !1;
      this.minimize(t);
    } else if (e.groupState == OrgChart.COLLAPSE) {
      if (
        !1 ===
        OrgChart.events.publish("expcollclick", [this, OrgChart.EXPAND, t])
      )
        return !1;
      this.maximize(t);
    }
  ...
  (OrgChart.prototype._globalMouseDownHandler = function (t, e) {
    ...
    if (this.config.nodeMouseClick == OrgChart.action.pan) {
      for (var i = e.target; i != t && !i.hasAttribute("control-expcoll-id"); )
        i = i.parentNode;
      if (!i.hasAttribute("control-expcoll-id"))
        return (
          e.stopPropagation(),
          e.preventDefault(),
          void this._mouseDownHandler(t, e, r)
    ...
    for (var a = e.target; a != t; ) {
      if (a.hasAttribute("node-id"))
        return (
          e.stopPropagation(),
          e.preventDefault(),
          void this._nodeMouseDownHandler(a, e, r)
        );
      a = a.parentNode;
    }
  }),
  (OrgChart.prototype._globalClickHandler = function (t, e) {
    if (
      ...
      if (e.changedTouches.length) {
        var r = e.changedTouches[0].clientX,
          ...
          a = OrgChart.t(this.config.template, this.getScale()).size,
          o = this.getScale(),
          n = Math.abs(r - this._touch.x) / o,
          l = Math.abs(i - this._touch.y) / o;
        if (((this._touch = null), n > a[0] / 10)) return;
        if (l > a[1] / 10) return;
      }
    ...
    for (var s = e.target; s != t; ) {
      if (s.hasAttribute("control-expcoll-id")) {
        ...
        return void this._expCollHandler(h);
      }
      if (s.hasAttribute("control-maxmin-id")) {
        h = s.getAttribute("control-maxmin-id");
        return void this._maxMinHandler(h);
      }
      if (s.hasAttribute("node-id")) {
        h = s.getAttribute("node-id");
        return void this._nodeClickHandler(h, e);
      }
      if (s.hasAttribute("control-node-menu-id")) {
        h = s.getAttribute("control-node-menu-id");
        return void this._nodeMenuClickHandler(h, s, e);
      }
      if (s.hasAttribute("control-add"))
  ...
  (OrgChart.prototype._globalContextHandler = function (t, e) {
    for (var r = e.target; r != t; ) {
      if (r.hasAttribute("node-id")) {
        ...
        return void this._nodeContextHandler(i, e);
      }
      r = r.parentNode;
    }
  }),
  (OrgChart.prototype._nodeContextHandler = function (t, e) {
    ...
    if (null != r && Array.isArray(r.tags))
      for (var a = 0; a < r.tags.length; a++) {
        var o = r.tags[a];
        this.config.tags[o] &&
          this.config.tags[o].nodeContextMenu &&
          (i = this.config.tags[o].nodeContextMenu);
      }
  ...
  (OrgChart.prototype._globalDbClickHandler = function (t, e) {
    for (var r = e.target; r != t; ) {
      if (r.hasAttribute("node-id")) {
        var i = r.getAttribute("node-id");
        return void this._nodeDbClickHandler(i, e);
      }
      r = r.parentNode;
    }
  }),
      ...
      i ||
        (function t() {
          ...
          0 < e ? e++ : e--,
            (l += e),
            r.zoom(1 - e / 12 / 50, s),
            parseInt(l) == parseInt(n) ? (i = !1) : h(t);
        })();
  }),
  (OrgChart.prototype._nodeMouseDownHandler = function (t, e, n) {
    if (this.config.enableDragDrop) {
      var r = OrgChart._getClientXY(e),
        i = t.getAttribute("node-id"),
        l = this.getBGNode(i);
      if (!1 !== OrgChart.events.publish("drag", [this, i])) {
        var s = null,
          h = null;
        ...
        if (
          ...
          var a = this.getNodeElement(l._groupParentNodeId),
            o = OrgChart._getTransform(a);
          (f += o[4]),
            (u += o[5]),
            (p[4] = f),
            (p[5] = u),
            m.setAttribute("transform", "matrix(" + p.toString() + ")");
        }
        var O = function (t, e) {
            if (null != t) {
              var r = d.getBGNode(t);
              r.isChildOfGroup &&
                (d.getNodeElement(r._groupParentNodeId).style.opacity = 1),
                (e.style.opacity = 1);
            }
          },
          v = function (t) {
            ...
            if ((O(s, h), (h = s = null), d.config.enableDragDrop))
              for (; null != r && r != c; ) {
                if (r.hasAttribute("node-id")) {
                  var i = r.getAttribute("node-id");
                  if (d._gragStartedId && i != d._gragStartedId) {
                    (s = i), (h = r);
                    break;
                  }
                }
            ...
            if (null != s) {
              var a = d.getBGNode(s);
              a.isChildOfGroup &&
                (d.getNodeElement(a._groupParentNodeId).style.opacity = 0.8),
                (h.style.opacity = 0.5);
            }
            var o = (e.x - g.x) / C,
              n = (e.y - g.y) / C;
          ...
          y = function (t) {
            if (
              (c.removeEventListener(n.move, v),
              c.removeEventListener(n.up, y),
              n.leave && c.removeEventListener(n.leave, y),
              l.id == s ||
                (l.isChildOfGroup && l._groupParentNodeId == s) ||
                null == s)
            )
              return O(s, h), c.removeChild(m), void (d._gragStartedId = null);
            var e = d.getBGNode(s);
            if (
              e.isChildOfGroup &&
              l.isChildOfGroup &&
              e._groupParentNodeId == l._groupParentNodeId
            )
              return O(s, h), c.removeChild(m), void (d._gragStartedId = null);
            if (!1 === OrgChart.events.publish("drop", [d, l.id, e.id]))
              return O(s, h), c.removeChild(m), void (d._gragStartedId = null);
            if (null == d.config.dragDropMenu || (l.isGroup && !e.isGroup))
              d._canUpdateLink(l.id, s)
                ? d.linkNode(l.id, s)
                : (c.removeChild(m), O(s, h));
            else if (d._canUpdateLink(l.id, s)) {
              var r = OrgChart._getOffsetXY(d.element, t),
                i = null;
              if (Array.isArray(l.tags))
                for (var a = 0; a < l.tags.length; a++) {
                  var o = l.tags[a];
                  d.config.tags[o] &&
                    d.config.tags[o].dragDropMenu &&
                    (i = d.config.tags[o].dragDropMenu);
                }
              d.dragDropMenuUI.show(r.x, r.y, l.id, s, i);
            } else c.removeChild(m), O(s, h);
            d._gragStartedId = null;
          };
        c.addEventListener(n.move, v),
          c.addEventListener(n.up, y),
          n.leave && c.addEventListener(n.leave, y);
      }
    }
  }),
  ...
  (OrgChart.prototype._commonClickHandler = function (t, e, r) {
    ...
    if (r == OrgChart.action.expandCollapse) {
      if (i.collapsedChildrenIds.length) {
        if (
          !1 ===
          OrgChart.events.publish("expcollclick", [
            this,
            OrgChart.EXPAND,
            t,
            i.collapsedChildrenIds,
          ])
        )
          return !1;
        this.expand(t, i.collapsedChildrenIds, !1);
      } else {
        if (
          !1 ===
          OrgChart.events.publish("expcollclick", [
  ...
  (OrgChart.prototype._nodeMenuClickHandler = function (t, e, r) {
    ...
    var i = this.getBGNode(t),
      a = null;
    if (Array.isArray(i.tags))
      for (var o = 0; o < i.tags.length; o++) {
        var n = i.tags[o];
        this.config.tags[n] &&
          this.config.tags[n].nodeMenu &&
          (a = this.config.tags[n].nodeMenu);
      }
  ...
  (OrgChart.prototype._lonelyButtonHandler = function () {
    var t = new OrgChart.node(
      OrgChart._randomId(),
      null,
      [],
      this.config.template
    );
    !1 !== this.addNode(t, !0) && this.center(t.id);
  }),
  ...
  (OrgChart.node = function (t, e, r, i) {
    (this.templateName = i),
      ...
      (this.childrenIds = []);
    var a = OrgChart.t(this.templateName);
    (this.w = a && a.size ? a.size[0] : 0),
      (this.h = a && a.size ? a.size[1] : 0),
      (this.groupState = OrgChart.EXPAND),
      (this.isChildOfGroup = !1),
      (this.isGroup = !1),
  ...
  (OrgChart.prototype._mouseDownHandler = function (t, e, r) {
    ...
    e.touches &&
      ...
      ((c.type = "pinch"),
      (c.dist = Math.sqrt(
        (i.x - a.x) * (i.x - a.x) + (i.y - a.y) * (i.y - a.y)
      )));
    var o = this.getPointerElement();
    if ("pan" == c.type) {
      this._hideBeforeAnimation();
      var n = OrgChart._getOffsetXY(this.element, e),
        l = n.x / d + h[0] - 16 / d,
        g = n.y / d + h[1] - 16 / d;
      (o.style.display = "inherit"),
        o.setAttribute("transform", "matrix(0,0,0,0," + l + "," + g + ")"),
        OrgChart.anim(
          o,
          {
          ...
          { transform: [1 / d, 0, 0, 1 / d, l, g], opacity: 1 },
          300,
    ...
    var p = function (t) {
        ...
        if (c && "pan" == c.type) {
          s._hideBeforeAnimation(),
            (c.diffX = e.x - c.x0),
            (c.diffY = e.y - c.y0);
          var r = -c.diffY / d + c.viewBoxTop,
            i = -c.diffX / d + c.viewBoxLeft;
          s._move(r, i, h);
        } else if (c && "pinch" == c.type) {
          var a = OrgChart._getClientTouchesXY(t, 1),
            o = Math.sqrt(
              (e.x - a.x) * (e.x - a.x) + (e.y - a.y) * (e.y - a.y)
            ),
            n = 1 + (o - c.dist) / (c.dist / 100) / 100;
          c.dist = o;
          var l = OrgChart._pinchMiddlePointInPercent(
            s.element,
            s.width(),
            s.height(),
            t
    ...
    t.addEventListener(r.move, p),
      t.addEventListener(r.up, f),
      r.leave && t.addEventListener(r.leave, f),
      r.touchstart && t.addEventListener(r.touchstart, f);
  }),
  void 0 === OrgChart && (OrgChart = {}),
  void 0 === OrgChart.remote && (OrgChart.remote = {}),
  (OrgChart.LIMIT_NODES = !0),
  (OrgChart.remote._fromResDTO = function (t, e, r, i) {
    var a = e[t.id];
    if (((t.x = a.p[0]), (t.y = a.p[1]), (t.level = a.p[2]), null != a.l)) {
      var o = OrgChart.remote._find(i, a.l);
      t.leftNeighbor = o;
    }
    if (null != a.r) {
      var n = OrgChart.remote._find(i, a.r);
      t.rightNeighbor = n;
    }
    for (var l = 0; l < t.children.length; l++)
      OrgChart.remote._fromResDTO(t.children[l], e, r, i);
  }),
  (OrgChart.remote._find = function (t, r) {
    var i;
    return (
      t.some(function t(e) {
        return e.id === r ? ((i = e), !0) : e.children.some(t);
      }),
      i
    );
  }),
  (OrgChart.remote._toReqDTO = function (t, e, r) {
    var i = { p: [t.id, null != t.parent ? t.parent.id : null, t.w, t.h] };
    0 < t.children.length &&
      (i.c = OrgChart.remote._convertToIdArray(t.children)),
      null != t.layout && 0 != t.layout && (i.l = t.layout),
      t.isAssistant && (i.a = 1),
      t.templateName != r && (i.t = t.templateName),
      e.push(i);
    for (var a = 0; a < t.children.length; a++)
      OrgChart.remote._toReqDTO(t.children[a], e, r);
  }),
  (OrgChart.remote._convertToIdArray = function (t) {
    for (var e = [], r = 0; r < t.length; r++) e.push(t[r].id);
    return e;
  }),
  (OrgChart.remote._walk = function (r, t, i) {
    for (
      var e = [],
        a = [],
        o = [
          t.orientation,
          t.levelSeparation,
          t.mixedHierarchyNodesSeparation,
          t.subtreeSeparation,
          t.siblingSeparation,
          t.template,
        ],
      ...
      a.push(r[n].id), OrgChart.remote._toReqDTO(r[n], e, t.template);
    var l = { n: e, c: o, r: a, v: "6.0.0" };
    OrgChart.LIMIT_NODES || (l.l = !0),
      null != OrgChart.remote._fromReqDTO
        ? OrgChart.remote._fromReqDTO(l.n, l.r, l.c, function (t) {
            for (var e = 0; e < r.length; e++)
              OrgChart.remote._fromResDTO(r[e], t, 0, r);
            i();
          })
        : ((l = JSON.stringify(l)),
          OrgChart.idb.read(l, function (t, e) {
            t
              ? OrgChart.remote._proceed(r, e.res, i)
              : OrgChart.remote._findRegion(function (t) {
                  OrgChart._ajax(t, "post", l, "json", function (t) {
                    t.error
                      ? i(2)
                      : (OrgChart.remote._proceed(r, t, i),
                        OrgChart.idb.write({ id: l, res: t }));
                  });
                });
          }));
  }),
  (OrgChart.remote._proceed = function (t, e, r) {
    if (("string" == typeof e && (e = JSON.parse(e)), e.limit && 1 == e.limit))
      r(e.limit);
    else {
      for (var i = 0; i < t.length; i++)
        OrgChart.remote._fromResDTO(t[i], e, 0, t);
      r();
    }
  }),
  (OrgChart.remote.getItem = function (t) {
    return OrgChart._browser().msie || OrgChart._browser().edge
      ? OrgChart.remote[t]
      : localStorage.getItem(t);
  }),
  (OrgChart.remote.setItem = function (t, e) {
    OrgChart._browser().msie || OrgChart._browser().edge
      ? (OrgChart.remote[t] = e)
  ...
  (OrgChart.searchUI.prototype.addSearchControl = function () {
    ...
    (t.innerHTML = OrgChart.searchUI.createSearchIcon(this.obj.config.padding)),
      (t.innerHTML += OrgChart.searchUI.createInputField(
        this.obj.config.padding
      )),
      this.obj.element.appendChild(t);
    var e = this.obj.element.querySelector('[data-id="search-icon"]'),
      i = this.obj.element.querySelector('[data-id="search"]'),
      a = this.obj.element.getElementsByTagName("input")[0];
    e.addEventListener("mouseover", function () {
      r.show();
    }),
      i.addEventListener("mouseleave", function () {
        document.activeElement != a && r.hide();
      }),
      i.addEventListener("click", function () {
        a.focus();
      }),
      a.addEventListener("keyup", function (t) {
        40 == t.keyCode
          ...
          : 27 == t.keyCode
          ? r.hide()
          : r._serverSearch(this.value);
      });
    var o = function () {
        var t = i.querySelectorAll("[data-search-item-id]"),
          e = i.querySelector('[data-selected="yes"]');
        null == e && 0 < t.length
          ? (t[0].setAttribute("data-selected", "yes"),
            (t[0].style.backgroundColor = "#F0F0F0"))
          : 0 < t.length &&
            e.nextSibling &&
            (e.setAttribute("data-selected", "no"),
            (e.style.backgroundColor = "inherit"),
            e.nextSibling.setAttribute("data-selected", "yes"),
            (e.nextSibling.style.backgroundColor = "#F0F0F0"));
      },
      n = function () {
        var t = i.querySelectorAll("[data-search-item-id]"),
          e = i.querySelector('[data-selected="yes"]');
        null == e && 0 < t.length
          ? (t[t.length - 1].setAttribute("data-selected", "yes"),
            (t[t.length - 1].style.backgroundColor = "#F0F0F0"))
          : 0 < t.length &&
            e.previousSibling &&
            (e.setAttribute("data-selected", "no"),
            (e.style.backgroundColor = "inherit"),
            e.previousSibling.setAttribute("data-selected", "yes"),
            (e.previousSibling.style.backgroundColor = "#F0F0F0"));
      },
      l = function () {
        var t = i
            .querySelector('[data-selected="yes"]')
            .getAttribute("data-search-item-id"),
          e = OrgChart.events.publish("searchclick", [r.obj, t]);
        (null != e && 1 != e) || r.obj.center(t);
      };
  }),
  ...
  (OrgChart.searchUI.prototype._serverSearch = function (t) {
    for (
      var e = this,
        r = this.obj.element.querySelector('[data-id="container"]'),
        i = this.obj.element.querySelector('[data-id="search"]'),
        a = this.obj.server.find(t),
        o = "",
        n = 0;
      n < a.length;
      n++
      ...
      l.img &&
        (s =
          '<img style="padding: 2px 0px  2px 7px;width:32px;height:32px;" src="' +
          l.img +
          '" / >'),
        (o += OrgChart.searchUI.createItem(s, l));
    }
    r.innerHTML = o;
    var h = i.querySelectorAll("[data-search-item-id]");
    for (n = 0; n < h.length; n++)
      h[n].addEventListener("click", function () {
        var t = OrgChart.events.publish("searchclick", [
          e.obj,
        ...
        h[n].addEventListener("mouseover", function () {
          this.setAttribute("data-selected", "yes"),
            (this.style.backgroundColor = "#F0F0F0");
        }),
        h[n].addEventListener("mouseleave", function () {
  ...
  (OrgChart.searchUI.createSearchIcon = function (t) {
    return (
      '<div data-id="search-icon" style="padding:5px; position:absolute;top:' +
      t +
      "px;left:" +
      t +
      'px;border:1px solid transparent;"><div><div style="float:left;">' +
      OrgChart.icon.search(32, 32) +
      "</div></div></div>"
    );
  }),
  void 0 === OrgChart && (OrgChart = {}),
  (OrgChart.server = function (t) {
    (this.config = t),
  ...
  (OrgChart.server.prototype.read = function (t, r, i, e, a, o, n, l) {
    var s = this;
    (this.viewBox = e), (this.action = a), (this.actionParams = o);
    var h = this.maxX,
      d = this.maxY,
      c = this.minX,
      g = this.minY,
      p = this.root,
      f = this.nodes,
      u = this.groupChildren;
    if (t) {
      var C = OrgChart.server._getResponse(
        r,
        i,
        this.visibleNodes,
        this.config,
      ...
      a != OrgChart.action.exporting &&
        ...
        (this.root = p),
        (this.nodes = f),
        (this.groupChildren = u),
        (this.visibleNodes = C.visibleNodes)),
        n(C);
    } else
      (this.oldNodes = f || null),
        this._read(function (t) {
          (h = t.maxX),
            ...
            (f = t.nodes),
            (u = t.groupChildren);
          var e = OrgChart.server._getResponse(
            r,
            i,
            s.visibleNodes,
            s.config,
          ...
          (e.notif = t.limit),
            a != OrgChart.action.exporting &&
              ...
              (s.nodes = f),
              (s.groupChildren = u),
              (s.visibleNodes = e.visibleNodes)),
            n(e);
        }, l);
  }),
  (OrgChart.server.prototype._read = function (a, t) {
    var o = this,
      n = OrgChart.server._createNodes(
        this.config,
        this.action,
        this.actionParams,
        this.oldNodes
    ...
    var l = n.nodes,
      s = n.roots,
      e = OrgChart.remote;
    null == e && (e = OrgChart.local),
      e._walk(s, this.config, function (t) {
        OrgChart.server._doNotChangePositionOfClickedNodeIfAny(
          s,
          l,
          o.action,
          o.actionParams,
        ...
        var e = { minX: null, minY: null, maxX: null, maxY: null };
        for (var r in l) {
          var i = l[r];
          OrgChart.server._setMinMaxXY(i, e);
        }
        a({
          minX: e.minX,
          minY: e.minY,
  ...
  (OrgChart.server.prototype.find = function (t) {
    ...
    for (
      var e,
        ...
        a,
        o = function (t) {
          for (var e in r.config.nodeBinding)
            if (r.config.nodeBinding[e] == t) return !0;
          return !1;
        },
        n = [],
        l = [],
      ...
      for (var d in h) {
        var c = h[d];
        (0 < this.config.searchFields.length &&
          -1 == this.config.searchFields.indexOf(d)) ||
          (c &&
            -1 != OrgChart.accentFold(c).indexOf(t) &&
            !OrgChart._fieldIsImg(this.config, d) &&
            n.push({
              id: h.id,
              propertyName: d,
              isId: d == OrgChart.ID,
              isNodeParam: o(d),
              weight: OrgChart.accentFold(c).indexOf(t),
              data: h,
            }));
      }
    }
    n.sort(function (t, e) {
      return 1 == t.isId && 0 == e.isId
        ? -1
        : 1 == e.isId && 0 == t.isId
        ? 1
        : 1 == t.isNodeParam && 0 == e.isNodeParam
        ? -1
        : 1 == e.isNodeParam && 0 == t.isNodeParam
        ? 1
        : t.weight < e.weight
        ? -1
        : t.weight > e.weight
    ...
    for (s = 0; s < n.length && s != OrgChart.SEARCH_RESULT_LIMIT; s++) {
      ...
      if (!g) {
        var f = "",
          ...
          C = "",
          m = "",
          O = Object.getOwnPropertyNames(n[s].data);
        0 < this.config.searchFields.length && (O = this.config.searchFields);
          ...
          d === n[s].propertyName &&
            ...
            d != OrgChart.TAGS &&
              (d == OrgChart.ID
                ...
                : OrgChart._fieldIsImg(this.config, d)
                ? (m = c)
                : o(d) && !OrgChart._fieldIsImg(this.config, d)
                ? (f = f + c + ", ")
                : OrgChart._fieldIsImg(this.config, d) || (C = C + c + ", "));
        }
        (u = u.slice(0, u.length - 2)),
          (f = f.slice(0, f.length - 2)),
          (C = C.slice(0, C.length - 2));
        var v = OrgChart._getTemplate(
          n[s].tags,
          this.config.tags,
          this.config.template
        );
        l.push({
          id: n[s].id,
          node: new OrgChart.node(n[s], null, [], v),
          textId: u,
          textInNode: f,
          text: C,
          img: m,
  ...
  void 0 === OrgChart && (OrgChart = {}),
  (OrgChart.server._createNodes = function (a, t, e, r) {
    for (
      var i = a.nodes, o = {}, n = [], l = [], s = [], h = {}, d = !1, c = 0;
      c < i.length;
      c++
    ) {
      var g = i[c],
        p = Array.isArray(g.tags) ? g.tags.slice(0) : [],
        f = OrgChart._getGroup(p, a.tags),
        u = OrgChart._getTemplate(p, a.tags, a.template);
      if (
        (((v = new OrgChart.node(g.id, g.pid, p, u)).isAssistant =
          -1 != p.indexOf("assistant")),
        v.isAssistant &&
          -1 == s.indexOf(v.pid) &&
          OrgChart.server._isNotNullEmptyUndefined(v.pid) &&
          s.push(v.pid),
        null != f)
      ) {
        if (!o[f.name]) {
          n.push(f.name);
          var C = new OrgChart.node(f.name, g.pid, [f.name], f.tag.template);
          (C.isGroup = !0),
            null != a.orderBy &&
              (C.order = OrgChart.server._getOrderFieldValue(g, a.orderBy)),
            (o[f.name] = C);
        }
        (v.isChildOfGroup = !0),
          (v._groupParentNodeId = f.name),
          o[f.name].bgnodes.push(v),
          1 == v.isAssistant && (o[f.name].isAssistant = !0),
          (h[v.id] = f.name),
          (d = !0);
      } else
        null != a.orderBy &&
          (v.order = OrgChart.server._getOrderFieldValue(g, a.orderBy)),
          (o[g.id] = v),
          n.push(g.id);
    }
    if (
      (null != a.orderBy &&
        n.sort(function (t, e) {
          ...
          return "number" == typeof r || "number" == typeof i
            ? (null == r && (r = -1),
              null == i && (i = -1),
              a.orderBy.desc ? i - r : r - i)
            : "string" == typeof r || "string" == typeof i
            ? (null == r && (r = ""),
              null == i && (i = ""),
              a.orderBy.desc ? i.localeCompare(r) : r.localeCompare(i))
            : void 0;
        }),
      d)
    )
      for (c = 0; c < n.length; c++) {
        h[(v = o[n[c]]).pid] && v.id != h[v.pid] && (v.pid = h[v.pid]);
      }
    var m = [];
    for (c = 0; c < n.length; c++) {
      var O = n[c],
        v = o[O],
        y = r ? r[O] : null;
      if (OrgChart.server._isNotNullEmptyUndefined(v.pid))
        (H = o[v.pid])
          ? ((v.parent = H).children.push(v), H.childrenIds.push(v.id))
          : ((v.pid = null),
            (v.parent = null),
            (v.isAssistant = !1),
            l.push(v));
      else (v.isAssistant = !1), l.push(v);
      t == OrgChart.action.exporting && null != e.id && (l = [o[e.id]]),
        y
          ? ((v.state = y.state),
            v.state == OrgChart.COLLAPSE && m.push(v.id),
            OrgChart.server._setNodeGroupState(v, y.groupState, a.orientation))
          : OrgChart.server._setNodeGroupState(
              v,
              OrgChart.EXPAND,
              a.orientation
            ),
        OrgChart.server._initStates(v, o, t, a, e, m),
        OrgChart.server._initGroupStates(v, o, t, a, e);
    }
    if (null != a.roots) {
      l = [];
      for (c = 0; c < a.roots.length; c++) {
        var x = o[a.roots[c]];
        if (x) {
          if (x.parent)
            for (var b = (H = x.parent).children.length - 1; 0 <= b; b--) {
              (z = H.children[b]) == x &&
                ((z.parent = null),
                H.children.splice(b, 1),
                H.childrenIds.splice(b, 1));
            }
          (x.isAssistant = !1), l.push(x);
        }
      }
    }
    for (c = 0; c < s.length; c++) {
      ...
      if (H) {
        var _ = new OrgChart.node(H.id + "_split_0", H.id, [], "split");
        ((o[_.id] = _).isAssistant = !0),
          (y = r[_.id]) &&
            ((o[_.id].state = y.state),
            o[_.id].state == OrgChart.COLLAPSE && m.push(_.id)),
          OrgChart.server._initStates(_, o, t, a, e, m);
        var k = [];
        for (b = H.children.length - 1; 0 <= b; b--) {
          (z = H.children[b]).isAssistant
            ? ((z.parent = null),
              H.children.splice(b, 1),
              H.childrenIds.splice(b, 1),
              k.splice(0, 0, z.id))
            : ((z.pid = _.id),
              (z.parent = _).children.unshift(z),
              _.childrenIds.unshift(z.id),
              H.children.splice(b, 1));
        }
        if (k.length % 2) {
          var A = o[k[k.length - 1]],
            S = [A.w, A.h],
            I = "transperant_" + A.templateName;
          (OrgChart.templates[I] = {
            linkAdjuster: {},
            link: "",
            node: "",
            nodeMenuButton: "",
        ...
        for (b = k.length - 1; 0 <= b; b--) {
          if (b % 2 && b != k.length - 1)
            ((J = new OrgChart.node(
              ...
              k.splice(b, 0, J.id),
              N++;
          else b % 2 && k.splice(b, 0, _.id);
        }
        for (b = 0; b < k.length; b += 3) {
          var M = null;
          M = 0 == b ? H : o[k[b - 2]];
          var E = o[k[b]],
            L = o[k[b + 1]],
          ...
          (E.parent = M),
            ...
            M.children.push(L),
            M.children.push(B),
            M.childrenIds.push(E.id),
            M.childrenIds.push(L.id),
            M.childrenIds.push(B.id);
          for (var T = M; "split" == T.templateName && (T = T.parent); )
            T.childrenIds.push(E.id),
              T.childrenIds.push(L.id),
              T.childrenIds.push(B.id);
        }
      }
    }
    if (t == OrgChart.action.centerNode) {
      var P = o[e.id];
      P ||
        ((P = o[h[e.id]]),
        OrgChart.server._setNodeGroupState(P, OrgChart.EXPAND, a.orientation)),
        (P.state = OrgChart.EXPAND),
        -1 != (D = m.indexOf(P.id)) && m.splice(D, 1);
      for (var H = OrgChart.server._getRealParent(P), U = P.id; null != H; ) {
        if (
          (-1 != (D = m.indexOf(H.id)) && m.splice(D, 1),
          (H.state = OrgChart.EXPAND),
          e.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS)
        )
          for (c = 0; c < H.childrenIds.length; c++) {
            var z = o[H.childrenIds[c]];
            if (!OrgChart.server._isSplit(z) && !z.isAssistant && z.id != U)
              -1 == (D = m.indexOf(H.childrenIds[c])) &&
                m.push(H.childrenIds[c]),
                (z.state = OrgChart.COLLAPSE);
          }
        if (H.state == OrgChart.EXPAND)
          for (var F = 0; F < H.childrenIds.length; F++) {
            var j = o[H.childrenIds[F]];
            if (OrgChart.server._isSplit(j) || j.isAssistant)
              -1 != (D = m.indexOf(j.id)) && m.splice(D, 1),
                (j.state = OrgChart.EXPAND);
          }
        (U = H.id), (H = OrgChart.server._getRealParent(H));
      }
      if (e.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
        for (c = 0; c < P.childrenIds.length; c++) {
          if (
            (-1 != (D = m.indexOf(P.childrenIds[c])) && m.splice(D, 1),
            ((z = o[P.childrenIds[c]]).state = OrgChart.EXPAND),
            !z.isAssistant && !OrgChart.server._isSplit(z))
          )
            for (b = 0; b < z.childrenIds.length; b++) {
              var D,
                G = o[z.childrenIds[b]];
              -1 == (D = m.indexOf(z.childrenIds[b])) &&
                m.push(z.childrenIds[b]),
                (G.state = OrgChart.COLLAPSE);
            }
        }
    }
    t == OrgChart.action.exporting && 1 == e.expandChildren && v && (m = []);
    for (c = 0; c < m.length; c++) {
      if ((H = (v = o[m[c]]).parent))
        for (b = H.children.length - 1; 0 <= b; b--) {
          if (H.children[b] == v)
            if (
              (-1 == H.collapsedChildrenIds.indexOf(v.id) &&
                H.collapsedChildrenIds.push(v.id),
              H.children.splice(b, 1),
              "split" == v.templateName || "split" == H.templateName)
            ) {
              if ((M = v.parent)) {
                for (; "split" == M.templateName; ) M = M.parent;
                for (var X = M.childrenIds.length - 1; 0 <= X; X--) {
                  var R = M.childrenIds[X];
                  -1 == M.collapsedChildrenIds.indexOf(R) &&
                    M.collapsedChildrenIds.push(R);
                }
              }
            } else v.parent = null;
        }
    }
    if (a.layout == OrgChart.mixed)
      for (c = 0; c < n.length; c++) {
        if (
          0 == (v = o[n[c]]).childrenIds.length &&
          !v.isAssistant &&
          "split" != v.templateName
        )
          if ((H = v.parent)) {
            if (!OrgChart.server._mixedLayoutAllNodes(H)) continue;
            for (b = H.children.length - 1; 0 <= b; b--) {
              if (
                (z = H.children[b]) != v &&
                0 == z.childrenIds.length &&
                !z.isAssistant &&
                "split" != z.templateName
              ) {
                (z.parent = v),
                  (z.pid = v.id),
                  (z.layout = OrgChart.mixed),
                  H.children.splice(b, 1);
                var Y = v.children.length;
                (v.children[Y] = z), (v.layout = OrgChart.mixed);
              }
            }
          }
      }
    if (
      a.layout == OrgChart.tree ||
      a.layout == OrgChart.treeRightOffset ||
      a.layout == OrgChart.treeLeftOffset
    ) {
      var q = [];
      for (c = 0; c < n.length; c++) {
        if (
          ...
          (H = v.parent) && -1 == q.indexOf(H.id) && q.push(H.id);
      }
      for (c = 0; c < q.length; c++) {
        (H = o[q[c]]),
          (_ = new OrgChart.node(H.id + "_split_0", H.id, [], "split"));
        (o[_.id] = _).layout = OrgChart.tree;
        var V = [];
        for (b = H.children.length - 1; 0 <= b; b--) {
          if (OrgChart.server._mixedLayoutAllNodes(H))
            if (
              0 == (z = H.children[b]).childrenIds.length &&
              !z.isAssistant &&
              "split" != z.templateName &&
              ((z.parent && "split" != z.parent.templateName) ||
                z.parent.isAssistant)
            ) {
              if (
                (((z = H.children[b]).parent = null),
                (z.layout = OrgChart.tree),
                H.children.splice(b, 1),
                H.childrenIds.splice(b, 1),
                a.layout == OrgChart.treeRightOffset && V.splice(0, 0, z.id),
                a.layout == OrgChart.treeLeftOffset ||
                  a.layout == OrgChart.treeRightOffset)
              ) {
                var W;
                I = "transperant_" + z.templateName;
                (OrgChart.templates[I] = {
                  linkAdjuster: {},
                  link: "",
                  node: "",
        ...
        for (N = 1, b = V.length - 1; 0 <= b; b--) {
          ...
          if (b % 2 && b != V.length - 1)
            ((J = new OrgChart.node(
              ...
              V.splice(b, 0, J.id),
              N++;
          else b % 2 && V.splice(b, 0, _.id);
        }
        for (b = 0; b < V.length; b += 3) {
          M = null;
          0 == b && (M = H);
          (E = o[V[b]]), (L = o[V[b + 1]]), (B = o[V[b + 2]]);
          0 != b && (M = o[V[b - 3]]),
            0 == b || L || (M = o[V[b - 2]]),
            (E.parent = M),
            (E.pid = M.id),
            M.children.push(E),
            H.childrenIds.push(E.id),
            L &&
              (0 != b && (M = o[V[b - 2]]),
              (L.parent = M),
              (L.pid = M.id),
              M.children.push(L),
              H.childrenIds.push(L.id)),
            B &&
              (0 != b && (M = o[V[b - 1]]),
              (B.parent = M),
              (B.pid = M.id),
              M.children.push(B),
              H.childrenIds.push(B.id));
        }
      }
    }
    return { nodes: o, roots: l, groupChildren: h };
  }),
  (OrgChart.server._mixedLayoutAllNodes = function (t) {
    if (OrgChart.MIXED_LAYOUT_ALL_NODES) return !0;
    for (var e = t.children.length - 1; 0 <= e; e--) {
      var r = t.children[e];
      if (
        0 < r.childrenIds.length ||
        r.isAssistant ||
        "split" == r.templateName
      )
        return !1;
    }
    return !0;
  ...
  (OrgChart.server._isSplit = function (t) {
    return !!t && "split" == t.templateName;
  }),
  (OrgChart.server._getRealParent = function (t) {
    if (!t) return null;
    if (!t.parent) return null;
    if ("split" != t.parent.templateName) return t.parent;
    for (var e = t.parent; e && "split" == e.templateName; ) e = e.parent;
    return e;
  }),
  (OrgChart.server._initStates = function (t, e, r, i, a, o) {
    if (r == OrgChart.action.init && t) {
      if (t.tags)
        for (var n = 0; n < t.tags.length; n++) {
          ...
          i.tags &&
            i.tags[l] &&
            null != i.tags[l].state &&
            (i.tags[l].state == OrgChart.COLLAPSE && o.push(t.id),
            (t.state = i.tags[l].state));
        }
      OrgChart.server._expandCollapseToLevel(t, e, r, i, a, o);
    } else if (
      r == OrgChart.action.expandCollapse &&
      "expandCollapseToLevel" == a.method
    ) {
      -1 != (s = o.indexOf(t.id)) && o.splice(s, 1),
        (t.state = OrgChart.EXPAND),
        OrgChart.server._expandCollapseToLevel(t, e, r, i, a, o);
    } else if (
      r == OrgChart.action.expandCollapse &&
      (-1 != a.ids.indexOf(t.id) || "all" == a.ids)
    ) {
      if (a.state == OrgChart.COLLAPSE) o.push(t.id);
      else if (a.state == OrgChart.EXPAND) {
        var s;
        -1 != (s = o.indexOf(t.id)) && o.splice(s, 1);
      }
      t.state = a.state;
  ...
  (OrgChart.server._expandCollapseToLevel = function (t, e, r, i, a, o) {
    if (i.collapse.level) {
      var n = 0;
      if (!i.roots || -1 == i.roots.indexOf(t.id)) {
        for (var l = e[t.pid]; OrgChart.server._isSplit(l); ) l = e[l.pid];
        for (; null != l && n <= i.collapse.level; ) {
          if (l && i.roots && -1 != i.roots.indexOf(l.id)) {
            n++;
            break;
          }
          (l = e[l.pid]), n++;
      ...
      if (n >= i.collapse.level) {
        var s = !1;
        if (Array.isArray(i.expand.nodes))
          if (i.expand.allChildren) {
            for (l = e[t.pid]; null != l; ) {
              if (-1 != i.expand.nodes.indexOf(l.id)) {
                s = !0;
                break;
              }
              l = e[l.pid];
            }
            s || (s = -1 != i.expand.nodes.indexOf(t.id));
          } else s = -1 != i.expand.nodes.indexOf(t.id);
        !s && i.collapse.allChildren
          ? (o.push(t.id), (t.state = OrgChart.COLLAPSE))
          : s ||
            i.collapse.allChildren ||
            n != i.collapse.level ||
            (o.push(t.id), (t.state = OrgChart.COLLAPSE));
      }
    }
  }),
  (OrgChart.server._initGroupStates = function (t, e, r, i, a) {
    if (r == OrgChart.action.exporting && 1 == a.expandChildren && t)
      OrgChart.server._setNodeGroupState(t, OrgChart.EXPAND, i.orientation);
    else {
      if (r == OrgChart.action.init && t && t.isGroup) {
        var o = i.tags[t.id].groupState;
        OrgChart.server._setNodeGroupState(t, o, i.orientation);
      }
      r == OrgChart.action.groupMaxMin &&
        OrgChart.server._setNodeGroupState(e[a.id], a.state, i.orientation);
    }
  }),
  (OrgChart.server._initNodeSize = function (t, e, r) {
    var i = OrgChart.t(e),
      a = i.size[0],
      o = i.size[1];
    if (t.isGroup && t.groupState == OrgChart.EXPAND) {
      var n = t.bgnodes.length,
        l = 0,
        s = null,
        h = (o = a = 0),
        d = 0;
      switch (r) {
        ...
        case OrgChart.orientation.top_left:
        case OrgChart.orientation.bottom_left:
          if (i.columns) (s = n / (l = i.columns)), (s = Math.ceil(s));
          else {
            for (; null == s || l < s; ) s = n / ++l;
            2 == l && 1.5 == s && ((l = 3), (s = 1)), (s = Math.ceil(s));
          }
          for (var c = 0; c < t.bgnodes.length; c++)
            (h = Math.max(t.bgnodes[c].w, h)),
              (d = Math.max(t.bgnodes[c].h, d));
          (a =
            h * l +
            i.groupNodesSeparation * l +
            i.groupNodesSeparation +
            i.groupPadding[1] +
            i.groupPadding[3]),
            (o =
              d * s +
              i.groupNodesSeparation * s +
              i.groupNodesSeparation +
              i.groupPadding[0] +
              i.groupPadding[2]);
          break;
        ...
        case OrgChart.orientation.right_top:
        case OrgChart.orientation.left_top:
          if (i.columns) (l = n / (s = i.columns)), (l = Math.ceil(l));
          else {
            for (l = null, s = 0; null == l || s < l; ) l = n / ++s;
            2 == s && 1.5 == l && ((s = 3), (l = 1)), (l = Math.ceil(l));
          }
          for (c = 0; c < t.bgnodes.length; c++)
            (h = Math.max(t.bgnodes[c].w, h)),
              (d = Math.max(t.bgnodes[c].h, d));
          (a =
            h * l +
      ...
      (t._groupSettings = {
        ...
        OrgChart.server._setGroupNodes(t, r);
    }
    (t.w = a), (t.h = o);
  }),
  (OrgChart.server._setNodeGroupState = function (t, e, r) {
    (t.groupState = e), OrgChart.server._initNodeSize(t, t.templateName, r);
  }),
    ...
    for (r = 0; r < t.nodes.length; r++)
      for (var i in t.nodes[r])
        i !== OrgChart.ID &&
          ...
          i !== OrgChart.NODES &&
          i !== OrgChart.PID &&
          (t.nodeBinding[i] || OrgChart._arrayContains(e, i) || e.push(i));
    return e;
  }),
  (OrgChart.server._doNotChangePositionOfClickedNodeIfAny = function (
    t,
    e,
    r,
    i,
    ...
    if (
      ...
      if (null != i.id) {
        var n = i.id;
        r == OrgChart.action.groupMaxMin && e[n].pid && (n = e[n].pid);
        var l = e[n];
        if (!l)
          for (var s in e)
            for (var h = e[s].bgnodes, d = 0; d < h.length; d++)
              if (h[d].id == n) {
                l = e[s];
                break;
              }
        ...
        if (!c)
          for (var s in a)
            for (h = a[s].bgnodes, d = 0; d < h.length; d++)
              if (h[d].id == n) {
                c = a[s];
                break;
              }
  ...
  (OrgChart.server._setGroupNodes = function (t, e) {
    if (t.isGroup && t.groupState == OrgChart.EXPAND)
      for (
        var r = OrgChart.t(t.templateName), i = 0, a = 0, o = 0;
        o < t.bgnodes.length;
        o++
      ) {
        var n = t.bgnodes[o];
        (n.x =
          t._groupSettings._cellWidth / 2 -
          n.w / 2 +
          r.groupNodesSeparation +
          (t._groupSettings._cellWidth * i + r.groupNodesSeparation * i)),
          (n.y =
            t._groupSettings._cellHeight / 2 -
            n.h / 2 +
            r.groupNodesSeparation +
            (t._groupSettings._cellHeight * a + r.groupNodesSeparation * a)),
          i >= t._groupSettings._columns - 1 ? ((i = 0), a++) : i++;
      }
  }),
  (OrgChart.server._getResponse = function (
    t,
    e,
    r,
    i,
    ...
    if (
      ((C.top = l - i.padding),
      (C.left = n - i.padding),
      (C.bottom = o + i.padding - e / y),
      (C.right = a + i.padding - t / y),
      (C.maxX = a),
      (C.minX = n),
      (C.maxY = o),
      (C.minY = l),
      null == s && i.align == OrgChart.CENTER)
    ) {
      var x = Math.ceil(t / y),
        b = Math.ceil(e / y),
        w = 0,
        _ = 0;
      if (x - 2 * i.padding >= a - n)
        switch (((w = (a + n) / 2 - x / 2), i.orientation)) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            w = (n - a) / 2 - x / 2;
        }
        ...
        switch (
          ((w = h.x - x / 2 + OrgChart.server._getNodeWidth(h, i) / 2),
          i.orientation)
        ) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            (w = -(x / 2 - (n - a) / 2)) < i.padding - x && (w = i.padding - x);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.bottom_left:
          case OrgChart.orientation.top_left:
          case OrgChart.orientation.left_top:
            (w = -(x / 2 - (a - n) / 2)) > -i.padding && (w = -i.padding);
        }
      if (b - 2 * i.padding >= o - l)
        switch (((_ = (o + l) / 2 - b / 2), i.orientation)) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            _ = (l - o) / 2 - b / 2;
        }
        ...
        switch (
          ((_ = -(b / 2 - (o - l) / 2)) > -i.padding && (_ = -i.padding),
          i.orientation)
        ) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (_ = -(b / 2 - (l - o) / 2)) < i.padding - b && (_ = i.padding - b);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.right:
            _ = h.y - b / 2 + OrgChart.server._getNodeWidth(h, i) / 2;
        }
      s = [w, _, x, b];
    } else if (null == s && i.align == OrgChart.ORIENTATION) {
      (x = Math.ceil(t / y)), (b = Math.ceil(e / y)), (w = 0), (_ = 0);
      switch (i.orientation) {
        ...
        case OrgChart.orientation.right:
          ...
          break;
        case OrgChart.orientation.top_left:
          (w = -i.padding), (_ = -i.padding);
          break;
        case OrgChart.orientation.right_top:
          (w = i.padding - x), (_ = -i.padding);
          break;
        case OrgChart.orientation.left_top:
          (w = -i.padding), (_ = -i.padding);
          break;
        case OrgChart.orientation.bottom_left:
          (w = -i.padding), (_ = i.padding - b);
      }
      s = [w, _, x, b];
    }
    d == OrgChart.action.centerNode &&
      ((B = g[c.id]) || (B = g[p[c.id]]),
      1 == c.options.horizontal && (s[0] = B.x + B.w / 2 - s[2] / 2),
      1 == c.options.vertical && (s[1] = B.y + B.h / 2 - s[3] / 2),
      i.sticky &&
        (s[0] < C.left &&
          s[0] < C.right &&
    ...
    if (
      ...
      d == OrgChart.action.expandCollapse ||
      ...
      if (
        ...
        (k = g[c.insertedNodeId]) || (k = g[p[c.insertedNodeId]]);
      else if (
        d == OrgChart.action.update &&
        c &&
        null != c.visId &&
        ...
        (k = g[c.id]) || (k = g[p[c.id]]),
          (k = OrgChart.server._getMostDeepChild(k, g));
      else if (d == OrgChart.action.centerNode) {
        switch (i.orientation) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            c.options.vertical || (k = g[c.id]);
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            c.options.horizontal || (k = g[c.id]);
        }
        k &&
          (k || (k = g[p[c.id]]),
          (k = OrgChart.server._getMostDeepChild(k, g)));
      ...
      if (k)
        switch (i.orientation) {
          ...
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            A = k.x + k.w - s[2] + i.padding;
            s[0] < A && (s[0] = A);
        }
    }
    for (var S in g) {
      var I = g[S];
      if (OrgChart.server._isVisible(I, i, s, d)) {
        u[I.id] = I;
        var N = null;
        if (
          d == OrgChart.action.expandCollapse &&
          f &&
          f[I.id] &&
          "expandCollapseToLevel" == c.method
        ) {
          if (((N = { x: (T = f[I.id]).x, y: T.y }), T)) {
            N = { x: T.x, y: T.y };
            for (var M = I, E = null; null != M; )
              f[M.id] && f[M.id].state == OrgChart.COLLAPSE && (E = M),
                (M = M.parent);
            E && E.parent && (N = { x: E.parent.x, y: E.parent.y });
          }
          if ((L = g[c.id])) {
            for (M = I.parent; null != M; ) M = M.parent;
            M &&
              (N = { x: L.x + L.w / 2 - I.w / 2, y: L.y + L.h / 2 - I.h / 2 });
          }
        } else if (d == OrgChart.action.expandCollapse && f && f[I.id]) {
          var L;
          if (((N = { x: (T = f[I.id]).x, y: T.y }), "all" == c.ids && T)) {
            N = { x: T.x, y: T.y };
            for (M = I, E = null; null != M; )
              f[M.id] && f[M.id].state == OrgChart.COLLAPSE && (E = M),
                (M = M.parent);
            E && E.parent && (N = { x: E.parent.x, y: E.parent.y });
          }
          if ((L = g[c.id])) {
            for (
              M = I.parent;
              null != M &&
              -1 == c.ids.indexOf(I.id) &&
              -1 == c.ids.indexOf(M.id);
        ...
        } else if (d == OrgChart.action.centerNode && f && f[I.id]) {
          var B;
          if (
            (null != (T = f[I.id]).x && null != T.y && (N = { x: T.x, y: T.y }),
            (B = g[c.id]) && B == I)
          )
            (M = I.parent) &&
              M.id == c.id &&
        ...
        } else if (d == OrgChart.action.groupMaxMin && f && f[I.id]) {
          N = { x: (T = f[I.id]).x, y: T.y };
        } else if (d == OrgChart.action.insert && c && c.insertedNodeId == I.id)
          N = {
            x: I.parent.x,
            y: I.parent.y,
          };
        else if (
          (d == OrgChart.action.update || d == OrgChart.action.insert) &&
          f &&
          f[I.id]
        ) {
          var T;
        ...
        null != N &&
          ...
          ((N.x == I.x && N.y == I.y) ||
            (m[0].push(I.id),
            m[1].push({ transform: [1, 0, 0, 1, N.x, N.y] }),
            m[2].push({ transform: [1, 0, 0, 1, I.x, I.y] })));
      }
    }
    return {
      animations: m,
  ...
  (OrgChart.server._setMinMaxXY = function (t, e) {
  ...
  (OrgChart.server._isNotNullEmptyUndefined = function (t) {
  ...
  (OrgChart.templates.base = {
    ...
    svg:
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:block;" width="{w}" height="{h}" viewBox="{viewBox}">{content}</svg>',
    link:
    ...
    node:
      '<rect x="0" y="0" height="120" width="250" fill="none" stroke-width="1" stroke="#aeaeae"></rect>',
    plus:
    ...
    link_field_0:
      '<text class="field_0" text-anchor="middle" fill="#aeaeae" width="290" x="0" y="0" style="font-size:10px;">{val}</text>',
  }),
  (OrgChart.templates.ana = {
    ...
    pointer:
      '<g data-pointer="pointer" transform="matrix(0,0,0,0,100,100)"><radialGradient id="pointerGradient"><stop stop-color="#ffffff" offset="0" /><stop stop-color="#C1C1C1" offset="1" /></radialGradient><circle cx="16" cy="16" r="16" stroke-width="1" stroke="#acacac" fill="url(#pointerGradient)"></circle></g>',
    node:
      '<rect x="0" y="0" height="120" width="250" fill="#039BE5" stroke-width="1" stroke="#aeaeae" rx="5" ry="5"></rect>',
    plus:
      '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#aeaeae" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#aeaeae"></line>',
    minus:
      '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#aeaeae" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line>',
    ...
    field_0:
      '<text width="230" class="field_0"  style="font-size: 18px;" fill="#ffffff" x="125" y="95" text-anchor="middle">{val}</text>',
    field_1:
      '<text width="130" text-overflow="multiline" class="field_1"  style="font-size: 14px;" fill="#ffffff" x="230" y="30" text-anchor="end">{val}</text>',
  }),
  ...
  (OrgChart.templates.group_orange = Object.assign(
    {},
    OrgChart.templates.base
  )),
  (OrgChart.templates.group_orange.size = [250, 120]),
  (OrgChart.templates.group_orange.node =
    '<rect rx="5" x="0" y="0" height="{h}" width="{w}" fill="#ffe6cc" stroke-width="1" stroke="#F57C00"></rect>'),
  (OrgChart.templates.group_orange.groupPadding = [50, 10, 10, 10]),
  (OrgChart.templates.group_orange.groupNodesSeparation = 10),
  (OrgChart.templates.group_orange.groupName =
    '<text width="{elastic_width}" class="groupName"  style="font-size: 24px;" fill="#F57C00" x="20" y="40">{val}</text>'),
  (OrgChart.templates.group_yellow = Object.assign(
    {},
    OrgChart.templates.group_orange
  )),
  (OrgChart.templates.group_yellow.node =
    '<rect rx="5" x="0" y="0" height="{h}" width="{w}" fill="#ffefbe" stroke-width="1" stroke="#FFCA28"></rect>'),
  (OrgChart.templates.group_yellow.groupName =
    '<text width="{elastic_width}" class="groupName"  style="font-size: 24px;" fill="#FFCA28" x="20" y="40">{val}</text>'),
  (OrgChart.templates.group_grey = Object.assign(
    {},
    OrgChart.templates.group_orange
  )),
  (OrgChart.templates.group_grey.node =
    '<rect rx="5" x="0" y="0" height="{h}" width="{w}" fill="#eeeeee" stroke-width="1" stroke="#aeaeae"></rect>'),
  (OrgChart.templates.group_grey.groupName =
    '<text width="{elastic_width}"  class="groupName"  style="font-size: 24px;" fill="#aeaeae" x="20" y="40">{val}</text>'),
  (OrgChart.templates.group_grey_one_column = Object.assign(
    {},
    OrgChart.templates.group_grey
  )),
  ...
  (OrgChart.templates.ula.field_0 =
    '<text width="145" class="field_0" style="font-size: 18px;" fill="#039BE5" x="100" y="55">{val}</text>'),
  (OrgChart.templates.ula.field_1 =
    '<text width="145" text-overflow="multiline" class="field_1" style="font-size: 14px;" fill="#afafaf" x="100" y="76">{val}</text>'),
  (OrgChart.templates.ula.node =
    '<rect x="0" y="0" height="120" width="250" fill="#ffffff" stroke-width="1" stroke="#aeaeae"></rect><line x1="0" y1="0" x2="250" y2="0" stroke-width="2" stroke="#039BE5"></line>'),
  ...
  (OrgChart.templates.olivia.field_0 =
    '<text width="145" class="field_0" style="font-size: 18px;" fill="#757575" x="100" y="55">{val}</text>'),
  (OrgChart.templates.olivia.field_1 =
    '<text width="145" class="field_1" style="font-size: 14px;" fill="#757575" x="100" y="76">{val}</text>'),
  ...
  (OrgChart.templates.olivia.node =
    '<rect fill="url(#{randId})" x="0" y="0" height="120" width="250" stroke-width="1" stroke="#aeaeae" rx="5" ry="5"></rect>'),
  ...
  (OrgChart.templates.belinda.field_0 =
    '<text width="170" class="field_0" style="font-size: 18px;" text-anchor="middle" fill="#ffffff"  x="90" y="105">{val}</text>'),
  (OrgChart.templates.belinda.field_1 =
    '<text width="160" class="field_1" style="font-size: 14px;" text-anchor="middle" fill="#ffffff"  x="90" y="125">{val}</text>'),
  ...
  (OrgChart.templates.rony.field_0 =
    '<text width="165" class="field_0" style="font-size: 18px;" fill="#039BE5" x="90" y="40" text-anchor="middle">{val}</text>'),
  (OrgChart.templates.rony.field_1 =
    '<text width="165" class="field_1" style="font-size: 14px;" fill="#F57C00" x="90" y="60" text-anchor="middle">{val}</text>'),
  (OrgChart.templates.rony.field_2 =
    '<text width="165" style="font-size: 14px;" fill="#FFCA28" x="90" y="80" text-anchor="middle">{val}</text>'),
  ...
  (OrgChart.templates.mery.field_0 =
    '<text width="220" class="field_0" style="font-size: 18px;" fill="#039BE5" x="125" y="30" text-anchor="middle">{val}</text>'),
  (OrgChart.templates.mery.field_1 =
    '<text width="220" class="field_1" style="font-size: 14px;" fill="#039BE5" x="125" y="100" text-anchor="middle">{val}</text>'),
  ...
  (OrgChart.templates.polina.field_0 =
    '<text width="210" class="field_0" style="font-size: 18px;" fill="#ffffff" x="80" y="30" text-anchor="start">{val}</text>'),
  (OrgChart.templates.polina.field_1 =
    '<text width="210" class="field_1" style="font-size: 14px;" fill="#ffffff" x="80" y="55" text-anchor="start">{val}</text>'),
  ...
  (OrgChart.templates.mila.field_0 =
    '<text width="240" class="field_0" style="font-size: 18px;" fill="#039BE5" x="125" y="92" text-anchor="middle">{val}</text>'),
  ...
  (OrgChart.templates.diva.field_0 =
    '<text width="185" class="field_0" style="font-size: 18px;" fill="#ffffff" x="100" y="125" text-anchor="middle">{val}</text>'),
  (OrgChart.templates.diva.field_1 =
    '<text width="185" class="field_1" style="font-size: 14px;" fill="#ffffff" x="100" y="145" text-anchor="middle">{val}</text>'),
  ...
  (OrgChart.templates.luba.field_0 =
    '<text width="235" class="field_0" style="font-size: 18px;" fill="#aeaeae" x="125" y="90" text-anchor="middle">{val}</text>'),
  (OrgChart.templates.luba.field_1 =
    '<text width="140" class="field_1" style="font-size: 14px;" fill="#aeaeae" x="240" y="30" text-anchor="end">{val}</text>'),
  ...
  (OrgChart.templates.derek.field_0 =
    '<text width="235" class="field_0"  style="font-size: 24px;" fill="#aeaeae" x="125" y="90" text-anchor="middle">{val}</text>'),
  (OrgChart.templates.derek.field_1 =
    '<text width="130" class="field_1"  style="font-size: 16px;" fill="#aeaeae" x="230" y="30" text-anchor="end">{val}</text>'),
  ...
  (OrgChart.templates.isla.field_0 =
    '<text width="120" style="font-size: 12px;" fill="#fff" x="90" y="90" text-anchor="middle">{val}</text>'),
  (OrgChart.templates.isla.field_1 =
    '<text width="160" style="font-size: 13px;" fill="#039BE5" x="90" y="64" text-anchor="middle">{val}</text>'),
  ...
  (OrgChart.templates.deborah.field_0 =
    '<text width="125" text-overflow="ellipsis" style="font-size: 18px;" fill="#ffffff" x="15" y="25" text-anchor="start">{val}</text>'),
  (OrgChart.templates.deborah.field_1 =
    '<text width="105" text-overflow="ellipsis" style="font-size: 11px;" fill="#ffffff" x="15" y="135" text-anchor="start">{val}</text>'),
  ...
  (OrgChart.ui = {
    ...
    pointer: function (t, e, r) {
      return e === OrgChart.action.exporting
        ? ""
        : OrgChart.t(t.template, r).pointer;
    },
    node: function (t, e, r, i, a, o, n, l, s, h) {
      var d = OrgChart.t(t.templateName, s),
        c = d.node.replaceAll("{w}", t.w).replaceAll("{h}", t.h);
      if (
        (d.defs &&
          (c = c.replace("{randId}", OrgChart.ui._defsIds[t.templateName])),
        null == n && (n = i.nodeBinding),
        t.isGroup)
      ) {
        var g = i.tags[t.id].groupName;
        if (g) {
          var p = d.groupName.replace(
            "{elastic_width}",
            t.w - (d.groupPadding[3] + d.groupPadding[1] + 45)
          );
          (g = OrgChart.wrapText(g, p)),
            (c += p
              .replace("{val}", g)
        ...
        for (var f in n) {
          ...
          if (e) {
            var C = e[u];
            if (
              ("function" == typeof u && (C = u(h, t)),
              null != C && null != C && null != d[f])
            )
              c += (OrgChart._lblIsImg(i, f) ||
                "string" != typeof C ||
                (C = OrgChart.wrapText(C, d[f])),
              d[f].replace("{val}", C))
                .replaceAll("{randId}", OrgChart._randomId())
                .replaceAll("{randId2}", OrgChart._randomId());
          }
        }
      var m = OrgChart._getPosition(r, t, a, o),
        O = "node";
      Array.isArray(t.tags) && t.tags.length && (O += " " + t.tags.join(" ")),
        t.layout && (O += " tree-layout");
      var v = OrgChart.nodeOpenTag
          .replace("{id}", t.id)
          .replace("{class}", O)
          .replace("{level}", t.level)
          .replace("{x}", m.x)
          .replace("{y}", m.y),
        y = OrgChart._getOpacity(r, t);
      (v = v.replace("{opacity}", y)),
        t.isGroup ||
          null == i.nodeMenu ||
          "split" == t.templateName ||
          l === OrgChart.action.exporting ||
          (c += d.nodeMenuButton.replace("{id}", t.id));
      var x = OrgChart.ui._renderGroupedNodes(t, d, i, r, n, a, o, l, s, h);
      return (
        t.isGroup &&
          l != OrgChart.action.exporting &&
          (t.groupState == OrgChart.EXPAND
            ? (c += OrgChart.MINIMIZE.replace("{x}", t.w - 45).replace(
                "{id}",
                t.id
              ))
            : (c += OrgChart.MAXIMIZE.replace("{x}", t.w - 45).replace(
                "{id}",
                t.id
              ))),
        (c = v + c + x + OrgChart.grCloseTag)
      );
    },
    _renderGroupedNodes: function (t, e, r, i, a, o, n, l, s, h) {
      var d = "";
      if (t.isGroup && t.groupState == OrgChart.EXPAND) {
        e.groupPadding ||
          console.error(
            "groupPadding is not defined in template " + t.templateName
          );
        for (var c = 0; c < t.bgnodes.length; c++) {
          for (var g = t.bgnodes[c], p = null, f = 0; f < r.nodes.length; f++)
            r.nodes[f].id == g.id && (p = r.nodes[f]);
          d += OrgChart.ui.node(g, p, i, r, o, n, a, l, s, h);
        }
        d =
          OrgChart.groupNodesOpenTag
            .replace("{x}", e.groupPadding[3])
            .replace("{y}", e.groupPadding[0]) +
          d +
          OrgChart.grCloseTag;
      }
      return d;
    },
    expandCollapse: function (t, e, r, i) {
      if (r === OrgChart.action.exporting) return "";
      if (0 == t.childrenIds.length) return "";
      if (t.isAssistant) return "";
      if ("split" == t.templateName) return "";
      var a = "",
        o = 0,
        n = 0,
        l = OrgChart.t(t.templateName, i);
      switch (e.orientation) {
        case OrgChart.orientation.top:
        case OrgChart.orientation.top_left:
          (o = t.x + t.w / 2), (n = t.y + t.h);
          break;
        case OrgChart.orientation.bottom:
        case OrgChart.orientation.bottom_left:
          (o = t.x + t.w / 2), (n = t.y);
        ...
        case OrgChart.orientation.left:
        case OrgChart.orientation.left_top:
          (o = t.x + t.w), (n = t.y + t.h / 2);
      }
      return (
        (o -= l.expandCollapseSize / 2),
        (n -= l.expandCollapseSize / 2),
        t.collapsedChildrenIds.length
          ? ((a += OrgChart.expcollOpenTag
              .replace("{id}", t.id)
              .replace("{x}", o)
              .replace("{y}", n)),
            (a += l.plus))
          : ((a += OrgChart.expcollOpenTag
              ...
              .replace("{y}", n)),
            (a += l.minus)),
        (a += OrgChart.grCloseTag)
      );
    },
    link: function (t, e, r, i) {
      var a = OrgChart.t(t.templateName, i),
        o = [],
        n = r.levelSeparation / 2;
      (t.layout != OrgChart.mixed && t.layout != OrgChart.tree) ||
        (n = r.mixedHierarchyNodesSeparation / 2);
      for (var l = 0; l < t.children.length; l++) {
        var s = t.children[l],
          h = {
            xa: 0,
          ...
          d = (a = OrgChart.t(s.templateName, i)).link;
        if (
          (s.isAssistant || 2 == s.layout) &&
          s.rightNeighbor &&
          "split" == s.rightNeighbor.templateName
        )
          switch (r.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              h = OrgChart.ui._linkRightToLeft(s.rightNeighbor, s, a, n);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              h = OrgChart.ui._linkRightToLeft(s.rightNeighbor, s, a, n);
            ...
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              h = OrgChart.ui._linkBottomToTop(s.rightNeighbor, s, a, n);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              h = OrgChart.ui._linkBottomToTop(s.rightNeighbor, s, a, n);
          ...
          (s.isAssistant || 2 == s.layout) &&
          s.leftNeighbor &&
          "split" == s.leftNeighbor.templateName
        )
          switch (r.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              h = OrgChart.ui._linkLeftToRight(s.leftNeighbor, s, a, n);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              h = OrgChart.ui._linkLeftToRight(s.leftNeighbor, s, a, n);
            ...
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              h = OrgChart.ui._linkTopToBottom(s.leftNeighbor, s, a, n);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              h = OrgChart.ui._linkTopToBottom(s.leftNeighbor, s, a, n);
          ...
          switch (r.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              h = OrgChart.ui._linkTopToBottom(t, s, a, n);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              h = OrgChart.ui._linkBottomToTop(t, s, a, n);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              h = OrgChart.ui._linkRightToLeft(t, s, a, n);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              h = OrgChart.ui._linkLeftToRight(t, s, a, n);
          }
        (d = d
          .replace("{xa}", h.xa)
          .replace("{ya}", h.ya)
          ...
          o.push(
            OrgChart.linkOpenTag
              .replace("{id}", t.id)
              .replace("{class}", "link " + s.tags.join(" "))
              .replace("{level}", t.level)
              .replace("{child-id}", s.id)
          ),
          o.push(d);
        var c = "";
        for (var g in r.linkBinding) {
          var p = r.linkBinding[g],
            f = e._get(s.id);
          if (f) {
            var u = f[p];
            null != u &&
        ...
        "" != c &&
          ((c =
            ...
            OrgChart.grCloseTag),
          o.push(c)),
          o.push(OrgChart.grCloseTag);
      }
      return o.join("");
    },
    svg: function (t, e, r, i, a, o) {
      return OrgChart.t(i.template, o)
        .svg.replace("{w}", t)
        .replace("{h}", e)
        .replace("{viewBox}", r)
        .replace("{content}", a);
    ...
    exportMenuButton: function (t) {
      return null == t.menu
        ? ""
        : OrgChart.t(t.template).exportMenuButton.replaceAll("{p}", t.padding);
    },
  ...
  (OrgChart._centerPointInPercent = function (t, e, r) {
    var i = t.getBoundingClientRect(),
      a = e - i.left,
      o = r - i.top;
    return [a / (i.width / 100), o / (i.height / 100)];
  }),
  ...
  (OrgChart.getScale = function (t, e, r, i, a, o, n, l) {
    var s = 1;
    ...
    else s = (h = r / l) < (d = e / n) ? h : d;
    return s && a < s && (s = a), s && s < o && (s = o), s;
  }),
  ...
  (OrgChart.htmlRipple = function (n) {
      ...
      n.addEventListener("mousedown", function (t) {
        ...
        return (
          ...
          (a =
            ...
            i +
            "px;"),
          n.rippleContainer.appendChild(r),
  ...
  (OrgChart._pinchMiddlePointInPercent = function (t, e, r, i) {
    var a = OrgChart._getTopLeft(t),
      o = i.touches[0].pageX - a.x,
      n = i.touches[0].pageY - a.y,
      l = i.touches[1].pageX - a.x,
      s = i.touches[1].pageY - a.y;
    return [((o - l) / 2 + l) / (e / 100), ((n - s) / 2 + s) / (r / 100)];
  }),
  ...
  (OrgChart._menuPosition = function (t, e, r) {
    var i = t.getBoundingClientRect(),
      ...
      l = i.top - a.top;
    return (
      i.top + o.height > a.top + a.height && (l -= o.height),
      i.left - o.width < a.left && (n += o.width),
      { x: n, y: l }
    );
  }),
  (OrgChart._getTemplate = function (t, e, r) {
    if (Array.isArray(t))
      for (var i = 0; i < t.length; i++) {
        var a = e[t[i]];
        if (a && !a.group && a.template) return a.template;
      }
    return r;
  }),
  (OrgChart._getGroup = function (t, e) {
    for (var r = 0; r < t.length; r++) {
      var i = e[t[r]];
      if (i && i.group && i.template) return { tag: i, name: t[r] };
    }
    return null;
  }),
  ...
  (OrgChart.wrapText = function (t, e) {
    ...
    var i = new DOMParser()
      ...
      o = parseFloat(i.getAttribute("y")),
      n = i.getAttribute("text-anchor"),
    ...
    if (
      ...
      for (var g = d.getComputedTextLength(), p = 2; l < g; )
        (d.textContent = t.substring(0, t.length - p)),
          (d.textContent += "..."),
          (g = d.getComputedTextLength()),
          p++;
    ...
    if ("multiline" == s) {
      var f = t.split(" "),
        u = d.getBBox().height;
      d.textContent = "";
      var C = document.createElementNS(h, "tspan"),
        m = document.createTextNode(f[0]);
      C.setAttributeNS(null, "x", a),
        C.setAttributeNS(null, "y", o),
        C.setAttributeNS(null, "text-anchor", n),
        C.appendChild(m),
        d.appendChild(C);
      p = 1;
      for (var O = 1, v = 1; v < f.length; v++) {
        var y = C.firstChild.data.length;
        if (
          ((C.firstChild.data += " " + f[v]), C.getComputedTextLength() > l)
        ) {
          if (
            ((C.firstChild.data = C.firstChild.data.slice(0, y)),
            O++,
            0 !== c && c < O)
          )
            break;
          (C = document.createElementNS(h, "tspan")).setAttributeNS(
            null,
            "x",
            a
          ),
            C.setAttributeNS(null, "y", o + u * p),
            C.setAttributeNS(null, "text-anchor", n),
            (m = document.createTextNode(f[v])),
            C.appendChild(m),
            d.appendChild(C),
            p++;
        }
      ...
      var x = "";
      if (null != d.innerHTML) (x = d.innerHTML), (d.innerHTML = "");
      else {
        var b = "";
        for (v = d.childNodes.length - 1; 0 <= v; v--)
          (b = XMLSerializer().serializeToString(d.childNodes[v]) + b),
            d.removeChild(d.childNodes[v]);
        x = b;
      }
      return x;
    }
  ...
  (OrgChart._getPosition = function (t, e, r, i) {
    var a = { x: e.x, y: e.y };
    if ((null != r && (a.x = r), null != i && (a.y = i), t && 3 == t.length)) {
      var o = t[0].indexOf(e.id);
      -1 != o &&
        null != t[1][o].transform &&
        (null == r && (a.x = t[1][o].transform[4]),
        null == i && (a.y = t[1][o].transform[5]));
    }
    return a;
  }),
  ...
  (OrgChart.t = function (t, e) {
    var r = OrgChart.templates[t],
      i = null;
    if (null != e && r.scaleLessThen) {
      var a = [];
      ...
      if (0 < a.length) {
        ...
        var l = r.scaleLessThen[a[0]];
        for (var s in l) null == i && (i = Object.assign({}, r)), (i[s] = l[s]);
      }
    }
    return null == i ? r : i;
  }),
    ...
    for (var l = 0; l < n; l++)
      !(function () {
        ...
        OrgChart._getDataUri(r.getAttribute(i), function (t) {
          t.success && r.setAttribute(i, t.result), e == n - 1 && a();
        });
      })();
  }),
  ...
  (OrgChart._csvToArray = function (t, e) {
    ...
    for (
      ...
      var o,
        n = a[1];
      n.length && n !== e && i.push([]),
        (o = a[2] ? a[2].replace(new RegExp('""', "g"), '"') : a[3]),
        i[i.length - 1].push(o);
    }
    return i;
  }),
  (OrgChart._json2xml = function (t) {
    for (
      ...
      for (var n in o) {
        var l = o[n];
        "tags" == n && (l = l.join()), a.setAttribute(n, l);
      }
      r.appendChild(a);
    }
    return (
  ...
  (OrgChart._xml2json = function (t) {
    for (
      ...
      for (var a = e[i], o = {}, n = 0; n < a.attributes.length; n++) {
        var l = a.attributes[n],
          s = l.value;
        "tags" == l.name && (s = s.split(",")), (o[l.name] = s);
      }
      r.push(o);
    }
    return r;
  ...
  (OrgChart._json2csv = function (t) {
    for (
          ...
          for (var e = "", r = 0; r < o.length; r++) {
            ...
            (i =
              "reportsTo" == o[r]
                ...
                : null == t[o[r]]
                ? ""
                : t[o[r]]) instanceof Date && (i = i.toLocaleString());
      ...
      for (var a in t[i])
        OrgChart._arrayContains(o, a) || (o.push(a), (r += a + ","));
    r += "\n";
  ...
  (OrgChart.accentFold = function (t) {
    return (t = t.toString().toLowerCase()).replace(
      ...
      function (t, e, r, i, a, o, n, l, s, h, d) {
        return e
          ? "a"
          : r
          ? "c"
  ...
  (OrgChart.xScrollUI.prototype.addListener = function (t) {
    ...
    if (
      ...
      !(function (t, i, e) {
        ...
        function o() {
          a = !0;
          var t = (n.pos - n.bar.scrollLeft) / e;
          0 < t ? t++ : t--,
            (n.bar.scrollLeft += t),
            n.bar.scrollLeft == n.pos ? (a = !1) : r(o);
        }
        ...
        t.addEventListener(
          ...
          function (t) {
            var e = 0;
            if (n.config.mouseScrool == OrgChart.action.xScroll)
              (e = t.deltaX || t.wheelDeltaX) ||
                (e = t.deltaY || t.wheelDeltaY);
            else if (
              n.config.mouseScrool == OrgChart.action.scroll &&
              !(e = t.shiftKey
            ...
            (e = -e),
              ...
              (n.pos += -e * i);
            var r =
              parseFloat(n.innerBar.clientWidth) -
              parseFloat(n.bar.clientWidth);
            n.pos < 0 && (n.pos = 0), n.pos > r && (n.pos = r), a || o();
          },
          !1
        );
        var r =
        ...
        this.bar.addEventListener("scroll", function () {
          if (this.ignore) this.ignore = !1;
            ...
            var t = a.requestParams(),
              e =
                (parseFloat(a.innerBar.clientWidth) -
                  parseFloat(a.bar.clientWidth)) /
                100,
              r = this.scrollLeft / e,
  ...
  (OrgChart.yScrollUI.prototype.addListener = function (t) {
    ...
    if (
      ...
      !(function (t, i, e) {
        ...
        function o() {
          a = !0;
          var t = (n.pos - n.bar.scrollTop) / e;
          0 < t ? t++ : t--,
            (n.bar.scrollTop += t),
            n.bar.scrollTop == n.pos ? (a = !1) : r(o);
        }
        ...
        t.addEventListener(
          ...
          function (t) {
            var e = 0;
            if (n.config.mouseScrool == OrgChart.action.yScroll)
              (e = t.deltaY || t.wheelDeltaY) ||
                (e = t.deltaX || t.wheelDeltaX);
            else if (
              n.config.mouseScrool == OrgChart.action.scroll &&
            ...
            (e = -e),
              ...
              (n.pos += -e * i);
            var r =
              parseFloat(n.innerBar.clientHeight) -
              parseFloat(n.bar.clientHeight);
            n.pos < 0 && (n.pos = 0), n.pos > r && (n.pos = r), a || o();
          },
          !1
        );
      ...
      this.bar && this.bar.parentNode.removeChild(this.bar),
        ...
        this.bar.addEventListener("scroll", function () {
          if (this.ignore) this.ignore = !1;
            ...
            var t = a.requestParams(),
              e =
                (parseFloat(a.innerBar.clientHeight) -
                  parseFloat(a.bar.clientHeight)) /
                100,
              r = this.scrollTop / e,
  ...
  (OrgChart.prototype.zoom = function (t, e, r) {
    var i = this.getViewBox().slice(0),
      ...
      n = i[3];
    !0 === t
      ? ((i[2] = i[2] / OrgChart.SCALE_FACTOR),
        (i[3] = i[3] / OrgChart.SCALE_FACTOR))
      : !1 === t
      ? ((i[2] = i[2] * OrgChart.SCALE_FACTOR),
        (i[3] = i[3] * OrgChart.SCALE_FACTOR))
      : ((i[2] = i[2] / t), (i[3] = i[3] / t)),
      e || (e = [50, 50]),
      (i[0] = a[0] - (i[2] - o) / (100 / e[0])),
      (i[1] = a[1] - (i[3] - n) / (100 / e[1]));
    var l = this.getScale(i);
    if (
      ((i[2] = this.width() / l),
      (i[3] = this.height() / l),
      (!0 === t && l < this.config.scaleMax) ||
        (!1 === t && l > this.config.scaleMin) ||
        (0 != t &&
          1 != t &&
          l < this.config.scaleMax &&
          l > this.config.scaleMin))
    ) {
      this._hideBeforeAnimation();
      var s = this;
      r
  ...
  (OrgChart.pdfPrevUI.show = function (r, i) {
    ...
    (t.id = "bg-ppdf-btns"),
      ...
      (t.innerHTML =
        ...
        '</h1><div><button id="bg-prev-save" style="font-size: 14px; width: 90px;">' +
        OrgChart.loc.ppdfSave +
        '</button>&nbsp;<button id="bg-prev-cancel" style="width: 90px;font-size: 14px;">' +
        ...
        OrgChart.loc.ppdfA1 +
        '</option><option value="fit2Levels">' +
        OrgChart.loc.ppdfFitToDrwaing2Levels +
        '</option><option value="A42Levels">' +
        OrgChart.loc.ppdfA42Levels +
        '</option><option value="A32Levels">' +
        OrgChart.loc.ppdfA32Levels +
        '</option><option value="A22Levels">' +
        OrgChart.loc.ppdfA22Levels +
        '</option><option value="A12Levels">' +
        OrgChart.loc.ppdfA12Levels +
    ...
    (e.id = "bg-ppdf-wrapper"),
      ...
      (e.innerHTML =
        '<div id="bg-ppdf-content" style="width: 100%;margin-top:10px;margin-bottom:10px;opacity:0;"></div>');
    var a,
      o,
      n,
      ...
      d = r.element.querySelector("#bg-ppdf-margin"),
      c = r.element.querySelector("#bg-ppdf-header"),
    ...
    (l.value = i.format),
      ...
      (g.value = i.footer),
      OrgChart.anim(
        r.element.querySelector("#bg-ppdf-btns"),
        { margin: [0, 0, 0, -250] },
        { margin: [0, 0, 0, 0] },
        300,
      ...
      r.element
        .querySelector("#bg-prev-cancel")
        .addEventListener("click", function () {
          OrgChart.pdfPrevUI.hide(r);
        }),
      r.element
        .querySelector("#bg-prev-save")
        .addEventListener("click", function () {
      ...
      l.addEventListener("change", function () {
        OrgChart.anim(
          r.element.querySelector("#bg-ppdf-content"),
          { opacity: 1 },
          { opacity: 0 },
          300,
          OrgChart.anim.inSin,
  ...
  (OrgChart.pdfPrevUI._showHide = function (t, e, r) {
    "A4" == t.value || "A3" == t.value || "A2" == t.value || "A1" == t.value
  ...
  (OrgChart.pdfPrevUI._handler = function (t, e, r) {
    ...
    for (
      var s = l.querySelector("svg"),
        h = t.element.querySelector("#bg-ppdf-content"),
        d = 0;
      d < a.length;
      d++
    ) {
      ...
      var u = g.getElementById("bg-header"),
        C = g.getElementById("bg-footer");
      if (u) {
        var m = o - u.offsetHeight - 7;
        u.style.top = m + "px";
      }
      if (C) {
        var O = n - C.offsetHeight - 7;
        C.style.bottom = O + "px";
      }
      g.close();
    }
  ...
  (OrgChart._exportHtml = function (t, e, r, i, a, o) {
    for (var n = "", l = 0; l < e.margin.length; l++) n += e.margin[l] + "px ";
    var s =
      '<!DOCTYPE html><html style="margin:0;padding:0;"><head></head><body style="margin:0; padding:0;"><div style="margin: ' +
      n +
  ...
  (OrgChart.prototype._clink = function (t, e) {
    for (var r, i, a, o, n, l = "", s = 0; s < this.config.clinks.length; s++) {
      var h = this.config.clinks[s],
        d = t.getBGNode(h.from),
        c = t.getBGNode(h.to);
      if (
        (d.isChildOfGroup || e.res.visibleNodes[d.id]) &&
        (!d.isChildOfGroup || e.res.visibleNodes[d._groupParentNodeId]) &&
        (c.isChildOfGroup || e.res.visibleNodes[c.id]) &&
        (!c.isChildOfGroup || e.res.visibleNodes[c._groupParentNodeId])
      ) {
        var g = d.x,
          p = d.y,
          f = c.x,
          u = c.y;
        if (d.isChildOfGroup) {
          var C = t.getBGNode(d._groupParentNodeId),
            m = OrgChart.t(C.templateName);
          (g += C.x + m.groupPadding[3]), (p += C.y + m.groupPadding[0]);
        }
        if (c.isChildOfGroup) {
          (C = t.getBGNode(c._groupParentNodeId)),
            (m = OrgChart.t(C.templateName));
          (f += C.x + m.groupPadding[3]), (u += C.y + m.groupPadding[0]);
        }
        var O = {},
          v = {},
          y = g + d.w / 2,
        ...
        switch (this.config.orientation) {
          ...
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (O.x = y <= x ? ((_ = -1), y + d.w / 10) : ((_ = 1), y - d.w / 10)),
              (v.x = x + c.w / 10),
              p == u
                ? ((_ = -1), (O.y = p + d.h), (v.y = u + c.h))
                : u < p
                ? ((O.y = p), (v.y = u + c.h))
                : ((O.y = p + d.h), (v.y = u));
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            (O.y = b <= w ? ((_ = -1), b + d.h / 5) : ((_ = 1), b - d.h / 5)),
              (v.y = w + c.h / 5),
              g == f
                ? ((_ = -1), (O.x = g), (v.x = f))
                : f < g
        ...
        var k = I(O, v, _),
          A = h.template;
        A || (A = "orange");
        m = OrgChart.clinkTemplates[A];
        l +=
          '<g c-link-from="{from}" c-link-to="{to}">'
            .replace("{from}", d.id)
            .replace("{to}", c.id) +
          m.link
            .replace("{d}", "M{a.x},{a.y} C{a.x},{a.y} {c.x},{c.y} {b.x},{b.y}")
            .replaceAll("{b.x}", v.x)
            .replaceAll("{b.y}", v.y)
            .replaceAll("{a.x}", O.x)
            .replaceAll("{a.y}", O.y)
        ...
        var S =
          ...
          (o = ((i = v).x - r.x) / 2 + r.x),
          (n = (i.y - r.y) / 2 + r.y),
          { x: (o - a.x) / 2 + a.x, y: (n - a.y) / 2 + a.y });
        h.label &&
          (l += m.label
            .replace("{x}", S.x)
            .replace("{y}", S.y)
            .replace("{val}", h.label)),
          (l += OrgChart.grCloseTag);
      }
      ...
      function I(t, e, r) {
        ...
        return (
          (o = (o / (Math.sqrt(i * i + a * a) * r)) * OrgChart.CLINK_CURVE),
          { x: t.x + i / 2 - a * o, y: t.y + a / 2 + i * o }
        );
      }
    }
    e.content += l;
  ...
  (OrgChart.clinkTemplates.orange = {
    ...
    link:
      '<path marker-start="url(#dotOrange)" marker-end="url(#arrowOrange)" stroke="#F57C00" stroke-width="2" fill="none" d="{d}" />',
    label:
  ...
  (OrgChart.clinkTemplates.blue = {
    ...
    link:
      '<path marker-start="url(#dotBlue)" marker-end="url(#arrowBlue)" stroke="#039BE5" stroke-width="2" fill="none" d="{d}" />',
    label:
  ...
  (OrgChart.clinkTemplates.yellow = {
    ...
    link:
      '<path marker-start="url(#dotYellow)" marker-end="url(#arrowYellow)" stroke="#FFCA28" stroke-width="2" fill="none" d="{d}" />',
    label:
  ...
  (OrgChart.prototype._slinks = function (_, k) {
    var A = "",
      S = this.getScale(),
      I = k.res.boundary;
    ...
    function t(t, e, r) {
      ...
      switch (_.config.orientation) {
        ...
        case OrgChart.orientation.right:
        case OrgChart.orientation.right_top:
          (o = "top"), e.y > t.y && (o = "bottom");
      }
      var n = OrgChart.t(t.templateName, S),
        l = _.config.levelSeparation;
      ((t.parent && t.parent.layout == OrgChart.mixed) ||
        (t.parent && t.parent.layout == OrgChart.tree)) &&
        (l = _.config.mixedHierarchyNodesSeparation);
      var s = {
        p: t.x + t.w / 2 + n.expandCollapseSize,
        q: t.y,
        r: t.x + t.w / 2 + n.expandCollapseSize,
        s: I.minY + l,
      };
      if (t.level == e.level)
        switch (((a = e), _.config.orientation)) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            i.push([s.p, s.q]),
              i.push([s.p, s.q - l / 3]),
              (n = OrgChart.t(a.templateName, S)),
              i.push([
                a.x + a.w / 2 + n.expandCollapseSize,
                i[i.length - 1][1],
              ]),
              i.push([i[i.length - 1][0], a.y]);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (s.q = t.y + t.h),
          ...
          case OrgChart.orientation.left_top:
            (s.p = t.x),
              (s.q = t.y + t.h / 2 + n.expandCollapseSize),
              (s.r = I.minX - l),
              (s.s = t.y + t.h / 2 + n.expandCollapseSize),
              i.push([s.p, s.q]),
              i.push([t.x - l / 3, s.q]),
              (n = OrgChart.t(a.templateName, S)),
              i.push([
                i[i.length - 1][0],
                a.y + a.h / 2 + n.expandCollapseSize,
              ]),
        ...
        switch (_.config.orientation) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            i.push([s.p, s.q]), i.push([s.r, t.y - l / 3]);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (s.q = t.y + t.h),
        ...
        for (var h = t; null == a; ) {
          ...
          if (
            (c.id == e.id
              ? (a = c)
              : OrgChart._intersects(c, s, _.config) &&
                ((s = OrgChart._addPoint(c, i, _.config, s, o)), (d = !0)),
            c.id != e.id)
          ) {
            for (; g; ) {
              if (g.id == e.id) {
              ...
              OrgChart._intersects(g, s, _.config) &&
                ((s = OrgChart._addPoint(g, i, _.config, s, o)), (d = !0)),
                (g = g.leftNeighbor);
            }
            for (; p; ) {
              if (p.id == e.id) {
              ...
              OrgChart._intersects(p, s, _.config) &&
                ((s = OrgChart._addPoint(p, i, _.config, s, o)), (d = !0)),
                (p = p.rightNeighbor);
            }
          }
          if (!d) {
            var f = i[i.length - 1][0],
              u = 0;
            if (c.parent)
              switch (
                ((l = _.config.levelSeparation),
                (c.parent.layout != OrgChart.mixed &&
                  c.parent.layout != OrgChart.tree) ||
                  (l = _.config.mixedHierarchyNodesSeparation),
                _.config.orientation)
              ) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                  u = c.parent.y + c.parent.h + l * (2 / 3);
                  break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                  u = c.parent.y - l * (2 / 3);
                ...
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                  (f = c.parent.x + c.parent.w + l * (2 / 3)),
                    (u = i[i.length - 1][1]);
                  break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                  (f = c.parent.x - l * (2 / 3)), (u = i[i.length - 1][1]);
              }
            i.push([f, u]);
          }
          h = c;
        ...
        switch (
          ...
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            i.push([a.x + a.w / 2 + n.expandCollapseSize, i[i.length - 1][1]]),
              i.push([i[i.length - 1][0], a.y + a.h]);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
          ...
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            i.push([i[i.length - 1][0], a.y + a.h / 2 + n.expandCollapseSize]),
              i.push([a.x + a.w, i[i.length - 1][1]]);
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
      ...
      C || (C = "orange");
      var m = null;
      switch ((n = OrgChart.slinkTemplates[C]).labelPosition) {
        case "start":
          m = { x: i[1][0], y: i[1][1] };
          break;
        case "middle":
          ...
          break;
        case "end":
          m = { x: i[i.length - 2][0], y: i[i.length - 2][1] };
      }
      ...
      if (
        ((A +=
          '<g c-link-from="{from}" c-link-to="{to}">'
            .replace("{from}", t.id)
            .replace("{to}", e.id) + n.link.replace("{d}", y)),
        N.label)
      ) {
        var x = n.label
            .replace("{x}", m.x)
      ...
      (A += OrgChart.grCloseTag), (k.content += A);
    }

    for (var e = 0; e < this.config.slinks.length; e++) {
      var N = this.config.slinks[e];
      if (k.res.visibleNodes[N.from] && k.res.visibleNodes[N.to]) {
        var r = _.getBGNode(N.from),
          i = _.getBGNode(N.to);
  ...
  (OrgChart.slinkTemplates.orange = {
    ...
    link:
      '<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkOrange)" marker-end="url(#arrowSlinkOrange)" stroke-linejoin="round" stroke="#F57C00" stroke-width="2" fill="none" d="{d}" />',
    label:
  ...
  (OrgChart.slinkTemplates.blue = {
    ...
    link:
      '<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkBlue)" marker-end="url(#arrowSlinkBlue)" stroke-linejoin="round" stroke="#039BE5" stroke-width="2" fill="none" d="{d}" />',
    label:
      '<text fill="#039BE5" text-anchor="middle" x="{x}" y="{y}">{val}</text>',
    labelPosition: "middle",
  }),
  (OrgChart.slinkTemplates.yellow = {
    ...
    link:
      '<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkYellow)" marker-end="url(#arrowSlinkYellow)" stroke-linejoin="round" stroke="#FFCA28" stroke-width="2" fill="none" d="{d}" />',
    label:
      '<text  fill="#FFCA28" text-anchor="middle" x="{x}" y="{y}">{val}</text>',
    labelPosition: "middle",
  });
